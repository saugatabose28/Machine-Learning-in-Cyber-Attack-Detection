/*1417236239,,JIT Construction: v1512134,en_US*/
...
try {
    window.FB || (function(window) {
        ...
        __d("legacy:fb.appevents", ["Assert", "sdk.AppEvents", "FB", "sdk.feature", "sdk.Runtime"], function(a, b, c, d, e, f, g, h, i, j, k) {
            i.provide('AppEvents', {
                ...
                logPurchase: function(l, m, n) {
                    g.isTrue(j('allow_non_canvas_app_events') || k.isCanvasEnvironment(), 'You can only use this function in Facebook Canvas environment');
        ...
        __d("legacy:fb.canvas.syncrequests", ["sdk.RPC", "sdk.Event"], function(a, b, c, d, e, f, g, h) {
            ...
            function i(j, k) {
                if (j != 'canvas.syncRequestUpdated')
                    return;
        ...
        __d("legacy:fb.canvas.presence", ["sdk.RPC", "sdk.Event"], function(a, b, c, d, e, f, g, h) {
            ...
            function i(k, l) {
                if (k != 'canvas.friendsOnlineUpdated')
                    return;
                if (l.length === 1)
                    g.remote.useFriendsOnline(true);
            }
            function j(k, l) {
                if (k != 'canvas.friendsOnlineUpdated')
                    return;
                if (l.length === 0)
                    g.remote.useFriendsOnline(false);
            }
        }, 3);
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1512134","message":"' + e.message + '"}}');
}
