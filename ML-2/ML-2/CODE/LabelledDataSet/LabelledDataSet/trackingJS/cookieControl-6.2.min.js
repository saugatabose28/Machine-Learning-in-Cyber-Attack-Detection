...
function cookieControl(b) {
    ...
    if (document.getElementsByTagName("body") > 0) {
        var a = document.createElement("script");
        a.type = "text/javascript";
        a.src = "//apikeys.civiccomputing.com/c/v?d=" + encodeURIComponent(document.location.hostname) + "&p=" + encodeURIComponent(b.product) + "&v=" + CookieControl.VERSION + "&k=" + encodeURIComponent(b.apiKey);
