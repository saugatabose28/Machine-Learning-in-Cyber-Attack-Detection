    ...
    e.Cookie = {
        ...
        removeSub: function(e, t, n) {
            ...
            if (o(r) && r.hasOwnProperty(t)) {
                delete r[t];
                if (!n.removeIfEmpty)
                    return this.setSubs(e, r, n);
                for (var i in r)
                    if (r.hasOwnProperty(i)&&!a(r[i])&&!u(r[i]))
                        return this.setSubs(e, r, n);
...
YUI.add("selector", function(e, t) {}, "3.11.0", {
...
YUI.add("anim-base", function(e, t) {
    ...
    e.Anim = function() {
        ...
        var t=!0, n;
        for (n in p)
            p[n]._runFrame && (t=!1, p[n]._runFrame());
        t && e.Anim._stopTimer()
    ...
    var v = {
        ...
        _runAttrs: function(t, n, r) {
            ...
            t >= n && (a=!0), r && (t = n - t, u = 0);
            for (c in i)
                i[c].to && (f = i[c], l = c in s && "set"in s[c] ? s[c].set : e.Anim.DEFAULT_SETTER, a ? l(this, c, f.from, f.to, u, n, o, f.unit) : l(this, c, f.from, f.to, t, n, o, f.unit))
        },
        _lastFrame: function() {
...
YUI.add("anim-curve", function(e, t) {
    e.Anim.behaviors.curve = {
        ...
        for (s = 1; s < n; ++s)
            for (i = 0; i < n - s; ++i)
                r[i][0] = (1 - t) * r[i][0] + t * r[parseInt(i + 1, 10)][0], r[i][1] = (1 - t) * r[i][1] + t * r[parseInt(i + 1, 10)][1];
        return [r[0][0], r[0][1]]
    }
}, "3.11.0", {
    requires: ["anim-xy"]
...
YUI.add("event-mouseenter", function(e, t) {
    var n = e.Env.evt.dom_wrappers, r = e.DOM.contains, i = e.Array, s = function() {}, o = {
        proxyType: "mouseover",
        ...
        processArgs: function(t) {
            ...
            if (s) {
                ...
                for (l = s.length - 1; l >= 0; --l) {
                    ...
                    if (!u)
                        continue;
                    + u == u ? i.keys[u] = r : (f = u.toLowerCase(), this.KEY_MAP[f] ? (i.keys[this.KEY_MAP[f]] = r, i.type || (i.type = "down")) : (u = u.charAt(0), a = u.toUpperCase(), r["+shift"] && (u = a), i.keys[u.charCodeAt(0)] = u === a ? e.merge(r, {
                        "+shift": !0
                    }) : r))
                }
            }
...
YUI.add("event-hover", function(e, t) {
    var n = e.Lang.isFunction, r = function() {}, i = {
...
YUI.add("event-touch", function(e, t) {
    ...
    e.DOMEventFacade.prototype._touch = function(t, s, o) {
        ...
        if (t.touches) {
            this.touches = [], c = {};
            for (u = 0, a = t.touches.length; u < a; ++u)
                l = t.touches[u], c[e.stamp(l)] = this.touches[u] = new e.DOMEventFacade(l, s, o)
        }
        if (t.targetTouches) {
            this.targetTouches = [];
            for (u = 0, a = t.targetTouches.length; u < a; ++u)
                l = t.targetTouches[u], f = c && c[e.stamp(l, !0)], this.targetTouches[u] = f || new e.DOMEventFacade(l, s, o)
        }
        if (t.changedTouches) {
            this.changedTouches = [];
            for (u = 0, a = t.changedTouches.length; u < a; ++u)
                l = t.changedTouches[u], f = c && c[e.stamp(l, !0)], this.changedTouches[u] = f || new e.DOMEventFacade(l, s, o)
        }
...
YUI.add("event-valuechange", function(e, t) {
    var n = "_valuechange", r = "value", i, s = {
        ...
        _startPolling: function(t, i, o) {
            if (!t.test("input,textarea"))
                return;
            var u = t.getData(n);
            u || (u = {
                prevVal: t.get(r)
            }, t.setData(n, u)), u.notifiers || (u.notifiers = {});
            if (u.interval) {
                if (!o.force) {
        ...
        _onFocus: function(e, t) {
            ...
            o || (o = {}, i.setData(n, o)), o.prevVal = i.get(r), s._startPolling(i, t, {
                e: e
            })
        },
        _onKeyDown: function(e, t) {
            s._startPolling(e.currentTarget, t, {
                e: e
            })
        },
        _onKeyUp: function(e, t) {
            (e.charCode === 229 || e.charCode === 197) && s._startPolling(e.currentTarget, t, {
                e: e,
                force: !0
            })
        },
    ...
    n.HTML_PARSER = {}, n._buildCfg = {
        ...
        _getHtmlParser: function() {
            ...
            for (r = t.length - 1; r >= 0; r--)
                i = t[r].HTML_PARSER, i && e.mix(n, i, !0);
            return n
        }
    })
}, "3.11.0", {
