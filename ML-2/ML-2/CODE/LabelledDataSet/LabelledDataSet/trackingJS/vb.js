/*1416873402,,JIT Construction: v1507751,en_US*/
...
try {
    window.FB || (function(window) {
        ...
        __d("JSSDKMusicConfig", [], {
            "swfPath": "rsrc.php\/v1\/yM\/r\/6SWfmUUTK18.swf"
        });
        ...
        __d("sdk.Music", ["sdk.Content", "sdk.Event", "Flash", "Log", "JSSDKMusicConfig", "sdk.Runtime", "UrlMap"], function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
            var n, o, p, q = {
                init: function() {
                    if (n)
                        return;
                    if (!i.isAvailable()) {
                        j.error('Flash is not installed or is too old');
                        h.fire('fb.music.FLASH_ERROR');
                        return;
                    }
                    var r = m.resolve('fbcdn', true) + '/' + k.swfPath, s = {
                        app_id: l.getClientID(),
                        domain: location.hostname
                    }, t = g.appendHidden(document.createElement('div'));
                    p = i.embed(r, t, null, s);
                    n = true;
                },
                send: function(r, s) {
                    if (o) {
                        ...
                        h.subscribe('fb.music.BRIDGE_READY', ES(q.send, 'bind', true, this, r, s));
                        q.init();
                    }
                },
                flashCallback: function(r, s) {
                    if (r === 'BRIDGE_READY') {
                        p.validate();
                        o = true;
                    }
        ...
        __d("legacy:fb.music", ["sdk.Event", "FB", "sdk.Music"], function(a, b, c, d, e, f, g, h, i) {
            h.provide('Music', i);
            g.subscribe('init:post', function(j) {
                if (j.music)
                    i.init();
            });
        }, 3);
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1507751","message":"' + e.message + '"}}');
}
