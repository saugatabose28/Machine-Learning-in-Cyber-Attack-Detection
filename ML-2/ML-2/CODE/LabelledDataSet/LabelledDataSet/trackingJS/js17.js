/* From: production-mt-wfe-58-119-use1 : 26647 */
(function(a) {
    var d = 1, c = function(f) {
        return jQuery("string" === typeof f ? "#" + f : f)
    }, b = function(e) {
        huff.beta && console.warn(e + " is deprecated")
    };
    a.YAHOO = {
        util: {
            Event: {
                on: function(j, h, g, f, i) {
                    b("YAHOO.util.Event.on", arguments);
                    c(j).bind(h, function(k) {
                        i === true ? g.apply(f || this, arguments) : g.call(i || this, k, f)
                    })
                },
                onAvailable: function(h, g) {
                    b("YAHOO.util.Event.onAvailable", arguments);
                    if (c(h).length) {
                    ...
                    var e = 0, f = setInterval(function() {
                        if (c(h).length) {
                            ...
                            2000<++e && clearInterval(f)
                        }
                    }, 100)
                },
                addListener: function(i, h, g, f) {
                    b("YAHOO.util.Event.addListener", arguments);
                    c(i).bind(h, function() {
                        g.apply(f, arguments)
                    })
                },
                removeListener: function(g, f) {
                    b("YAHOO.util.Event.removeListener", arguments);
                    c(g).unbind(f)
                },
                getTarget: function(f) {
                    b("YAHOO.util.Event.getTarget", arguments);
                    return f.currentTarget
                },
                purgeElement: function(f) {
                    b("YAHOO.util.Event.purgeElement", arguments);
                    c(f).unbind()
                }
            },
            Dom: {
                get: function() {
                    b("YAHOO.util.Dom.get", arguments);
                    return document.getElementById.apply(document, arguments)
                },
                setStyle: function(f, h, g) {
                    b("YAHOO.util.Dom.setStyle", arguments);
                    c(f).css(h, g)
                },
                getStyle: function(f, g) {
                    b("YAHOO.util.Dom.getStyle", arguments);
                    return c(f).css(g)
                },
                addClass: function(f, g) {
                    b("YAHOO.util.Dom.addClass", arguments);
                    c(f).addClass(g)
                },
                removeClass: function(f, g) {
                    b("YAHOO.util.Dom.removeClass", arguments);
                    c(f).removeClass(g)
                },
                hasClass: function(f, g) {
                    b("YAHOO.util.Dom.hasClass", arguments);
                    return c(f).hasClass(g)
                },
                batch: function(h, g) {
                    b("YAHOO.util.Dom.batch", arguments);
                    c(h).each(g)
                },
                getElementsByClassName: function(f, e) {
                    b("YAHOO.util.Dom.getElementsByClassName", arguments);
                    return Array.prototype.slice.call(jQuery((e || "") + "." + f), 0)
                },
                generateId: function(f) {
                    b("YAHOO.util.Dom.generateId", arguments);
                    var g = "yui-gen" + (d++);
                    c(f).attr("id", g);
                    return g
                },
                getXY: function(f) {
                    b("YAHOO.util.Dom.getXY", arguments);
                    var g = c(f).offset();
                    return g ? [g.left, g.top] : false
                },
                ...
                getAncestorByClassName: function(f, g) {
                    return c(f).parents("." + g)[0] || null
                }
            },
            Connect: {
                asyncRequest: function(j, h, i, e) {
                    b("YAHOO.util.Connect.asyncRequest", arguments);
                    var f = {};
                    var g = {
                        url: h,
                        type: j,
                        success: function(k, l) {
                            f.done = true;
                            "function" === typeof i.success && i.success.call(i.scope || null, {
                                responseText: k,
                                status: l.status,
                                argument: i.argument
                            })
                        ...
                        error: function() {
                            f.done = true;
                            "function" === typeof i.failure && i.failure.call(i.scope || null)
                        }
                    };
                    i.timeout && (g.timeout = i.timeout);
                    e && (g.data = e);
                    jQuery.ajax(g);
                    return f
                },
            ...
            Anim: function(m, k, j, f) {
                b("YAHOO.util.Anim", arguments);
                m = c(m);
                var h, n = {}, o = {}, g = [];
                for (var l in k) {
                    if (k.hasOwnProperty(l)) {
                        h = k[l];
                        "from" in h && (n[l] = h.from);
                        "to" in h && (o[l] = h.to)
                    }
                }
                m.css(n);
                return {
                    animate: function() {
                        m.animate(o, j, function() {
                            for (var p = 0, e = g.length; p < e; p++) {
                                "function" === typeof g[p] && g[p]()
                            }
                            g = []
                        })
                    },
        ...
        namespace: function(e) {
            b("YAHOO.namespace", arguments);
            return YAHOO[e] = {}
        },
        extend: function(f, e, h) {
            b("YAHOO.extend", arguments);
            var g = function() {};
            g.prototype = e.prototype;
            f.prototype = new g();
            f.prototype.constructor = f;
            f.superclass = e.prototype;
            h && jQuery.extend(f.prototype, h)
        }
    }
})(window);
/*!
