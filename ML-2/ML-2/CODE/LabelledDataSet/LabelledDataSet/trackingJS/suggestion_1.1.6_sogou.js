...
var documentField_;
var smartPop_;
var hlightSearch_ = false; //是否需要高亮搜索框
var smartPopStyle_;
var completeIFrame_ = null;
var completeIFrameStyle_ = null;
//var aqElement_; //智能提示关键字的索引号
//var oqElement_; //存储, 原始查询的关键字 input 元素
//var cidElement_;
...
var autoSubmit_ = true; //单击自动提示元素是否提交?
function $(id){
	return document.getElementById(id);
}
//autoSubmit 点击自动弹出提示,是否搜索?
function init(form, autoSubmit, pid) {
	...
	documentForm_.onclick=function(event){stopEvent(event);} //阻止冒泡    
...
function initChannel(){
	//提示文字,搜索的url,统计参数
    var channelList = [
        ['网页', 'http://www.sogou.com/tx?hdq=sogou-wsse-3f7bcd0b3ea82268&ie=utf-8&query=', 'soweb'],
        ['图片', 'http://pic.sogou.com/pics?p=17040500&query=', 'soimage'],
        ['视频', 'http://v.sogou.com/v?p=17040600&query=', 'sovideo'],
        ['音乐', 'http://mp3.sogou.com/music.so?p=17040200&ie=utf-8&query=', 'somusic'],
        ['地图', 'http://map.sogou.com/#page=1&lq=', 'somap'],
        ['问问', 'http://wenwen.soso.com/z/Search.e?cid=w.q.in.sb.ww&ie=utf-8&sp=S', 'sowenwen'],
        ['百科', 'http://baike.soso.com/Search.e?cid=w.q.in.sb.bk&sp=S', 'sobaike'],
        ['新闻', 'http://news.sogou.com/news?p=17040300&query=', 'sonews'],
        ['购物', 'http://gouwu.sogou.com/shop?_src=haoqq&ie=utf-8&p=17041500&query=', 'soshop']
    ];
    var suggestionUrl = [
        ['网页', 'http://www.sogou.com/tx?hdq=sogou-wsse-3f7bcd0b3ea82268&sourceid=sugg&query=', 'soweb'],
        ['图片', 'http://pic.sogou.com/pics?p=17050500&sourceid=sugg&query=', 'soimage'],
        ['视频', 'http://v.sogou.com/v?p=17050600&sourceid=sugg&query=', 'sovideo'],
        ['音乐', 'http://mp3.sogou.com/music.so?p=17050200&ie=utf-8&sourceid=sugg&query=', 'somusic'],
        ['地图', 'http://map.sogou.com/#page=1&sourceid=sugg&lq=', 'somap'],
        ['问问', 'http://wenwen.soso.com/z/Search.e?cid=w.q.in.sb.ww&ie=utf-8&sp=S', 'sowenwen'],
        ['百科', 'http://baike.soso.com/Search.e?cid=w.q.in.sb.bk&sp=S', 'sobaike'],
        ['新闻', 'http://news.sogou.com/news?p=17040300&sourceid=sugg&query=', 'sonews'],
        ['购物', 'http://gouwu.sogou.com/shop?_src=haoqq&ie=utf-8&p=17051500&sourceid=sugg&query=', 'soshop']
    ];
...
function populateSmartPop(suggestions) {
	...
	if (numSuggestions > 0){
		...
		closeRow.innerHTML = '<span class="fl">搜狗智能提示</span>'; //搜狗智能提示
