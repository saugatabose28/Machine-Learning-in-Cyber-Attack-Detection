...
function F(a, b, c) {
    ...
    case "object":
        ...
        d = "";
        for (e in b)
            Object.prototype.hasOwnProperty.call(b, e) && (f = b[e], "function" != typeof f && (c.push(d), wa(e, c), c.push(":"), F(a, f, c), d = ","));
        c.push("}");
        break;
    case "function":
        break;
...
function Ca(a) {
    if (Da) {
        ...
        if (b) {
            var c = b.href;
            if (c && (c = (c = Ca(c)[3] || null) ? decodeURI(c) : c) && c != b.hostname)
                throw Da=!0, Error();
        }
    }
    return a.match(Ba)
...
function O(a, b, c) {
    ...
    if (a = n(a) ? b.getElementById(a) : a)
        if ("iframe" != a.tagName.toLowerCase() && (b = Za(this, a), this.o = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.d = a, this.d.id || (b = a = this.d, b = b[p] || (b[p]=++ca), a.id = "widget" + b), K[this.d.id] = this, window.postMessage) {
            ...
            a = P(this.g, "events");
            for (var d in a)
                a.hasOwnProperty(d) && this.addEventListener(d, a[d]);
                for (var e in Va)
                    ab(this,
                    e)
        }
...
var S = y;
S && ( - 1 != S.indexOf("Firefox") ? fb=!0 : - 1 != S.indexOf("Camino") ? gb=!0 : - 1 != S.indexOf("iPad") ? ib=!0 : - 1 != S.indexOf("iPhone")||-1 != S.indexOf("iPod") ? hb=!0 : - 1 != S.indexOf("Chrome") ? mb=!0 : - 1 != S.indexOf("Android") ? jb=!0 : - 1 != S.indexOf("Safari") && (nb=!0));
...
X.prototype.k = function(a) {
    ...
    if (b) {
        ...
        if (a = Q[c.id])
            a.F=!0, a.F && (w(a.D, a.J, a), a.D.length = 0), a.P(c)
    }
};
function Nb(a) {
    X.call(this, a);
