//tealium universal tag - utag.304 ut4.0.201402281618, Copyright 2014 Tealium.com Inc. All Rights Reserved.
...
window._fbds=window._fbds||{};try{(function(id,loader,u){u=utag.o[loader].sender[id]={};u.ev={'view':1};u.initialized=false;u.data={};u.data.pixel_id="284067518410183";u.map={};u.extend=[];u.send=function(a,b){if(u.ev[a]||typeof u.ev.all!="undefined"){var c,d,e,f;c=[];for(d in utag.loader.GV(u.map)){if(typeof b[d]!="undefined"&&b[d]!=""){e=u.map[d].split(",");for(f=0;f<e.length;f++){if(e[f].indexOf("event.")==0){c.push(b[d]);}else{u.data[e[f]]=b[d];}}}}
...
utag.o[loader].loader.LOAD(id);})('304','godaddy.godaddy');}catch(e){}
