...
try {
    ...
    var Df = function(a, b) {
        if (b && b.metadata && b.metadata.globalCounts && void 0 != b.metadata.globalCounts.count) {
            ...
            if (d) {
                var e;
                e = (e = "en-US".match(/^\w{2,3}([-_]|$)/)) ? e[0].replace(/[_-]/g, "") : "";
                var f;
                if ("en" != e) {
                    f = a.Vc;
                    var g = c;
                    ...
                    f = Math.floor(10 * c), 1E7 <= f ? f/=1E6 : 1E4 <= f && (f/=1E3), f = Math.floor(f), f = 10 <= f && 100 > f && 0 != f%
                    10 ? "" + (f / 10).toPrecision(2) : "" + Math.floor(f / 10);
                c = c.toString().length;
                q = "";
    ...
    var lf = function(a, b, c, d) {
        ...
        if (!a.ua)
            return !1;
        (a = Xc("https://www.google.com/support/profiles/?p=plusone_button_error&hl=en-US", ed(window, "GooglePlusOneHelp", 800, 600))) && a.focus();
        return !0
    }, Jf = function(a) {
        var b = parseInt(a, 10);
        if (b == a)
