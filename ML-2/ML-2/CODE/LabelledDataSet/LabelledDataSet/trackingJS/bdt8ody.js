...
window.Typekit.config = {
    "c": [".etica,.tk-lft-etica", "\"lft-etica\",sans-serif", ".tk-source-sans-pro", "\"source-sans-pro\",sans-serif"],
    "f": "//use.typekit.net/c/37fb6f/1w;lft-etica,2,ZRg:N:i4,ZRl:N:i7,ZRn:N:i8,ZRf:N:n4,ZRk:N:n7,ZRm:N:n8;source-sans-pro,2,Xw5:N:n4,Xvy:N:n7/{format}{/extras*}?",
    "fn": ["lft-etica", ["i4", "i7", "i8", "n4", "n7", "n8"], "source-sans-pro", ["n4", "n7"]],
    "k": "//use.typekit.net/{id}.js",
    "p": "//p.typekit.net/p.gif?s=1&k=bdt8ody&ht=tk&h={host}&f=5898.5902.13429.13430.5903.13433.17265.17267&a=647572&_={_}",
    "w": "bdt8ody"
};
/*{"k":"1.6.5","created":"2013-11-07T12:43:35Z"}*/
;
(function(window, document, undefined) {
    ...
    la.prototype.parse = function() {
        ...
        if ( - 1 != this.e.indexOf("MSIE")||-1 != this.e.indexOf("Trident/")) {
            ...
            a: if (a = "Unknown", b =
        E(this.e, /Presto\/([\d\w\.]+)/, 1), c = y(b), d = D(this), e = y(d), f = F(this.R), c.g !== k ? a = "Presto" : ( - 1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = E(this.e, /rv:([^\)]+)/, 1), c = y(b)), - 1 != this.e.indexOf("Opera Mini/"))
            g = E(this.e, /Opera Mini\/([\d\.]+)/, 1), h = y(g), a = new A("OperaMini", h, g, a, c, b, C(this), e, d, f, new u(l, l, l));
        else {
            ...
            / OPR\ / [\d.] + /.test(this.e)?a=pa(this):/AppleWeb(K | k)it / .test(this.e) ? a = pa(this) : - 1 != this.e.indexOf("Gecko") ? (a = "Unknown", b = new v, c = "Unknown", d = D(this), e = y(d), f = l, - 1 != this.e.indexOf("Firefox") ? (a = "Firefox", c = E(this.e, /Firefox\/([\d\w\.]+)/, 1), b = y(c), f = 3 <= b.g && 5 <= b.o) : - 1 != this.e.indexOf("Mozilla") && (a = "Mozilla"), g = E(this.e, /rv:([^\)]+)/, 1), h = y(g), f || (f = 1 < h.g ||
    ...
    W.prototype.load = function(a, b) {
        if (this.t) {
            for (var c = Xa[this.t] || new Sa(Ta), d = 0; d < this.v.length; d++) {
                for (var e = this.v[d], f = this.t, g = c, h = [], p = e.L.split(",")[0].replace(/"|'/g, ""), z = e.H(), ca = h, B = void 0, S = [], I = {}, ma = 0; ma < z.length; ma++)
                    B = z[ma], 0 < B.length&&!I[B] && (I[B] = j, S.push(B));
                z = S;
