...
if (window.sc_project && (_sc_project_int == 9560334 || _sc_project_int == 6709687 || _sc_project_int == 9879613 || _sc_project_int == 4124138 || _sc_project_int == 204609 || 9993602 < _sc_project_int && _sc_project_int <= 10056047 || _sc_project_int > 10128785))
    try {
                                        ...
                                        if (navigator.mimeTypes && navigator.mimeTypes.length)
                                            for (i in pluginMap)
                                                ...
                                                if (typeof navigator.javaEnabled !== "unknown" && typeof navigator.javaEnabled !== "undefined" && navigator.javaEnabled())
                                                    browserFeatures.push("java");
                                                    if (typeof window.GearsFactory === "function")
                                                        browserFeatures.push("gears")
                                    }
                                    ...
                                    if (include_dashes)
                                        ...
                                        for (var i = 0; i < guid_len; i++)
                                            if (include_dashes && (i == 8 || i == 13 || i == 18 || i == 23))
                                                guid[i] = "-";
                                            else if (i == 12&&!include_dashes || i == 14 && include_dashes)
                                                guid[i] = "4";
                                            else if (i ==
                                            13&&!include_dashes || i == 15 && include_dashes)
                                                guid[i] = "F";
                                            else {
                                                if (rnd <= 2)
                                                    rnd = 33554432 + sc_seededrandom() * 16777216 | 0;
                                                    r = rnd & 15;
                                                    rnd = rnd>>4;
                                        ...
                                        if (typeof window.sc_first_party_cookie == "undefined")
                                            ...
                                            if (sc_first_party_cookie == 1) {
                                                if (typeof window.sc_cookie_domain == "undefined")
                                                    ...
                                                    if (sc_cookie_domain.substring(0, 1) != ".")
                                                        sc_cookie_domain = "." + sc_cookie_domain;
                                                        ...
                                                        if (sc_cookie) {
                                                            ...
                                                            for (var i = 0; i < cookie_projects.length; i++) {
                                                                ...
                                                                if (cookie_project[0] == sc_project) {
                                                                    ...
                                                                    var last_session_time =
                                                                    parseInt(cookie_project[1], 10);
                                                                    if (last_session_time > 1E12)
                                                                        last_session_time = last_session_time / 1E3;
                                                                        if (sc_cookie.substring(0, 2) == "sc")
                                                                            last_session_time -= 60 * 30;
                                                                            ...
                                                                            if (cookie_project.length < 5) {
                                                                                ...
                                                                                if (isNaN(r_30))
                                                                                    ...
                                                                                    if (sc_uuid == ".0")
                                                                                        sc_uuid = "." + generate_uuid();
                                                                                        for (var i = 0; i < returning_times.length; i++) {
                                                                                            var rval = parseInt(cookie_project[i + 3], 10);
                                                                                            if (isNaN(rval))
                                                                                                rval = 1;
    ...
    sc_debug_img.src = "http://statcounter.com/feedback/?email=javascript@statcounter.com&page_url=" +
    encodeURIComponent(document.location.protocol + "//" + document.location.host + document.location.pathname + document.location.search + document.location.hash) + "&name=Auto%20JS&feedback_username=statcounter&pid=" + sc_project + "&fake_post&user_company&feedback=consistent%20uniques%20js%20exception:%20" + encodeURIComponent(vDebug);
    sc_unique_returning = "";
    sc_uuid_q = "&u1=f2"
}
    ...
    function _sc_validateTags(tags) {
        ...
        if (!(tags.length%2 == 0))
            ...
            for (i = 0; i < tags.length; i++) {
                var tagLength = ("" +
                tags[i]).length;
                if (tagLength < min_tag_char_length || tagLength > max_tag_char_length)
                    errors.push("Tag names and values must be between " + min_tag_char_length + " and " + max_tag_char_length + " characters in length ('" + tags[i] + "' is " + tags[i].length + " characters long).")
                }
            for (i = 0; i < tags.length; i++)
                if (_sc_strip_tags("" + tags[i]) != "" + tags[i])
                    errors.push("Tag names and values may not contain HTML tags.")
        }
        if (errors.length != 0) {
            for (i = 0; i < errors.length; i++)
                console.log("StatCounter Custom Tag Error: " + errors[i] + " Tags will not be recorded for this pageview.");
            return false
        }
        return true
    }
...
if (sc_script_num)
    ...
    var sc_script_num = 1;
var sc_tracking_url = sc_base_dir + sc_unique_returning + sc_uuid_q + "&resolution=" + sc_width + "&h=" + sc_height + "&camefrom=" + sc_referer + "&u=" + sc_url + "&t=" + sc_title + "&java=1&security=" + sc_security_code + "&sc_random=" + Math.random() + "&sc_snum=" + sc_script_num + sc_pageview_tag_string;
                ...
                if (window.sc_click_stat)
                                ...
                                if (lnklocal.test(adata))
                                    if (dl.test(adata))
                                        ...
                                        if (clickmode != 0) {
                                            ...
                                            if (sc_link.length > 0) {
                                                var sc_req = sc_click_dir + "click.gif?sc_project=" + clickstat_project + "&security=" + clickstat_security + "&c=" + sc_link + "&m=" + clickmode + "&u=" +
                                                sc_url + "&t=" + sc_title + "&rand=" + Math.random() + sc_uuid;
                    ...
                    function sc_adsense_click(sc_data) {
                        ...
                        function sc_adsense_init() {
                            ...
                            } else if (typeof window.addEventListener !=
                            "undefined") {
                            ...
                            function sc_exitpage(e) {
                                ...
                                if (typeof sc_px == "undefined")
                                    ...
                                    for (var i = 0; i < ad.length; i++) {
                                        ...
                                        var adH = parseInt(adTop, 10) + parseInt(ad[i].height,
                                        10) + 10;
