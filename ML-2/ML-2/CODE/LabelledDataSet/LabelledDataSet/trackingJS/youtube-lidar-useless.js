...
var yd = null, zd = null, Ad = null, Bd=!1, Fd = function() {
    ...
    Bd=!1;
    Ba(yd) && (u(z, "scroll", yd), yd = null);
    Ba(zd) && (u(z, "resize", zd), zd = null);
    if (Ba(Ad)) {
        var a = Fa();
        a && u(z, a, Ad);
        Ad = null
...
var ue = null, ve=!1, we=!1, Ce = 0, De = 0, $ = 0, Ee = 0, Fe = 0, Ge = 0, He = 0, Ke = function(a) {
    if (a) {
        ...
        if (!b || vd(a)) {
            if (X(a) && vd(a)) {
                var c = a.Za, d;
                y.body ? (za || (d = y.createElement("iframe"), d.style.display = "none", d.id = "anonIframe", za = d, y.body.appendChild(d)), d=!0) : d=!1;
                d && x(za.contentWindow, c);
                a.Ob=!0
            }
...
Me = function() {
    ...
    if (!b ||!a.Ub) {
        var c = (7 == $ || 6 == $ ? "https://" : "//") + "pagead2.googlesyndication.com/activeview?id=avtest&exp=pde&exp_id=" + $ + "&v=242&type=" + (b ? "imm" : "eos") + "&avi=" + a.ea;
            ...
            if (1 > E.length)
                ...
                5 === a.h) {
                    var b = new re(function(b) {
                        var c = Te(z);
                        null === c && (c =- 1);
                        x(z, ["//pagead2.googlesyndication.com/pagead/gen_204?id=ah&v=242", "avi=" + a.ea, "adk=" + a.o, "pmd=" + b.Hc, "pd=" + b.Gc, "fd=" + c].join("&").substring(0, 2E3))
                    });
...
Ka("lidar::main", function() {
    z.__google_lidar_ ? z.__google_lidar_ += 1 : (z.__google_lidar_ = 1, fe = "lidar", S(z, "unload", function() {
        Se("u")
    }, "lidar::unload"), document.readyState && "complete" === document.readyState ? Xe() : (Ca(function() {
