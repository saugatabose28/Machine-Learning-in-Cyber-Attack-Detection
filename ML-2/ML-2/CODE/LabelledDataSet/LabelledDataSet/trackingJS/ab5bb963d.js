...
(function() {
    ...
    SmtMenu.sdata =
    {
        ...
        settings: (typeof smtAuto != "undefined" && smtAuto === true) ? smtSettings : {},
        // if auto on, there must be settings
