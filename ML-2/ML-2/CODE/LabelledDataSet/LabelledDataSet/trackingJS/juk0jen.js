...
window.Typekit.config = {
    "c": [".tk-source-sans-pro", "\"source-sans-pro\",sans-serif", ".tk-museo-slab", "\"museo-slab\",serif"],
    "f": "//use.typekit.net/c/b86bd2/1w;museo-slab,2,SLT:M:i3,QL2:M:i7,SKB:M:n3,WH7:M:n5,VnC:M:n7;source-sans-pro,2,Xw2:M:i4,Xvz:M:i7,Xw3:M:n3,Xw5:M:n4,Xw6:M:n6,Xvy:M:n7/{format}{/extras*}?",
    "fn": ["museo-slab", ["i3", "i7", "n3", "n5", "n7"], "source-sans-pro", ["i4", "i7", "n3", "n4", "n6", "n7"]],
    "k": "//use.typekit.net/{id}.js",
    "p": "//p.typekit.net/p.gif?s=1&k=juk0jen&ht=tk&h={host}&f=17265.17267.17268.17269.17270.17272.2028.2032.2029.2033.2030&a=674909&_={_}",
    "w": "juk0jen"
};
...
(function(window, document, undefined) {
        ...
        if (d) {
            ...
            e.onload = e.onreadystatechange = function() {
                if (!f && (!this.readyState || "loaded" == this.readyState || "complete" == this.readyState))
                    f = h, c && c(k), e.onload = e.onreadystatechange = k, "HEAD" == e.parentNode.tagName && d.removeChild(e)
            };
            d.appendChild(e);
            window.setTimeout(function() {
                f || (f = h, c && c(Error("Script load timeout")))
            }, 5E3)
        }
    }
    function u(a, b, c) {
    ...
    function A(a, b, c, d, e, f, g, j, p, z, ca) {
        this.W = a;
        this.q = b;
        this.Ta = c;
        this.B = d;
    ...
    la.prototype.parse = function() {
        ...
        if ( - 1 != this.e.indexOf("MSIE")) {
            a = C(this);
            var b = D(this), c = y(b), d = E(this.e, /MSIE ([\d\w\.]+)/, 1), e = y(d);
            a = new A("MSIE", e, d, "MSIE", e, d, a, c, b, F(this.R), new u("Windows" == a && 6 <= e.g || "Windows Phone" == a && 8 <= c.g, l, l))
        } else if ( - 1 != this.e.indexOf("Opera"))
            a: {
            a = "Unknown";
            var b = E(this.e, /Presto\/([\d\w\.]+)/, 1), c = y(b), d = D(this), e = y(d), f = F(this.R);
            c.g !== k ? a = "Presto" : ( - 1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = E(this.e, /rv:([^\)]+)/, 1), c = y(b));
            if ( - 1 != this.e.indexOf("Opera Mini/")) {
                var g =
                E(this.e, /Opera Mini\/([\d\.]+)/, 1), j = y(g);
                a = new A("OperaMini", j, g, a, c, b, C(this), e, d, f, new u(l, l, l))
            } else {
                if ( - 1 != this.e.indexOf("Version/") && (g = E(this.e, /Version\/([\d\.]+)/, 1), j = y(g), j.g !== k)) {
                    a = new A("Opera", j, g, a, c, b, C(this), e, d, f, new u(10 <= j.g, l, l));
                    break a
                }
                g = E(this.e, /Opera[\/ ]([\d\.]+)/, 1);
                j = y(g);
                a = j.g !== k ? new A("Opera", j, g, a, c, b, C(this), e, d, f, new u(10 <= j.g, l, l)) : new A("Opera", new v, "Unknown", a, c, b, C(this), e, d, f, new u(l, l, l))
            }
        } else 
            / OPR\ / [\d.] + /.test(this.e)?a=pa(this):/AppleWeb(K | k)it / .test(this.e) ?
        a = pa(this) : - 1 != this.e.indexOf("Gecko") ? (a = "Unknown", b = new v, c = "Unknown", d = D(this), e = y(d), f = l, - 1 != this.e.indexOf("Firefox") ? (a = "Firefox", c = E(this.e, /Firefox\/([\d\w\.]+)/, 1), b = y(c), f = 3 <= b.g && 5 <= b.o) : - 1 != this.e.indexOf("Mozilla") && (a = "Mozilla"), g = E(this.e, /rv:([^\)]+)/, 1), j = y(g), f || (f = 1 < j.g || 1 == j.g && 9 < j.o || 1 == j.g && 9 == j.o && 2 <= j.J || g.match(/1\.9\.1b[123]/) != k || g.match(/1\.9\.1\.[\d\.]+/) != k), a = new A(a, b, c, "Gecko", j, g, C(this), e, d, F(this.R), new u(f, l, l))) : a = oa;
        return a
    };
    function C(a) {
    ...
    function D(a) {
        ...
        if (b || (b = E(a.e, /Windows Phone( OS)? ([^;)]+)/, 2)) || (b = E(a.e, /(iPhone )?OS ([\d_]+)/, 2)))
            return b;
        if (b = E(a.e, /(?:Linux|CrOS) ([^;)]+)/, 1))
    ...
    function pa(a) {
        var b = C(a), c = D(a), d = y(c), e = E(a.e, /AppleWeb(?:K|k)it\/([\d\.\+]+)/, 1), f = y(e), g = "Unknown", j = new v, p = "Unknown", z = l;
        ...
        j = y(p);
        z = "AdobeAIR" == g ? 2 < j.g || 2 == j.g && 5 <= j.o : "BlackBerry" == b ? 10 <= d.g : "Android" == b ? 2 < d.g || 2 == d.g && 1 < d.o : 526 <= f.g || 525 <= f.g && 13 <= f.o;
        return new A(g, j, p, "AppleWebKit", f, e, b, d, c, F(a.R), new u(z, 536 > f.g || 536 == f.g && 11 > f.o, "iPhone" ==
    ...
    function va(a, b, c, d, e, f, g, j) {
        ...
        ua(a);
        for (var p in L)
            L.hasOwnProperty(p) && (ta(a, new J(L[p], H(this.C))), this.P[L[p]] = a.D.offsetWidth);
        a.remove()
    }
    var L = {
        ab: "serif",
    ...
    function xa(a, b, c) {
        for (var d in L)
            if (L.hasOwnProperty(d) && b === a.P[L[d]] && c === a.P[L[d]])
                return h;
        return l
    }
    function wa(a) {
    ...
    M.prototype.fa = function(a, b, c, d) {
        if (0 === a.length && d)
            ...
            for (d = 0; d < a.length; d++) {
                var e = a[d], f = b[e.getName()], g = this.G, j = e;
                r(g.n, g.r.h(g.s, j.getName(), H(j).toString(), "loading"));
                G(g, "fontloading", j);
    ...
    function Fa(a, b, c, d) {
        ...
        for (b = 0; b < a.length; b++) {
            for (var e = a[b], f = e.L, g = l, j = 0; j < c.length; j++)
                c[j] == f && (g = h);
            g || (c.push(f), d[f] = e.H())
        }
    }
    ...
    Ga.prototype.H = m("T");
    function Ha() {
        this.ka = this.xa = this.K = this.U = this.oa = h
    }
    function P(a) {
        return "Windows" === a.m
    }
    ...
    W.prototype.load = function(a, b) {
        if (this.t) {
            for (var c = Xa[this.t] || new Sa(Ta), d = 0; d < this.v.length; d++) {
                for (var e = this.v[d], f = this.t, g = c, j = [], p = e.L.split(",")[0].replace(/"|'/g, ""), z = e.H(), ca = j, B = void 0, S = [], I = {}, ma = 0; ma < z.length; ma++)
                    B = z[ma], 0 < B.length&&!I[B] && (I[B] = h, S.push(B));
                z = S;
            ...
            if (this.aa) {
                ...
                for (f = 0; f < c.length; f++)
                    e.push(c[f].toString());
                var d = this.aa.h(t(this.j), {
                    format: d,
                    extras: e
                }), c = this.j, d = c.createElement("link",
                {
                    rel: "stylesheet",
                    href: d
                }), Z = l;
            ...
            if (a) {
                ...
                ha(this.j, function() {
                    for (var c = 0; c < na.v.length; c++)
                        na.v[c].fa(a, nb, b && c == na.v.length - 1)
                })
            }
        }
    };
    ...
    Ya.prototype.load = function(a, b) {
        ...
        if (c.length)
            for (var e = this, f = c.length, g = 0; g < c.length; g++) {
                var j = this.Oa.h(t(this.j), {
                    id: encodeURIComponent(c[g])
                });
                ja(this.j, j, function() {
                    0==--f && Za(e, d)
                })
            } else 
                Za(this, d)
    ...
    function Za(a, b) {
        if (0 != a.u.length) {
            for (var c = new ra(a.j, a.n, b), d = l, e = 0; e < a.u.length; e++)
                a.u[e].init(), d = d || a.u[e].supportsConfiguredBrowser();
            if (d) {
                ...
                for (var f = new M(a.e, a.j, c), c = function(a, b, c) {
                    for (var d = [], e = 0; e < a.length; e += 1) {
                        var B = a[e];
                        if (b[B])
                            for (var S = b[B], I = 0; I < S.length; I += 1)
                                d.push(new J(B, S[I]));
                        else 
                            d.push(new J(B))
                    }
                    ...
                    e = a.u[d], e.supportsConfiguredBrowser() && (e.load(c, d == a.u.length - 1), e.performOptionalActions(window))
                } else 
                    sa(c);
            a.u = []
        }
        ...
        if (a)
            for (var b = 0; b < this.u.length; b++) {
                ...
                d && d(function(a, b, d) {
                    a = [];
                    b = {};
                    var j = (new la(navigator.userAgent, document)).parse(), p = c;
                    p.e = j;
                    p.t = Wa(p.e, p.Z);
    ...
    ab.prototype.h = function(a, b) {
        ...
        if ("MSIE" == a.getName() && "Windows Phone" != f) {
            ...
            bb(this, this.I, "scroll", j);
            bb(this, this.I, "resize", j)
        }
