...
(function() {
    ...
    var require, define;
    (function(global) {
        var head = document.getElementsByTagName('head')[0], baseUrl, loadingMap = {}, factoryMap = {}, modulesMap = {}, scriptsMap = {}, resMap = {}, pkgMap = {};
        ...
        CMod.ClickManage = (function() {
            ...
            var cm = {
                ...
                getPosSize: function(obj, pid, opts) {
                    var possize, posel, size, dom = comm.dom, poscn;
                    opts = opts || {};
                    poscn = cm.poscn;
                ...
                combinedata: function(phrase, obj, pid, oid) {
                    var data = {}, now = comm.getTime(), dimension, size;
                ...
                mouseevent: function(pid, oid, opts) {
                    var data = {}, target, el, url, now = comm.getTime(), eda, type, evt;
                    opts = opts || {};
                    el = opts.el;
                    eda = opts.evtdata;
                    type = eda.type;
    ...
    GDTDefine('gdt:comm/proxy.js', function(require, exports, module) {
        ...
        Mshell.prototype = {
            ...
            prefetch: function() {},
            mock: function() {
                var i = 0, len, meths = Array.prototype.slice.call(arguments);
        ...
        Mshell.prototype.prefetch = function(ver) {
            var rs, rscount, i = 0, len, url, el, urlid, loadFn;
    ...
    GDTDefine('gdt:comm/helper.js', function(require, exports, module) {
        ...
        var HMod = {};
        var each = comm.each, dom = comm.dom;
        HMod.__imgs = [];
    ...
    GDTDefine('gdt:comm/data.js', function(require, exports, module) {
        ...
        DMod.getDataAndPing = function(pid, start, len, cb) {
            var pos = DMod.getPosData(pid), data, ret = [];
            if (pos) {
                var dlist = pos.data, parr = [], _cpinged;
    ...
    GDTDefine('gdt:comm/config.js', function(require, exports, module) {
        ...
        Config.graydatadomain = 'gray.i.gdt.qq.com';
        Config._curdatadomain = Config.datadomain;
        var burl = 'http://' + Config._curdatadomain + '/view.fcg?';
        Config._burl = burl;
        Config._xhrproxyurl = 'http://' + Config._curdatadomain + '/ajaxproxy2.html';
        Config._xhrdataurl = 'http://' + Config._curdatadomain + '/dataproxy.html';
        Config.expconf = {
            PINGWAIT: '11030',
            PCPUSHTPL: 'mapptpl'
        };
    ...
    GDTDefine('gdt:comm/ping.js', function(require, exports, module) {
        ...
        var PMod = {};
        PMod.ping = (function() {
            var plist = [], orderlist = [], pmap = {}, extlist = [], safeplist = [], mplist = [], mextlist = [], waitflush, timerflush = 0;
            return {
                append: function(orderdata, pid) {
                    ...
                    if (orderdata.customizedpingurl) {
                        safeplist.push(orderdata.customizedpingurl);
                    }
                },
                ...
                flush: function() {
                    var v, rd = Math.random() * 100, fn = arguments.callee, delaymerge;
                    if (plist.length === 0) {
                        return;
                    }
                    delaymerge = 100;
        ...
        PMod._viewpos = function(pid, forcePing) {
            var d = datamanage.getPosData(pid), c;
        ...
        PMod._postOrderView = function(list) {
            ...
            PMod._batchview(targeturl, varr);
        };
        PMod.ping_vgdt = function(url) {
            var p, statId = 440065, succode, retcode;
            url += '&datatype=jsonp';
    ...
    GDTDefine('gdt:comm/click.js', function(require, exports, module) {
        ...
        CMod.getOrderLink = function(pid, oid) {
            var cm = "ClickManage", cparam = '', d = datamanage.getOrderData(pid, oid);
    ...
    GDTDefine('gdt:comm/load.js', function(require, exports, module) {
        ...
        var wantedcallnum = 0, callingnum = 0, user_data_buffer = {}, call_p_buffer = [], _tmp_user_data_buffer = {}, timeout;
        ...
        NMod.dataUrl = {
            get: function(plist, userdataList) {
                var len = plist.length, extkey, ext, arr;
                var req = {
                    'adposcount': len,
                    'posid': [],
                    count: []
        ...
        NMod._load = function(poscnf) {
            var req = [];
            poscnf = comm.getType(poscnf) == 'array' ? poscnf : [poscnf];
            comm.each(poscnf, function(v, k) {
                var cnf = v, context = {};
                context.count = cnf.count;
                cnf.context && (comm.mix(context, cnf.context));
                req.push([cnf.posId, cnf.container, 1, false, cnf.onComplete, context, {
                    timeout: cnf.timeout,
                    onExposure: cnf.onExposure,
                    onClick: cnf.onClick,
                    onBeforeLoad: cnf.onBeforeLoad
                }
                ]);
            });
            NMod._get(req);
        ...
        NMod._realload = function(pid, container, num, render_default, callback, user_data, opts) {
            var type, arg0 = arguments[0], appid, opts = opts || {}, type = comm.getType(arg0);
            if (type == 'array') {
                NMod._mget(arg0);
                return;
            }
            ...
            if (wantedcallnum == callingnum || wantedcallnum == 1) {
                var data_url = NMod.dataUrl.get(call_p_buffer, user_data_buffer), brdata;
                brdata = {
                    url: data_url
                };
        ...
        NMod.callback = function(data) {
            ...
            datamanage.trimData(data, pconf);
            pconf.id = pid;
            pconf.container = conf.container;
            datamanage.init(pid, pconf, data);
    ...
    GDTDefine('gdt:comm/net.js', function(require, exports, module) {
        ...
        var NMod = {};
        NMod.getter = function(url, callback, ecb, opts) {
            var timeout = 15000, opttimeout, mat, postail = 0;
            opts = opts || {};
        ...
        NMod._normalgetter = function(url, callback, ecb, opts) {
            var charset = config.charset || 'GB2312', js1;
        ...
        NMod.xhrgetter = function(url, callback, ecb, opts) {
            ...
            if (supportlv2 && NMod._ishostSupportxhr()) {
                gtk && (url += '&g_tk=' + gtk);
                NMod._xhr2getter(url, callback, ecb, opts);
                helper.valueStat(valuestaturl, 1, 11, 1, 500);
                return;
            }
            if (domain == 'qq.com') {
                gtk && (url += '&g_tk=' + gtk);
                if (url.indexOf('72343472179107023') > 0) {
                    opts.xhrgetter = NMod._getProxyXHR;
                    NMod._xhr2getter(url, callback, ecb, opts);
                    return;
                }
            }
        ...
        NMod._xhr2getter = function(url, callback, ecb, opts) {
            var timer, _getter;
            opts = opts || {};
                ...
                xmlHttp.onreadystatechange = function() {
                    if (xmlHttp.readyState == 4) {
                        if (xmlHttp.status == 200) {
                            ...
                            NMod._decodexhrjson(resp, callback, ecb);
                        } else {
                            ecb({
                                ret: 599,
                                msg: 'http error',
            ...
            _getter = opts.xhrgetter || NMod._getCors;
            _getter(send, ecb);
        };
        ...
        NMod._detectBlock = function(ifr, opts) {
            opts = opts || {};
            return function() {
                setTimeout(function() {
                    try {
                        var fn = ifr.contentWindow.document.getElementById;
                    } catch (e) {
                        var svrstatus = 599;
                        ifr.parentNode && (svrstatus += 2);
                        opts.ecb && opts.ecb({
                            ret: 599,
                            msg: 'get proxy error',
                            status: svrstatus
        ...
        NMod._getTansport = function(getTransport, ecb) {
            var xmlHttp;
            try {
        ...
        NMod._getProxyXHR = function(send, ecb) {
            var xmlHttp = null, setting;
            var ifr = document.createElement('iframe');
            ifr.style.display = 'none';
            var getandsend = function(getTransport) {
                detectBlock = function() {};
                xmlHttp = NMod._getTansport(getTransport, ecb);
            ...
            var detectBlock = NMod._detectBlock(ifr, {
                ecb: ecb,
                clear: clearIfr
            });
            setting = {
                request: function(getTransport) {
                    getandsend(getTransport);
                }
            };
            ifr.setting = setting;
            ifr.src = config._xhrproxyurl;
            ifr.onload = ifr.onreadystatechange = function() {
                if (typeof ifr.readyState == 'undefined' || ifr.readyState == 'complete') {
                    ifr.onload = ifr.onreadystatechange = null;
                    detectBlock();
                }
            };
        ...
        NMod._getCors = function(send, ecb) {
            var xmlHttp = null;
    ...
    GDTDefine('gdt:comm/plugin.js', function(require, exports, module) {
        ...
        PMod._beforeclick = function(data) {
            var pid = data.pid, oid = data.oid, obj = data.obj;
            var d = datamanage.getOrderData(pid, oid), tmp;
        ...
        PMod._fixDataURL = function(data_url) {
            var gray = comm.getUrlParam('gray');
            ...
            GDT.isGray && (gray = 'gray');
            if (gray == 'gray') {
                data_url = data_url.replace('http://' + config.datadomain, 'http://' + config.graydatadomain);
                config._xhrproxyurl = config._xhrproxyurl.replace('http://' + config.datadomain, 'http://' + config.graydatadomain);
                config._xhrdataurl = config._xhrdataurl.replace('http://' + config.datadomain, 'http://' + config.graydatadomain);
                config._curdatadomain = config.graydatadomain;
            }
            return data_url;
        };
        comm.on('gatherparams', function(data) {
            var extreq = data.extreq, req = data.req;
        ...
        comm.on('afterclick', function(data) {
            var pid = data.pid, orderdata = data.orderdata;
        ...
        comm.on('beforerender', function(data) {
            var pid = data.pid, pconf = data.pconf, orderdata = data.data;
    ...
    GDTDefine('gdt:comm/render.js', function(require, exports, module) {
        ...
        RMod.render = function(pid, callback) {
            var pos = datamanage.getPosData(pid), type, d, hasCb = typeof(callback) == 'function';
            ...
            'default': {
                doRender: function(pid, callback) {
                    require.async('gdt:mod/defaultrender.js', function(defrender) {
                        var h = defrender.renderHelper, pos = datamanage.getPosData(pid), data = pos.data, cfg = pos.cfg;
                        cfg.pid = pid;
    ...
    GDTDefine('gdt:main.js', function(require, exports, module) {
        (function() {
            ...
            GDT.Poller = Poller;
            setTimeout(function() {
                require.async('gdt:mod/match.js', function(mod) {
                    mod();
                });
            }, 2000);
        })();
    ...
    function main(cb) {
        require.setBaseUrl('http://qzonestyle.gtimg.cn/qzone/biz/gdt/display/modules');
