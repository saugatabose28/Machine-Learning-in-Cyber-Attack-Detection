...
!function(d, c) {
    ...
    function D(f, e) {
        var h, g = document.createElement(f || "div");
        for (h in e) {
            g[h] = e[h]
        }
        return g
    ...
    function C(e) {
        for (var d = 1, f = arguments.length; f > d; d++) {
            e.appendChild(arguments[d])
        }
        return e
    }
    function B(G, F, E, o) {
        var n = ["opacity", F, ~~(100 * G), E, o].join("-"), m = 0.01 + E / o * 100, l = Math.max(1 - (1 - G) / F * (100 - m), G), k = u.substring(0, u.indexOf("Animation")).toLowerCase(), j = k && "-" + k + "-" || "";
    ...
    function A(g, f) {
        var j, i, h = g.style;
        for (f = f.charAt(0).toUpperCase() + f.slice(1), i = 0; i < t.length; i++) {
            if (j = t[i] + f, void 0 !== h[j]) {
                return j
            }
        }
        return void 0 !== h[f] ? f : void 0
    }
    function z(e, d) {
        for (var f in d) {
            e.style[A(e, f) || f] = d[f]
    ...
    function w(b) {
        this.opts = y(b || {}, w.defaults, q)
    }
    function v() {
        function a(d, e) {
            return D("<" + d + ' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">', e)
        }
        r.addRule(".spin-vml", "behavior:url(#default#VML)"), w.prototype.lines = function(G, F) {
            function E() {
                return z(a("group", {
                    coordsize: e + " " + e,
                    coordorigin: - g + " " +- g
            ...
            var n, g = F.length + F.width, e = 2 * g, c = 2*-(F.width + F.length) + "px", b = z(E(), {
                position: "absolute",
                top: c,
                left: c
            });
            if (F.shadow) {
                for (n = 1; n <= F.lines; n++) {
                    o(n, - 2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)")
                }
            }
            for (n = 1; n <= F.lines; n++) {
                o(n)
    ...
    var u, t = ["webkit", "Moz", "ms", "O"], s = {}, r = function() {
        var a = D("style", {
            type: "text/css"
        });
        return C(document.getElementsByTagName("head")[0], a), a.sheet || a.styleSheet
    }(), q = {
        lines: 12,
        length: 7,
        width: 5,
    ...
    w.defaults = {}, y(w.prototype, {
        spin: function(M) {
            this.stop();
            var L = this, K = L.opts, J = L.el = z(D(0, {
            ...
            K.radius + K.length + K.width;
            if (z(J, {
                left: K.left,
                top: K.top
            }), M && M.insertBefore(J, M.firstChild || null), J.setAttribute("role", "progressbar"), L.lines(J, L.opts), !u) {
                var I, H = 0, G = (K.lines - 1) * (1 - K.direction) / 2, F = K.fps, E = F / K.speed, j = (1 - K.opacity) / (E * K.trail / 100), e = E / K.lines;
                !function a() {
                    H++;
                    for (var b = 0; b < K.lines; b++) {
                        I = Math.max(1 - (H + (K.lines - b) * e)%E * j, K.opacity), L.opacity(J, b * K.direction + G, I, K)
                    }
                    L.timeout = L.el && setTimeout(a, ~~(1000 / F))
                }()
            }
            return L
        },
        ...
        lines: function(j, g) {
            function e(d, f) {
                return z(D(), {
                    position: "absolute",
                    width: g.length + g.width + "px",
                    height: g.width + "px",
                    background: d,
                    boxShadow: f,
                    transformOrigin: "left",
                    transform: "rotate("+~~(360 / g.lines * b + g.rotate) + "deg) translate(" + g.radius + "px,0)",
                    borderRadius: (g.corners * g.width>>1) + "px"
                })
            }
            for (var c, b = 0, a = (g.lines - 1) * (1 - g.direction) / 2; b < g.lines; b++) {
                c = z(D(), {
                    position: "absolute",
                    top: 1+~(g.width / 2) + "px",
                    transform: g.hwaccel ? "translate3d(0,0,0)": "",
                    opacity: g.opacity,
                    animation: u && B(g.opacity, g.trail, a + b * g.direction, g.lines) + " " + 1 / g.speed + "s linear infinite"
                }), g.shadow && C(c, z(e("#000", "0 0 4px #000"), {
                    top: "2px"
                })), C(j, C(c, e(x(g.color, b), "0 0 1px rgba(0,0,0,.1)")))
            }
            return j
        },
    ...
    return !A(p, "transform") && p.adj ? v() : u = A(p, "animation"), w
});
function trigger_ie_download(c, b) {
    var a = b || navigator.appVersion;
    if (c && a.indexOf("MSIE")!==-1) {
        window.open(c, "download_window", "toolbar=0,location=no,directories=0,status=0,scrollbars=0,resizeable=0,width=1,height=1,top=0,left=0");
        window.focus()
    }
}
function init_download_links() {
    $(".download-link").each(function() {
        var a = $(this);
        a.click(function() {
            trigger_ie_download(a.data("direct-link"))
        })
    });
...
function update_download_text_for_old_fx() {
    if (isFirefox()&&!isFirefoxUpToDate()) {
        $(".download-button").each(function() {
            var a = $(this);
            if (a.hasClass("download-button-check-old-fx")) {
                a.find(".download-subtitle").text(window.trans("global-update-firefox"))
            }
        })
    }
}
function init_android_download_links() {
    if (site.platform === "android") {
        $('a[href^="https://play.google.com/store/apps/"]').each(function() {
            $(this).attr("href", $(this).attr("href").replace("https://play.google.com/store/apps/", "market://"))
        })
    }
}
function init_lang_switcher() {
    $("#language").change(function(a) {
        a.preventDefault();
        gaTrack(["_trackEvent", "Language Switcher", "change", $(this).val()], function() {
            $("#lang_form").submit()
        })
    })
}
...
function getFirefoxMasterVersion(d) {
    var a = 0;
    var b = d || navigator.userAgent;
    var c = /Firefox\/([0-9]+).[0-9]+(?:.[0-9]+)?/.exec(b);
    if (c !== null && c.length > 0) {
        a = parseInt(c[1], 10)
    }
    return a
}
function isFirefox(b) {
    var a = b || navigator.userAgent;
    return ((/\sFirefox/).test(a)&&!(/like Firefox/i).test(a)&&!(/Iceweasel/i).test(a)&&!(/SeaMonkey/i).test(a))
}
function isFirefoxUpToDate(c, e) {
    var a = $(document.documentElement);
    var f = getFirefoxMasterVersion();
    var b = e || a.data("esr-versions");
    var d;
    if (!c) {
        d = a.attr("data-latest-firefox");
        d = parseInt(d.split(".")[0], 10)
    } else {
        d = parseInt(c.split(".")[0], 10)
    }
    return ($.inArray(f, b)!==-1 || d <= f)
}
function isFirefoxMobile(b) {
    var a = b || navigator.userAgent;
    return /Mobile|Tablet|Fennec/.test(a)
}
var $strings = $("#strings");
window.trans = function trans(a) {
    return $strings.data(a)
};
function gaTrack(a, c) {
    var b = typeof(c) === "function";
...
$(function() {
    function b() {
        ...
        var g = $(".footer-newsletter-form #form-details");
        function f() {
            if (!g.is(":visible")) {
                g.slideDown("normal")
            }
        }
        $(".footer-newsletter-form").on("focus", "select, input", f);
    ...
    function c(f) {
        var g = f.find("#id_email").val();
        var e = f.find("#id_privacy");
        return a(g) && e.is(":checked")
    }
    function d(e) {
        var f = e.children("input[name=newsletters]");
        if (f.length === 0) {
            return "Registered for Firefox Updates"
        }
        return f.val()
    }
    $("#mozorg-newsletter-form").on("submit", function(f) {
        var g = $(this);
        var h;
        if (("checkValidity" in g) || c(g)) {
            h = d(g);
            if (typeof(gaTrack) === "function" && h !== "") {
                f.preventDefault();
                f.stopImmediatePropagation();
                g.off("submit");
                gaTrack(["_trackEvent", "Newsletter Registration", "submit", h], function() {
                    g.submit()
                })
            }
        }
    });
    $("#newsletter-form").on("submit", function(k) {
        k.preventDefault();
        var l = $(this);
        var h = $("#footer-email-errors");
        var i = h.find("ul.errorlist");
        var o = $("#footer_email_submit");
        var n = $("#newsletter-spinner");
        var m = new Spinner({
            lines: 12,
            length: 4,
            width: 2,
        ...
        $.ajax(l.attr("action"), {
            ...
            if (r.success) {
                var e = $("#newsletter-form-thankyou");
                var q = l.css("height");
                e.css("min-height", q);
                l.hide();
                j();
                e.show();
                var s = d(l);
                gaTrack(["_trackEvent", "Newsletter Registration", "submit", s])
            } else {
                if (r.errors) {
                    for (var p = 0; p < r.errors.length; p++) {
                        i.append("<li>" + r.errors[p] + "</li>")
                    }
                    h.show();
                    j()
                }
            ...
            i.append("<li>An unknown error occurred. Please try again later</li>");
            h.show();
            j()
        });
        function f() {
            l.addClass("loading");
            l.find("input,select").prop("disabled", true);
            o.addClass("insensitive");
            m.spin(n.show()[0])
        }
        function j() {
            l.removeClass("loading");
            l.find("input,select").prop("disabled", false);
            o.removeClass("insensitive");
            m.stop();
            n.hide()
        }
    })
...
(function() {
    ...
    var a = {};
    a.isMSIEpre9 = (function() {
        return (/MSIE\ (4|5|6|7|8)/.test(navigator.userAgent))
    })();
    a.smallMode = false;
    a.smallMenuOpen = false;
    a.currentSmallSubmenu = null;
    a.previousMenuItem = null;
    a.currentSubmenuItem = null;
    a.mainMenuItems = null;
    a.mainMenuLinks = null;
    a.toggleButton = null;
    a.init = function() {
        a.toggleButton = $("#masthead .toggle");
        a.mainMenuItems = $("#nav-main .has-submenus > li");
        a.mainMenuLinks = $('#nav-main ul > li > [tabindex="0"]');
        a.mainMenuItems.bind("mouseover focusin", a.handleFocusIn).bind("mouseout focusout", a.handleFocusOut).each(a.initSubmenu);
        if (!a.isMSIEpre9) {
            $(window).resize(a.handleResize);
            a.handleResize()
        }
        $("#masthead .toggle").click(function(b) {
            b.preventDefault();
            a.toggleSmallMenu()
        }).keydown(function(b) {
            if (b.keyCode == 13 || b.keyCode == 32) {
                ...
                if (b.keyCode == 27 && a.smallMenuOpen) {
                    a.closeSmallMenu()
                }
            }
        });
        if ("ontouchstart" in window) {
            a.mainMenuLinks.click(function(b) {
                b.preventDefault();
                this.focus()
            })
        }
    ...
    a.handleFocusIn = function() {
        var b = $(this);
        if (a.previousMenuItem) {
            if (a.previousMenuItem.attr("id") !== b.attr("id")) {
                a.previousMenuItem.dequeue()
            } else {
                a.previousMenuItem.clearQueue()
            }
        }
        b.addClass("hover").find('[aria-expanded="false"]').attr("aria-expanded", "true")
    };
    a.handleFocusOut = function() {
        a.previousMenuItem = $(this);
        a.previousMenuItem.delay(100).queue(function() {
            if (a.previousMenuItem) {
                a.previousMenuItem.clearQueue().removeClass("hover").find('[aria-expanded="true"]').attr("aria-expanded", "false");
                a.previousMenuItem = null;
                if (a.currentSubmenuItem) {
                    a.currentSubmenuItem.get(0).blur()
                }
            }
        })
    };
    a.initSubmenu = function(b) {
        var c = $(this).find("a");
        c.mouseover(function() {
            this.focus()
        }).focus(function() {
            a.currentSubmenuItem = $(this)
        }).each(function(d) {
            $(this).keydown(function(g) {
                var f;
                switch (g.keyCode) {
                case 27:
                    a.handleEscKeypress(g);
                    break;
                case 33:
                case 36:
                    f = c.first();
                ...
                case 35:
                    ...
                    break;
                case 38:
                    f = (d > 0) ? c.eq(d - 1) : c.last();
                    break;
                case 40:
                    f = (d < c.length - 1) ? c.eq(d + 1) : c.first();
                    break;
                case 37:
                    f = (b > 0) ? a.mainMenuLinks.eq(b - 1) : a.mainMenuLinks.last();
                    break;
                case 39:
                    f = (b < a.mainMenuLinks.length - 1) ? a.mainMenuLinks.eq(b + 1) : a.mainMenuLinks.first();
                    break
                }
                if (f) {
                    f.get(0).focus();
    ...
    a.enterSmallMode = function() {
        a.unlinkMainMenuItems();
        $("#nav-main-menu").css("display", "none").attr("aria-hidden");
        $("#outer-wrapper").on("click.mobile-nav", a.handleDocumentClick);
        $("a, input, textarea, button, :focus").on("focus.mobile-nav", a.handleDocumentFocus);
        $("#nav-main-menu, #nav-main-menu .submenu").attr("aria-hidden", "true");
        a.mainMenuLinks.addClass("submenu-item").unbind("click", a.handleSubmenuClick);
        a.linkMenuHideOnClick();
        a.smallMode = true
    };
    a.leaveSmallMode = function() {
        a.relinkMainMenuLinks();
        $("#nav-main-menu").css("display", "").removeAttr("aria-hidden");
        $("#outer-wrapper").off("click.mobile-nav", a.handleDocumentClick);
        $("a, input, textarea, button, :focus").off("focus.mobile-nav", a.handleDocumentFocus);
        a.toggleButton.removeClass("open").attr("aria-expanded", false);
        ...
        a.unlinkMenuHideOnClick();
        a.currentSmallSubmenu = null;
        a.smallMode = false;
        a.smallMenuOpen = false
    };
    a.linkMenuHideOnClick = function() {
        if (a.mainMenuItems.length === 0) {
    ...
    a.unlinkMenuHideOnClick = function() {
        if (a.mainMenuItems.length === 0) {
    ...
    a.unlinkMainMenuItems = function() {
        a.mainMenuLinks.each(function(b, d) {
            var c = $(d);
            if (c.siblings(".submenu")) {
                c.attr("data-old-href", c.attr("href"));
                c.removeAttr("href")
            }
        })
    };
    a.relinkMainMenuLinks = function() {
        a.mainMenuLinks.each(function(b, d) {
            var c = $(d);
            if (c.attr("data-old-href")) {
                c.attr("href", c.attr("data-old-href"));
                c.removeAttr("data-old-href")
            }
        })
    };
    a.handleDocumentClick = function(c) {
        if (a.smallMode) {
            var b = $(c.target);
            if (!b.parents().is("#masthead")) {
                a.closeSmallMenu()
            }
        }
    };
    a.handleDocumentFocus = function(c) {
        var b = $(c.target);
        if (!b.parents().is("#masthead")) {
            a.closeSmallMenu()
        }
    };
    a.handleToggleKeypress = function(b) {
        if (b.keyCode == 13) {
            a.toggleSmallMenu()
        }
    };
    a.handleEscKeypress = function(b) {
        if (b.keyCode == 27 && a.smallMenuOpen) {
            a.closeSmallMenu();
            a.toggleButton.focus()
        }
    };
    a.toggleSmallMenu = function() {
        if (a.smallMenuOpen) {
            a.closeSmallMenu()
        } else {
            a.openSmallMenu()
    ...
    a.openSmallMenu = function() {
        if (a.smallMenuOpen) {
            return 
        }
        $("#nav-main-menu").slideDown(150).removeAttr("aria-hidden");
        a.toggleButton.addClass("open").attr("aria-expanded", true);
        a.mainMenuLinks.addClass("submenu-item").on("click", a.handleSubmenuClick).on("keydown", a.handleSubmenuKeypress);
        $("#nav-main-menu > li > a").on("keydown", a.handleEscKeypress);
        a.smallMenuOpen = true
    };
    a.closeSmallMenu = function() {
        if (!a.smallMenuOpen) {
            return 
        }
        $("#nav-main-menu, #nav-main-menu .submenu").slideUp(100).attr("aria-hidden", "true");
        a.toggleButton.removeClass("open").attr("aria-expanded", false);
        a.mainMenuLinks.addClass("submenu-item").off("click", a.handleSubmenuClick).off("keydown", a.handleSubmenuKeypress);
        $("#nav-main-menu > li > a").off("keydown", a.handleEscKeypress);
        if (a.currentSmallSubmenu) {
            a.closeSmallSubmenu(a.currentSmallSubmenu)
        }
        a.currentSmallSubmenu = null;
        a.smallMenuOpen = false
    };
    a.handleSubmenuClick = function(b) {
        b.preventDefault();
        var c = $(this).siblings(".submenu");
        a.openSmallSubmenu(c)
    };
    a.handleSubmenuKeypress = function(b) {
        if (b.keyCode == 13 || b.keyCode == 32) {
            b.preventDefault();
            var c = $(this).siblings(".submenu");
            a.openSmallSubmenu(c)
    ...
    a.openSmallSubmenu = function(b) {
        if (a.currentSmallSubmenu && a.currentSmallSubmenu.get(0).id !== b.get(0).id) {
            a.closeSmallSubmenu(a.currentSmallSubmenu)
        }
        if (a.currentSmallSubmenu && a.currentSmallSubmenu.get(0).id === b.get(0).id) {
            b.find("a").get(0).focus();
            return 
        }
        b.stop(true).css({
            left: "80px",
        ...
        b.find("a").get(0).focus();
        a.currentSmallSubmenu = b
    };
    a.closeSmallSubmenu = function(b) {
        b.stop(true).fadeOut(100, function() {
            b.css({
                left: "",
                top: "",
                display: "",
...
Mozilla.ImageHelper.initPlatformImages = function() {
    $(".platform-img").each(function() {
        ...
        if (site.platform === "osx" || site.platform === "oldmac") {
            ...
            g = ["linux"];
            if (b.data("additional-platforms")) {
                h = b.data("additional-platforms").split(" ");
                g = g.concat(h)
            }
            if ($.inArray(site.platform, g)>-1) {
                j = "-" + site.platform
            }
        }
        var e = b.data("src");
        ...
        var d = e.substring(f);
        var a = c + j + d;
        if (b.data("high-res") && Mozilla.ImageHelper.isHighDpi()) {
            a = Mozilla.ImageHelper.convertUrlToHighRes(a)
        }
        this.src = a;
...
Mozilla.ImageHelper.initHighResImages = function() {
    $('img[data-src][data-high-res="true"][data-processed="false"]').each(function() {
        ...
        if (Mozilla.ImageHelper.isHighDpi()) {
            b = Mozilla.ImageHelper.convertUrlToHighRes(b)
        }
        this.src = b;
        a.attr("data-processed", "true")
    })
};
Mozilla.ImageHelper.isHighDpi = function() {
    if (Mozilla.ImageHelper.is_high_dpi === null) {
        var a = "(-webkit-min-device-pixel-ratio: 1.5),(-o-min-device-pixel-ratio: 3/2),(min--moz-device-pixel-ratio: 1.5),(min-resolution: 1.5dppx)";
        Mozilla.ImageHelper.is_high_dpi = (window.devicePixelRatio > 1 || (window.matchMedia && window.matchMedia(a).matches))
    }
    return Mozilla.ImageHelper.is_high_dpi
};
Mozilla.ImageHelper.convertUrlToHighRes = function(a) {
    var b = a.lastIndexOf(".");
