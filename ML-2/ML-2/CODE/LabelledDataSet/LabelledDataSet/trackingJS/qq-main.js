...
KSLITE.declare("tanxssp-main", ["tanxssp-utils", "tanxssp-config", "tanxssp-params", "tanxssp-request"], function(a, b) {
    ...
    b.Def = function(a) {
        ...
        "" === e && (b = 51), 51 == b && ((new Image).src = "http://ckm.qiyi.com/pixel?qiyi_nid=71000017&qiyi_no_sc"), b = Math.floor(1e2 * Math.random() + 1), 53 === b && c.send("http://mlt01.com/mlcp.htm?media=taobao")
    }
