...
optimizelyCode = function() {
    var DATA = {
        ...
        "goal_expressions": {
            "217473413": ["^(https?://)?(www\\.)?fancydress\\.com\\/costumes\\/checkout\\-auth/?(\\?.*)?(#.*)?$"],
            "340369391": ["^bloodbarctaclicks$"],
            "232102025": ["^thank\\_you$"],
            "217471500": ["^(https?://)?(www\\.)?fancydress\\.com\\/costumes\\/checkout\\-detail/?(\\?.*)?(#.*)?$"],
            "2087962126": ["^image\\_grid\\_top\\_left$"],
            "543120528": ["^logged\\_in$"],
            "982240658": ["^add\\_to\\_basket\\_clicks$"],
            "1865631003": ["www\\.fancydress\\.com\\/costumes\\/(checkout-paypal-finalise|checkout-auth)"],
            "580851233": ["^price\\_guarantee\\_click$"],
            "1974610331": ["^ang027\\-\\_payment\\_update$"],
            "345897143": ["^countdownlinkclicks$"],
            "1840180025": ["^submit\\_clicks$"],
            "684590014": ["^basket\\_total$"],
            "2121700428": ["^image\\_grid\\_bottom\\_right$"],
            "1964060876": ["^ang\\_027\\-bill\\_to\\_update$"],
            "2116391843": ["^image\\_grid\\_top\\_right$"],
            "1371918551": ["^purcyhase$"],
            "1983150068": ["^ang\\_027\\-deliver\\_update$"],
            "2112911710": ["^image\\_carousel\\_clicks$"],
            "2017560034": ["^ang027\\_\\-\\_ctas$"],
            "1989290470": ["^ang\\_027\\_\\-\\_rightsidebar\\_update$"],
            "2092431082": ["^image\\_grid\\_bottom\\_left$"],
            "222629355": ["^navigation\\_clicks$"],
            "201294447": ["^engagement$"],
            "1895340272": ["(https?://)?(www\\.)?fancydress\\.com\\/costumes\\/checkout\\-paypal\\-finalise/?"],
            "323353842": ["^thank\\_you\\_one\\_size$"],
            "323309428": ["^add\\_to\\_basket\\_click$"],
            "1361800311": ["^logo$"],
            "217478271": ["^(https?://)?(www\\.)?fancydress\\.com\\/costumes\\/basket/?(\\?.*)?(#.*)?$"],
            "217482236": ["^benefit\\_bar\\_clicks$"],
            "322422525": ["^prod\\_page\\_one\\_size$"],
            "341671167": ["^ang\\-ty\\-blood$"]
        },
        "experiments": {
            "2002910396": {
                "code": "// CF Utility Code v1.1\nconsole.log(\"cfu\");\nif(typeof window.cFact==\"undefined\"){window.cFact=new Object;}window.cFact.createCookie=function(e,t,n){if(n){var r=new Date;r.setTime(r.getTime()+n*24*60*60*1e3);var i=\"; expires=\"+r.toGMTString()}else var i=\"\";document.cookie=escape(e)+\"=\"+escape(t)+i+\"; path=/\"};window.cFact.readCookie=function(e){var t=escape(e)+\"=\";var n=document.cookie.split(\";\");for(var r=0;r<n.length;r++){var i=n[r];while(i.charAt(0)==\" \")i=i.substring(1,i.length);if(i.indexOf(t)==0)return unescape(i.substring(t.length,i.length))}return null};window.cFact.eraseCookie=function(e){cFact.createCookie(e,\"\",-1)};window.cFact.addCss=function(e){head=document.getElementsByTagName(\"head\")[0],style=document.createElement(\"style\");style.type=\"text/css\";if(style.styleSheet){style.styleSheet.cssText=e}else{style.appendChild(document.createTextNode(e))}head.appendChild(style)};window.cFact.urlParams;(window.onpopstate=function(){var e,t=/\\+/g,n=/([^&=]+)=?([^&]*)/g,r=function(e){return decodeURIComponent(e.replace(t,\" \"))},i=window.location.search.substring(1);cFact.urlParams={};while(e=n.exec(i))cFact.urlParams[r(e[1])]=r(e[2])})();if(cFact.urlParams[\"cfQA\"]){cfQA=cFact.urlParams[\"cfQA\"].toLowerCase();if(cfQA==\"true\"){cFact.createCookie(\"cfQA\",\"true\")}if(cfQA==\"false\"){cFact.eraseCookie(\"cfQA\")}}if(typeof window[\"optimizely\"]!=\"undefined\"){var active=window[\"optimizely\"].data.state.activeExperiments;cFact.experimentData=\"\";for(var i=0;i<active.length;i++){cFact.experimentData=cFact.experimentData+window[\"optimizely\"].data.experiments[active[i]].name+\" | \"+active[i]+\" | \"+window[\"optimizely\"].data.state.variationNamesMap[active[i]]+\"\\n\";var q1=\"cfTest-\"+active[i];var q2=\"cfVariation-\"+active[i];if(_kiq){_kiq.push([\"set\",{q1:window[\"optimizely\"].data.experiments[active[i]].name,q2:window[\"optimizely\"].data.state.variationNamesMap[active[i]]}])}}}\nconsole.log(\"cfue\");",
                "section_ids": ["2003800344", "2006570333"],
                "conditions": [{
                    "not": true,
                    "type": "browser",
                    "values": ["ie8", "ie7", "ie6"]
                    ...
                    "type": "url",
                    "values": [{
                        "value": "http://www.fancydress.com/costumes/basket",
                        "match": "simple"
                    }
                    ]
                }, {
                ...
                "name": "ANG 013 Basket Page Delivery & Blood Upsell [Winner] (2)",
                "enabled_variation_ids": ["2011220400_2009490345"],
                "google_analytics": {
                    "slot": 3
                }
            },
            "1382211317": {
                ...
                "name": "Test",
                "variation_ids": ["1376486440", "1383141281"],
                "enabled_variation_ids": ["1376486440", "1383141281"]
            }
        },
        "audiences": {
            "2141460041": {
                "conditions": ["and", ["or", ["not", ["or", {
                    "dimension_id": 2125713668
                }
                ]]]],
                "name": "Returning",
                "segment_id": 2109000157
            },
            "696953165": {
                "conditions": ["and", {
                    "dimension_id": 651750729,
                    "value": "ie8"
                }
                ],
                "name": "IE 8 (1)",
                "segment_id": 746451441
            },
            "1591954959": {
                "conditions": ["and", {
                    "dimension_id": 1592784840,
                    "value": "((new Date()).getDay() == 5)"
                }
                ],
                "name": "Friday",
                "segment_id": 329366372
            },
            "718603765": {
                "conditions": ["and", {
                    "dimension_id": 651750729,
            ...
            "699433301": {
                ...
                "name": "IE 11 (1)",
                "segment_id": 696292967
            }
        },
        "www_host": "www.optimizely.com",
        "token_hash": "3d81a602a98a4770710f03166f01d33cb8494cd2728790ee895cfb0fa740c619",
        "dimensions": {
            "2125713668": {
                "condition_type": "first_session"
            },
            "921825541": {
                "api_name": "has_accessories",
                "condition_type": "custom_dimension",
                "name": "Has Accessories",
                "segment_id": 946870068
            },
            "1592784840": {
                "condition_type": "code"
            },
            ...
            "1595575016": {
                "api_name": "seen_newsletter_exit_modal",
                "condition_type": "custom_dimension",
                "name": "Seen Newsletter Exit Modal",
                "segment_id": 358450906
            },
            "1589014792": {
                "api_name": "seen_countdown_modal",
                "condition_type": "custom_dimension",
                "name": "Seen Countdown Modal",
                "segment_id": 349600669
            },
            "1006846985": {
                "api_name": "seen_upsell",
                "condition_type": "custom_dimension",
                "name": "Seen upsell",
                "segment_id": 1006067179
            }
        },
        "summary_revenue_goal_id": 201310130,
        "public_suffixes": {
            "fancydress.com": ["fancydress.com", "www.fancydress.com"]
        },
        ...
        "variations": {
            ...
            "2003380801": {
                "code": "// Track Blood in basket\n$('input[name=\"b_checkout\"], input[name=\"b_paypal\"]').click(function() { \nif(typeof($('#qty_array\\\\.1768-').attr('value'))!=\"undefined\") {\ncFact.createCookie(\"cfBldItems\",$('#qty_array\\\\.1768-').attr('value'));\n}\n});",
                "name": "Original"
            },
            "1376486440": {
                "name": "Original"
            ...
            "2009490345": {
                "code": "cFact.addCss('table.boaskettotal td.subtotal p {font-size:15px;} table.boaskettotal td.subtotal .red{float:right;font-size:12px; text-align:right;color:red;line-height: 22px;} .ui-accordion .ui-accordion-content{padding:1em 5px;} .ui-state-hover{background:#0093ff;color:#fff !important;border:1px solid #0093ff;} h3.ui-accordion-header {padding-left:30px;} #shipping_options{margin-bottom:10px;} #shipping_options .active{background-color:#CEE3F6;} #showVoucher{padding-left:50px;float:left;} table.boaskettotal td.voucher, table.boaskettotal td.spend, table.boaskettotal td.subtotal{border-right:none;border-left:none;border-bottom:none;} .price-right{ float:right; padding-top:2px; } #shipping_options input, #shipping_options label{cursor:pointer;}');\n\n// Add custom styling \n$('head').append('<link href=\"//s3-eu-west-1.amazonaws.com/cfactory-img/ANG/013/css/style.css\" rel=\"stylesheet\" type=\"text/css\" media=\"all\">');\n\n// shipping title\njQuery('strong:contains(\"Shipping\")').replaceWith(\"<strong>Delivery Options</strong>\");\njQuery('#shipping_options').after(jQuery('td.subtotal p:first,#order_sub_total,#order_shipping'));\njQuery('#shipping_options').after(jQuery('td.subtotal .clear.line:first'));\njQuery('#order_shipping').before('<div class=\"clear\"></div><p class=\"left\"><strong>Shipping</strong></p>');\n// spend more\nvar s = jQuery('.spend .red strong').text();\nif (s.length > 0){\n  var amount = parseInt(/(\\d+)/.exec(s)[1], 10);\n  if (amount > 0 && amount <= 15){\n    //move it\n    jQuery('.subtotal p:first').after(jQuery('.spend .red'));\n    jQuery('.subtotal .red br').remove();\n    jQuery('.subtotal .red strong,.subtotal .red i').contents().unwrap();\n  } else {\n    //hide it\n    jQuery('.spend span').hide();\n  }\n}\njQuery('.spend .ship').remove();\n// voucher\njQuery('#voucher').hide();\njQuery('table.basket td.buttons:first').append('<p id=\"showVoucher\"><a href=\"#\">I have a voucher code</a></p>');\njQuery('#showVoucher a').click(function(){jQuery('#voucher').show();jQuery('#showVoucher').hide();});\n// set up the accordion\njQuery('#shipping_options br').remove();\njQuery('#shipping_options').prepend('<h3>Deliver my order (UK & BFPO)</h3><div id=\"cf-shipping-uk\"></div><h3>International delivery</h3><div id=\"cf-shipping-international\"></div>');\n//wrap the radio & label in a div class based on radio value\n// make the free shipping option checked by default or standard\nvar freeShipping = false;\nvar standardShipping = false;\njQuery('[type=\"radio\"]').each(function(){\n if (jQuery(this).val().indexOf(\"standard\") != -1){\n   standardShipping = jQuery(this).attr('id');\n }\n if (jQuery(this).val().indexOf(\"free\") != -1){\n   freeShipping = jQuery(this).attr('id');\n }\n});\nvar cfShip = cFact.readCookie('cf-ship');\nvar hideFreeShippingOptions = false;\nif (freeShipping != false){\n  jQuery('#shipping_options #'+freeShipping).click();\n  cFact.eraseCookie('cf-ship');\n  hideFreeShippingOptions = true;\n} else{\n  if (cfShip != null && jQuery('#'+cfShip).length > 0){\n  jQuery('#shipping_options #'+cfShip).click();\n  } else {\n     jQuery('#shipping_options #'+standardShipping).click();\n     cFact.createCookie('cf-ship',standardShipping,28);\n  }\n}\n// hold onto price information for label updates\nvar prices = [];\njQuery('#shipping_options [type=\"radio\"]').each(function(){\n    var thisClass=jQuery(this).val().split('-');\n    prices[thisClass[0]]=thisClass[1];\n    var activeClass = \"\";\n      if(jQuery(this).is(':checked')) {activeClass=' active';}\n    jQuery(this).next('label').andSelf().wrapAll('<div class=\"cf-ship-type cf-' + thisClass[0] + activeClass +'\"/>');\n});\njQuery('#shipping_options [type=\"radio\"]').click(function(){\n  jQuery('.cf-ship-type').removeClass('active');\n  jQuery(this).parent().addClass('active');\n   cFact.createCookie('cf-ship',jQuery(this).attr('id'),28);\n   jQuery('form#shipping #cf-shipping_method').val(jQuery(this).val());\n});\n// work out dates\nvar now = new Date();\n//var now = new Date(\"October 13, 2013 14:15:00\");\n//console.log(now);\nvar nowDay = now.getDay(); //0=Sun, 1=Mon, ..., 6=Sat\nvar nowYr = now.getFullYear();\nvar nowMth = now.getMonth();\nvar nowDate = now.getDate();\nvar nowHrs = now.getHours();\nvar nowMin = now.getMinutes();\nvar nowTimestamp = now.getTime();\n\ndayStart = new Date(nowYr,nowMth,nowDate,'0','0','0').getTime();\nexpressEnd= new Date(nowYr,nowMth,nowDate,'13','59','59').getTime();\nstandardEnd= new Date(nowYr,nowMth,nowDate,'15','59','59').getTime();\nvar stdDays = 2;\nvar economyDays = 7;\nvar expressDays = 1;\nvar daysTilSat =  parseInt(6-nowDay);\nswitch(nowDay){\ncase 0: // sun\n  stdDays = 4;\n  economyDays = 8;\n  expressDays = 2;\n  break;\ncase 1: //mon\n   if (nowTimestamp > expressEnd){\n    expressDays = 2;\n    stdDays = 3;\n  }\n  break;\ncase 2: //tues\n   if (nowTimestamp > expressEnd){\n    expressDays = 2;\n    stdDays = 3;\n  }\n  break;\ncase 3: // wed\n  if (nowTimestamp > expressEnd){\n    expressDays = 2;\n    stdDays = 5;\n  }\n  break;\ncase 4: // thur\n  stdDays = 4;\n  if (nowTimestamp > expressEnd){\n    expressDays = 4;\n    stdDays = 5;\n  }\n  break;\ncase 5: //fri\n    stdDays = 4;\n    expressDays = 3;\n  if (nowTimestamp > expressEnd){\n    stdDays = 5;\n    expressDays = 4;\n    daysTilSat = 8;\n  }\n  break;\ncase 6: // sat\n  stdDays = 5;\n  economyDays = 9;\n  expressDays = 3;\n  daysTilSat = 7;\n\tbreak;\n}\n\nfunction get_nth_suffix(date) {\n   switch (date) {\n     case 1:\n     case 21:\n     case 31:\n        return 'st';\n     case 2:\n     case 22:\n        return 'nd';\n     case 3:\n     case 23:\n        return 'rd';\n     default:\n        return 'th';\n   }\n }\nvar monthNames = [ \"January\", \"February\", \"March\", \"April\", \"May\", \"June\",\"July\", \"August\", \"September\", \"October\", \"November\", \"December\" ];\n// update the label text\nvar stdDate = new Date(nowYr,nowMth,(nowDate +stdDays));\nvar stdDateString = stdDate.getDate()+get_nth_suffix(stdDate.getDate()) + ' '+ monthNames[stdDate.getMonth()];\nvar ecoDate = new Date(nowYr,nowMth,(nowDate +economyDays));\nvar ecoDateString = ecoDate.getDate()+get_nth_suffix(ecoDate.getDate()) + ' '+ monthNames[ecoDate.getMonth()];\nvar expDate = new Date(nowYr,nowMth,(nowDate +expressDays));\nvar expDateString = expDate.getDate()+get_nth_suffix(expDate.getDate()) + ' '+ monthNames[expDate.getMonth()];\njQuery('.cf-standard label').html('Standard: <strong>Guaranteed by '+ stdDateString + ' </strong><span class=\"price-right\">&pound;'+prices['standard'] +'</span>');\njQuery('.cf-free label').html('Free: By '+ stdDateString);\njQuery('.cf-reduced label').html('Economy: 5 working days <span class=\"price-right\">&pound;'+prices['reduced'] +'</span>');\n;\nvar satDate = new Date(nowYr,nowMth,(nowDate +daysTilSat));\nvar satDateString = satDate.getDate()+get_nth_suffix(satDate.getDate()) + ' '+ monthNames[satDate.getMonth()];\njQuery('.cf-saturday label').html('Saturday: <strong>Guaranteed on Saturday '+ satDateString+ ' </strong><span class=\"price-right\">&pound;'+prices['saturday'] +'</span>');\njQuery('.cf-express label').html('Premium: <strong>Guaranteed by '+expDateString+' </strong><span class=\"price-right\">&pound;'+prices['express'] +'</span>');\njQuery('.cf-priority label').html('Priority: <strong>Guaranteed by 1pm '+expDateString+' </strong><span class=\"price-right\">&pound;'+prices['priority'] +'</span>');\nif (nowHrs < 14) {\n  var sdday = 'today';\n} else {\n  var sdday = 'tomorrow';\n}\njQuery('.cf-sameday label').html('Same Day: <strong>Guaranteed by 9pm '+sdday+'</strong><span class=\"price-right\">&pound;'+prices['sameday']+'</span><span class=\"small-text shipping_popup_link\" onmousemove=\"moveProdPopup(9,event)\" onmouseover=\"showShippingPopup(9,event)\" onmouseout=\"hideShippingPopup(9)\">Selected London postcodes only</span>');\n\n// move the new divs to the appropiate div\njQuery('.cf-free').appendTo(jQuery('#cf-shipping-uk'));\njQuery('.cf-reduced').appendTo(jQuery('#cf-shipping-uk'));\njQuery('.cf-standard').appendTo(jQuery('#cf-shipping-uk'));\njQuery('.cf-express').appendTo(jQuery('#cf-shipping-uk'));\njQuery('.cf-priority').appendTo(jQuery('#cf-shipping-uk'));\njQuery('.cf-saturday').appendTo(jQuery('#cf-shipping-uk'));\njQuery('.cf-sameday').appendTo(jQuery('#cf-shipping-uk'));\n\nif (hideFreeShippingOptions == true){\n  jQuery('.cf-reduced,.cf-standard').hide();\n}\n// jQuery('.cf-pickup_hdn').appendTo(jQuery('#cf-shipping-pickup'));\n// jQuery('.cf-pickup').appendTo(jQuery('#cf-shipping-pickup'));\njQuery('.cf-overseas_rm, .cf-overseas_cr,#div_overseas_country').appendTo(jQuery('#cf-shipping-international'));\n// sort out the pick up labels\n// jQuery('.cf-pickup label span.shipping_popup_link').text('?');\n// jQuery('.cf-pickup label').html('London West End Store (<a href=\"https://maps.google.co.uk/maps?q=119+Shaftesbury+Avenue,+London+WC2H+8AE&hnear=119+Shaftesbury+Ave,+London+WC2H+8AE,+United+Kingdom&t=h&z=16&iwloc=A\" target=\"_blank\">view on map</a>) '+ jQuery('.cf-pickup label span.shipping_popup_link').prop(\"outerHTML\") +' <span class=\"price-right\">&pound;'+prices['pickup'] +'</span>');\n// jQuery('.cf-pickup_hdn  label span.shipping_popup_link').text('?');\n// jQuery('.cf-pickup_hdn label').html('North London Store (<a href=\"https://maps.google.co.uk/maps?q=1+Garrick+Rd+Edgware,+London,+Greater+London+NW9+6AA+%E2%80%8E&hl=en&ie=UTF8&sll=51.580472,-0.242589&sspn=0.011934,0.033023&t=h&hnear=1+Garrick+Rd,+Edgware,+London+NW9+6AA,+United+Kingdom&z=16\" target=\"_blank\">view on map</a>) '+ jQuery('.cf-pickup_hdn label span.shipping_popup_link').prop(\"outerHTML\") +' <span class=\"price-right\">&pound;'+prices['pickup_hdn'] +'</span>');\n// build accordion\n// find which tab the active shipping method is in\nvar activeTab = 0;\nif (jQuery('#cf-shipping-pickup input[name=shipping_method]:checked').length > 0){\n  activeTab = 1;\n} else if (jQuery('#cf-shipping-international input[name=shipping_method]:checked').length > 0) {\n  activeTab = 2;\n}\njQuery('#shipping_options').wrapInner('<div class=\"cf-accordion\"></div>');\njQuery('.hide_shipping_popup').insertAfter(jQuery('#shipping_options .cf-accordion'));\njQuery('#shipping_options .cf-accordion').accordion({autoHeight: false, active: activeTab});\njQuery('#shipping_options label').click(function(){jQuery(this).parent().find(jQuery('[type=\"radio\"]')).click();});\n// add a hidden field to the form\nif(jQuery('#shipping input[name=\"shipping_method\"]').length<1) {\njQuery('form#shipping').append(jQuery('<input type=\"hidden\" id=\"cf-shipping_method\" name=\"shipping_method\" value=\"'+jQuery('input[name=\"shipping_method\"]:checked').val()+'\" />'));\n}\n\n$('head').append('<style type=\"text/css\">#shipping_options label { position: relative; top: -1px; } .cf-pickup { display: none !important; }</style>');\n\n\nvar xOffset=450;\nvar yOffset=10;\n\nshowShippingPopup = function (popupNo,event) {\n\n  var x=event.clientX - xOffset + document.documentElement.scrollLeft;\n  var y=event.clientY - yOffset + document.documentElement.scrollTop;\n\n  var sdiv=document.getElementById(\"shipping_popup_shadow\");\n  sdiv.style.top=y + shadowOffset +\"px\";\n  sdiv.style.left=x + shadowOffset +\"px\";\n  sdiv.setAttribute(\"class\",\"show_shipping_popup_shadow\");\n  sdiv.className=\"show_shipping_popup_shadow\";\n\n  var div=document.getElementById(\"shipping_popup\"+popupNo);\n  div.style.top=y+\"px\";\n  div.style.left=x+\"px\";\n  div.setAttribute(\"class\",\"show_shipping_popup\");\n  div.className=\"show_shipping_popup\";\n};",
                "name": "Delivery"
            },
            "2011230382": {
                "code": "// Track Blood in basket\n$('input[name=\"b_checkout\"], input[name=\"b_paypal\"]').click(function() { \nif(typeof($('#qty_array\\\\.1768-').attr('value'))!=\"undefined\") {\ncFact.createCookie(\"cfBldItems\",$('#qty_array\\\\.1768-').attr('value'));\n}\n});",
            ...
            "2011220400": {
                "code": "// Add custom styling \n$('head').append('<link href=\"//s3-eu-west-1.amazonaws.com/cfactory-img/ANG/013/css/style.css\" rel=\"stylesheet\" type=\"text/css\" media=\"all\">');\n\n// Check if fake blood exists\nvar fakeBlood = false;\n$('.basket .radio label').each(function() {\n\tvar del_array = $(this).attr('for').split('.');\n\tvar del_num_array = del_array[1].split('-');\n\tif (del_num_array[0] == '1768' || del_num_array[0] == '1764' || del_num_array[0] == '1765' || del_num_array[0] == '1766' || del_num_array[0] == '4211030') {\n\t\tfakeBlood = true;\n\t}\n});\nif (!fakeBlood) {\n\t// Add fake blood upsell\n\t$('table.basket tr:last').before('<tr><td colspan=\"5\" class=\"upsell\"><div id=\"blood-upsell\"> <div class=\"preview\"><img src=\"//s3-eu-west-1.amazonaws.com/cfactory-img/ANG/013/images/before-after.jpg\" alt=\"Before After\"></div> <div class=\"desc-container\"> <div class=\"add\"> <img src=\"//s3-eu-west-1.amazonaws.com/cfactory-img/ANG/013/images/blood-preview.jpg\" alt=\"Blood Preview\"> <p>15ml Blood &pound;3.99</p> <form id=\"upsell-form\" action=\"/costumes/add_qtys\" method=\"post\"> <button id=\"blood-basket\">ADD TO<br>BASKET</button> <input type=\"hidden\" name=\"category_id\" value=\"76\"/> <input type=\"hidden\" name=\"product_id\" value=\"1768\"/> <input type=\"hidden\" name=\"size_choice\" id=\"size_choice\" value=\"\"/> <input type=\"hidden\" name=\"hire\" id=\"hire\" value=\"f\"/>\t</form> </div> <div class=\"desc\"> <h3>Go From Bore to Gore with Angels Blood!</h3> <p>No Halloween costume is complete without copious amounts of fake blood. Here at Angels we take blood very seriously. Our unique fake blood won\\'t stain your skin and washes out of most fabrics. Perfect for cleaning up after whatever gruesome deeds you get up to on the night!</p> </div> </div> </div></td></tr>');\n}\n\n// Track Blood in basket\n$('input[name=\"b_checkout\"], input[name=\"b_paypal\"]').click(function() { \nif(typeof($('#qty_array\\\\.1768-').attr('value'))!=\"undefined\") {\ncFact.createCookie(\"cfBldItems\",$('#qty_array\\\\.1768-').attr('value'));\n}\n});",
                "name": "Blood Upsell"
            }
        },
        "version": "master-1744.380574169777097211",
        "admin_account_id": 52709471,
        "blacklisted_experiments": [1766361089, 1790135304, 1930940075, 850620038, 1889662130, 2161060659, 2153580422, 537420556, 634390594, 1804540046, 1561272335, 1913550224, 2095980049, 347461650, 555000340, 2108640558, 2027550870, 1962090201, 1260585241, 2166750107, 2195104156, 2180241607, 2153460387, 1902800164, 831155334, 1120371497, 1754470100, 1601740039, 2106172689, 2009650093, 1758000558, 1834890159, 1886340273, 702434738, 753333555, 2018610103, 1772370172, 1768433783, 1997820362, 1038730174, 1996620095, 2155220052, 1885880641, 1374517698, 1481490294, 714806214, 1356911943, 594423113, 1897570378, 2083430219, 1501072205, 2131890254, 537632758, 381520468, 1633342158, 2006060502, 2156540119, 2207911768, 1768433497, 1417151818, 1970880096, 2123911265, 2130343548, 1768100196, 595041511, 577671913, 581083114, 2234540903, 1866210028, 681530094, 2166940029, 1216610032, 2117060211, 1892661322, 595810678, 1756961911, 2061060052, 1505424575, 695033724, 2090650621, 1988420222, 2109180565],
        "project_id": 201285641,
        "sections": {
            "2003800344": {
                "name": "Section #1",
                "variation_ids": ["2003380801", "2011220400"]
            },
            "2006570333": {
                "name": "Section #2",
                "variation_ids": ["2011230382", "2009490345"]
            }
        },
        "segments": {
            "201300320": {
            ...
            "329366372": {
                "audience_id": 1591954959,
                "api_name": "friday",
                "id": 329366372,
                "name": "Friday"
            },
            "696292967": {
                "audience_id": 699433301,
                "api_name": "ie_11_1",
                "id": 696292967,
                "name": "IE 11 (1)"
            },
            ...
            "721700989": {
                "audience_id": 721700990,
                "api_name": "ie_10_1",
                "id": 721700989,
                "name": "IE 10 (1)"
            },
            "746451441": {
                "audience_id": 696953165,
                "api_name": "ie_1",
                "id": 746451441,
                "name": "IE 8 (1)"
            },
            "946870068": {
                "api_name": "has_accessories",
                "is_api_only": true,
                "dimension_id": 921825541,
                "id": 946870068,
                "name": "Has Accessories"
            },
            "2109000157": {
                "audience_id": 2141460041,
                "id": 2109000157,
                "name": "Returning"
            },
            "328960151": {
            ...
            "349600669": {
                "api_name": "seen_countdown_modal",
                "is_api_only": true,
                "dimension_id": 1589014792,
                "id": 349600669,
                "name": "Seen Countdown Modal"
            },
            "697163006": {
                "audience_id": 718603765,
                "api_name": "ie_9_1",
                "id": 697163006,
                "name": "IE 9 (1)"
            }
        ...
        "click_goals": [{
            "event_name": "benefit_bar_clicks",
            "experiments": {
                "252780024": true,
                "201285670": true
            },
            "selector": ".offer-blocks, #header_buts_lrg"
        }, {
            "event_name": "navigation_clicks",
            "experiments": {
                "252780024": true,
                "1768433497": true,
                "201285670": true
            },
            "selector": ".cfheader > .nav, #header_tabs"
        }, {
            "event_name": "add_to_basket_click",
            "experiments": {
                "337028299": true,
                "299341574": true
            },
            "selector": "input[src=\"/resources/images/button/addtobasket.gif\"]"
        }, {
            "event_name": "bloodBarCTAClicks",
            "experiments": {
                "381520468": true,
                "347461650": true,
                "2002910396": true,
            ...
            "selector": "#blood-basket"
        }, {
            "event_name": "countdownLinkClicks",
            "experiments": {
                "553530842": true,
                "341470154": true,
                "536260653": true,
            ...
            "selector": "#guaranteed-link"
        }, {
            "event_name": "add_to_basket_clicks",
            "experiments": {
                "753333555": true
            },
            "selector": ".cf-upsell .cta"
        }, {
            "event_name": "logo",
            "experiments": {
                "1382211317": true
            ...
            "event_name": "purcyhase",
            "experiments": {
                "1382211317": true
            },
            "selector": ".banner5_sub_title > img,.banner3_sub_title > img,.logo img,.nav > ul > li:eq(4) > a:eq(0)"
        }, {
            "event_name": "submit_clicks",
            "experiments": {
                "1970880096": true,
                "1804540046": true
            },
            "selector": "#cf-search .inner input[type=\"submit\"],#header_search_form button"
        }, {
            "event_name": "ang_027-bill_to_update",
            "experiments": {
                "1962090201": true
            },
            "selector": "#order > tbody > tr:eq(3) > th:eq(0) > a:eq(0) > img:eq(0)"
        }, {
            "event_name": "ang027-_payment_update",
            "experiments": {
                "1962090201": true
            },
            "selector": "#order > tbody > tr:eq(2) > th:eq(0) > a:eq(0) > img:eq(0)"
        }, {
            "event_name": "ang_027-deliver_update",
            "experiments": {
                "1962090201": true
            },
            "selector": "#order > tbody > tr:eq(3) > th:eq(1) > a:eq(0) > img:eq(0)"
        }, {
            "event_name": "ang_027_-_rightsidebar_update",
            "experiments": {
                "1962090201": true
            },
            "selector": ".total_txt img"
        }, {
            "event_name": "ang027_-_ctas",
            "experiments": {
                "1962090201": true
            },
            "selector": ".cf_cta027, #order_detail input"
        }, {
            "event_name": "image_grid_top_left",
            "experiments": {
                "2123911265": true
            },
            "selector": "#promo_buts_left > a:eq(0)"
        }, {
            "event_name": "image_grid_bottom_left",
            "experiments": {
                "2123911265": true
            },
            "selector": "#promo_buts_left > a:eq(1)"
        }, {
            "event_name": "image_grid_top_right",
            "experiments": {
                "2123911265": true
            },
            "selector": "#promo_buts_right > a:eq(0)"
        }, {
            "event_name": "image_grid_bottom_right",
            "experiments": {
                "2123911265": true
            },
            "selector": "#promo_buts_right > a:eq(1)"
        }
        ],
        "revision": 1527
    };
