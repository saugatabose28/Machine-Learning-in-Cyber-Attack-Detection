...
(function() {
    var f = encodeURIComponent, g = window, k = decodeURIComponent, m = "shift", n = "replace", s = "split", t = "push", x = "test", A = "length", B = "join";
    var C = g, D = document, aa = C.location, ba = function() {}, ca = /\[native code\]/, F = function(a, b, c) {
        return a[b] = a[b] || c
    }, da = function(a) {
        ...
        a = a.sort();
        for (var b = [], c = void 0, d = 0; d < a[A]; d++) {
            var e = a[d];
            e != c && b[t](e);
            c = e
        }
    ...
    var L = F(I, "perf", G()), M = F(L, "g", G()), ga = F(L, "i", G());
    F(L, "r", []);
    G();
    G();
    var N = function(a, b, c) {
        var d = L.r;
        "function" === typeof d ? d(a, b, c) : d[t]([a, b, c])
    }, P = function(a, b, c) {
        b && 0 < b[A] && (b = O(b), c && 0 < c[A] && (b += "___" + O(c)), 28 < b[A] && (b = b.substr(0, 28) + (b[A] - 28)), c = b, b = F(ga, "_p", G()), F(b, c, G())[a] = (new Date).getTime(), N(a, "_p", c))
    }, O = function(a) {
        return a[B]("__")[n](/\./g, "_")[n](/\-/g, "_")[n](/\,/g, "_")
    };
    var R = G(), S = [], T = function(a) {
    ...
    S[t](["jsl", function(a) {
        ...
        if (b = a.u)
            a = F(I, "us", []), a[t](b), (b = /^https:(.*)$/.exec(b)) && a[t]("http:" + b[1])
    }
    ]);
    var ha = /^(\/[a-zA-Z0-9_\-]+)+$/, ia = /^[a-zA-Z0-9\-_\.,!]+$/, ja = /^gapi\.loaded_[0-9]+$/, ka = /^[a-zA-Z0-9,._-]+$/, oa = function(a, b, c, d) {
        var e = a[s](";"), h = R[e[m]()], l = null;
        h && (l = h(e, b, c, d));
        if (b = l)
            b = l, c = b.match(la), d = b.match(ma), b=!!d && 1 === d[A] && na[x](b)&&!!c && 1 === c[A];
        b || T(a);
        return l
    }, qa = function(a, b, c, d) {
        a = pa(a);
        ja[x](c) || T("invalid_callback");
        b = U(b);
        d = d && d[A] ? U(d) : null;
        var e = function(a) {
            return f(a)[n](/%2C/g, ",")
        };
        return [f(a.d)[n](/%2C/g, ",")[n](/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d):
        "", "/rt=j/sv=1/d=1/ed=1", a.a ? "/am=" + e(a.a): "", a.b ? "/rs=" + e(a.b): "", "/cb=", e(c)][B]("")
    }, pa = function(a) {
        "/" !== a.charAt(0) && T("relative path");
        for (var b = a.substring(1)[s]("/"), c = []; b[A];) {
            a = b[m]();
            if (!a[A] || 0 == a.indexOf("."))
                T("empty/relative directory");
            else if (0 < a.indexOf("=")) {
                b.unshift(a);
                break
            }
        ...
        for (var d = 0, e = b[A]; d < e; ++d) {
            var h = b[d][s]("="), l = k(h[0]), p = k(h[1]);
            2 == h[A] && l && p && (a[l] = a[l] || p)
        }
        b = "/" + c[B]("/");
        ha[x](b) || T("invalid_prefix");
        c = V(a, "k", !0);
        d = V(a, "am");
        a = V(a, "rs");
        return {
    ...
    var W = decodeURI("%73cript"), X = function(a, b) {
        for (var c = [], d = 0; d < a[A]; ++d) {
            var e = a[d];
            e && 0 > da.call(b, e) && c[t](e)
        }
        return c
    }, sa = function(a) {
        ...
        ta(a, c);
        var d = a ? a[s](":"): [], e = c.h || ra(), h = F(I, "ah", G());
        if (h["::"] && d[A]) {
            for (var l = [], p = null; p = d[m]();) {
                var u = p[s]("."), u = h[p] || h[u[1] && "ns:" + u[0] || ""] || e, r = l[A] && l[l[A] - 1] || null, y = r;
                r && r.hint == u || (y = {
                    hint: u,
                    c: []
                }, l[t](y));
        ...
        a = ea(a) || [];
        var d = b.callback, e = b.config, h = b.timeout, l = b.ontimeout, p = null, u=!1;
        if (h&&!l ||!h && l)
            throw "Timeout requires both the timeout parameter and ontimeout parameter to be set";
        var r = F(K(c), "r", []).sort(), y = F(K(c), "L", []).sort(), z = [].concat(r), E = function(a, b) {
            if (u)
                return 0;
            C.clearTimeout(p);
            y[t].apply(y, q);
        ...
        "jsl": {
            "ci": {
                ...
                "iframes": {
                    ...
                    "managers": {
                        "url": ":socialhost:/:session_prefix:_/widget/render/managers?usegapi\u003d1"
                    },
                    "visibility": {
                        "params": {
                            "url": ""
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en._V0Y4125WIk.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/t\u003dzcms/rs\u003dAGLTcCPtUtCvPClIHD1wamy4HT_F4sbLEg",
            "u": "https://apis.google.com/js/api.js",
            "hee": true,
            "fp": "d0ce045442818e2f02c4fdb22e99d6880c51d83f",
            "dpo": false
        },
        "fp": "d0ce045442818e2f02c4fdb22e99d6880c51d83f",
