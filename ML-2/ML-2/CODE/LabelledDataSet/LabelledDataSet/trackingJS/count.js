...
typeof DISQUSWIDGETS == "undefined" && (DISQUSWIDGETS = function() {
    var c = {}, q = document.getElementsByTagName("HEAD")[0] || document.body, h = {}, o = {
        identifier: 1,
        url: 2
    };
    c.domain = "disqus.com";
    ...
    c.getCount = function(a) {
        ...
        []], k, g, e, f, l = 0; l < a.length; l++) {
            ...
            for (var m = 0; m < k.length; m++) {
                ...
                if (e)
                    ...
                    continue;
                var n;
                h.hasOwnProperty(e) ? n = h[e] : (n = h[e] = {
                    elements: [],
                    type: f
                }, d.push(b(f) + "=" + b(e)));
                n.elements.push(g)
        ...
        d.sort();
        for (b = d.slice(i, j); b.length;)
            a = document.createElement("script"), a.async=!0, a.src = r + b.join("&") + p, q.appendChild(a),
            i += 10, j += 10, b = d.slice(i, j)
    };
    c.displayCount = function(a) {
        for (var b, c, d, i = a.counts, a = a.text.comments; b = i.shift();)
            if (c = h[b.id]) {
                switch (b.comments) {
                case 0:
                    d = a.zero;
