...
(function(e, t) {
    ...
    return function(r) {
        ...
        return n.prototype = {
            ...
            isIE: function() {
                return navigator.appName == "Microsoft Internet Explorer" || navigator.appName == "Netscape" && (new RegExp("Trident/.*rv:")).exec(navigator.userAgent) !== null
            },
            isIPad: function(e) {
        ...
        return t.prototype = {
            ...
            _resolvePromises: function() {
                var e = this._adobeIMS().getAccessTokenInfo();
                e ? this._getAccessTokenInfoPromise.resolve(e) : this._getAccessTokenInfoPromise.reject();
                var t = this._adobeIMS().getAccessToken();
                t ? this._getAccessTokenPromise.resolve(t) : this._getAccessTokenPromise.reject();
                var n = this._adobeIMS().getUserProfile();
                n ? this._getProfilePromise.resolve(n) : this._getProfilePromise.reject()
            },
            ...
            getAccessToken: function(e) {
                return e && this._adobeIMS().makeApiCall(this._adobeIMS().IMSAPIs.check, {
                    client_id: this._adobeid.client_id,
                    scope: this._adobeid.scope
                }, function(e) {
                    e && e.access_token ? this._getAccessTokenPromise.resolve(e.access_token) : this._getAccessTokenPromise.reject()
                }.bind(this)), this._getAccessTokenPromise
            },
            getAccessTokenInfo: function() {
                return this._getAccessTokenInfoPromise
            },
            ...
            resetAccessTokenPromise: function() {
                return this._getAccessTokenPromise = new e, this._getAccessTokenPromise
            },
            signIn: function() {
        ...
        return p.prototype = {
            ...
            _initPromises: function() {
                ...
                if (!h.arrayHas(this._options.sections, "profile"))
                    return;
                this._imsGetAccessTokenInfoPromise = this._ims.getAccessTokenInfo(), this._imsGetAccessTokenPromise = this._options._entitlements ? h.wrapInPromise({}) : this._ims.getAccessToken(), this._imsGetProfilePromise = h.wrapInPromise(this._options._imsProfile) || this._ims.getProfile();
            ...
            _fetchEntitlements: function(e, t) {
                var n = (new Date).getTime();
                if (t && t.expiresAtMilliseconds && n > t.expiresAtMilliseconds - 15e3) {
                    var r = this._ims.resetAccessTokenPromise();
                    r.then(function(e) {
                        this._accountServices.setToken(e), this._accountServices.getEntitlements()
                    }.bind(this), function() {
                        this._accountServices.setToken(e), this._accountServices.getEntitlements(), u.error("Refreshing access token")
                    }.bind(this)), this._ims.getAccessToken(!0)
                } else 
                    this._accountServices.setToken(e), this._accountServices.getEntitlements()
            },
