        ...
        f: function() {
            return {
                ...
                make: function(a) {
                    ...
                    for (b in a)
                        if (a[b].hasOwnProperty) {
                            ...
                            for (c in a[b])
                                a[b][c].hasOwnProperty && "string" === typeof a[b][c] && d.f.set(e, c, a[b][c]);
                                break
                        }
                    return e
                },
                ...
                getButtonConfig: function(a) {
                    ...
                    return c && parseInt(c) > 0 && (b.id = parseInt(c)), "round" === b.shape ? ("16" !== b.height && "32" !== b.height && (b.height = "16"), b.color = "red") : "rect" === b.shape ? ("20" !== b.height && "28" !== b.height && (b.height = "20"), "gray" !== b.color && "red" !== b.color && "white" !== b.color && (b.color = "gray")) : (b.shape = "rect", b.height = "20", b.color = "gray"), "rect" === b.shape ? d.a.hazAssets[b.assets] || (b.assets = d.v.config.assets) : b.assets = "en", b
                },
                showFloatingButton: function(a) {
                    ...
                    if (a.height > d.a.minImgSize && a.width > d.a.minImgSize&&!a.src.match(/^data/)) {
                        ...
                        })) : (e = d.v.endpoint.create + "guid=" + d.v.guid + "&url=" + encodeURIComponent(d.d.URL) + "&media=" + encodeURIComponent(a.src) + "&description=" + encodeURIComponent(a.getAttribute("data-pin-description") || a.title || a.alt || d.d.title), d.s.floatingButton = d.f.make({
                            A: {
                                className: c,
                                title: "Pin it!",
                ...
                click: function(a) {
                    a = a || d.w.event;
                    var b, c;
                    if (b = d.f.getEl(a), b && (c = d.f.getData(b, "log")))
                        if ("embed_pin_play" === c) {
                            var e = b.parentNode.getElementsByTagName("IMG")[0];
                            "II GIF" !== b.innerHTML ? (b.innerHTML = "II GIF", e.src = e.src.replace(/237x/, "originals")) : (b.innerHTML = "&#9654; GIF", e.src = e.src.replace(/originals/, "237x"))
                        } else {
                            var f = d.f.getData(b, "href");
                            if (f)
                                switch (d.f.log("&type=" + c + "&href=" + encodeURIComponent(f)), b.className.match(/hazClick/) || (b.className = b.className + " " + d.a.k + "_hazClick"), c) {
                                case"button_pinit":
                                    var g = d.f.parse(f, {
                                        url: !0,
                                        media: !0,
                                    ...
                                    g.description || d.f.log("&type=config_warning&warning_msg=no_description&href=" + encodeURIComponent(d.d.URL)), g.url && g.url.match(/^http/i) && g.media && g.media.match(/^http/i) ? d.w.open(f, "pin" + (new Date).getTime(), d.a.pop) : (d.f.log("&type=config_error&error_msg=invalid_url&href=" + encodeURIComponent(d.d.URL)), d.f.fireBookmark());
                                    break;
                                ...
                                case"button_pinit_floating_repin":
                                    d.w.open(f, "pin" + (new Date).getTime(), d.a.pop), d.f.hideFloatingButton(), d.v.hazFloatingButton=!1;
                                    break;
                                ...
                                case"embed_user_thumb":
                                    d.w.open(f, "pin" + (new Date).getTime(), d.a.pop);
                                    break;
                                case"button_follow":
                                    d.w.open(f, "pin" + (new Date).getTime(), d.a.popHuge);
                                    break;
                ...
                behavior: function() {
                    ...
                    var a = function() {
                        for (var b = d.d.getElementsByTagName("SCRIPT"), c = 0, e = b.length; c < e; c += 1)
                            b[c] && b[c].src && b[c].src.match(/^https?:\/\/logc?\.pinterest\.com/) && d.f.kill(b[c]);
                ...
                grid: function(a, b, c) {
                    ...
                    if (i > d.a.tile.maxColumns && (i = d.a.tile.maxColumns), i < d.a.tile.minColumns)
                        return !1;
                    var j = d.f.make({
                        SPAN: {
                            className: d.a.k + "_embed_grid_bd"
                        }
                    });
                    ...
                    for (var k = d.f.make({
                        SPAN: {
                            className: d.a.k + "_embed_grid_ct"
                        }
                    }), l = 0, m = [], n = 0, o = b.length; n < o; n += 1) {
                        var p = d.f.make({
                            SPAN: {
                            ...
                            height: b[n].images["237x"].height * (e.width / b[n].images["237x"].width),
                            width: e.width
                        }, s = d.f.make({
                            IMG: {
                                src: b[n].images["237x"].url,
                                "data-pin-nopin": "true",
                                height: r.height,
                                width: r.width,
                        ...
                        s.style.height = r.height + "px", s.style.width = r.width + "px", s.style.marginTop = 0 - r.height / d.a.tile.style.margin + "px", r.height > e.height && (r.height = e.height), q.appendChild(s), q.style.height = r.height + "px", q.style.width = r.width + "px", m[l] || (m[l] = 0), q.style.top = m[l] + "px", q.style.left = l * (e.width + d.a.tile.style.margin) + "px", m[l] = m[l] + r.height + d.a.tile.style.margin, q.appendChild(s), k.appendChild(q), l = (l + 1)%i
                    }
                    for (var t = 1e4, n = 0; n < m.length; n += 1)
                        m[n] < t && (t = m[n]);
                    return k.style.height = t + "px", j.appendChild(k), d.v.userAgent.match(/Mac OS X/) && (j.className = j.className + " " + d.a.k + "_embed_grid_scrolling_okay"), j
                },
                makeHeader: function(a, b, c, e) {
                    var f = d.v.endpoint.pinterest + b.href.split(".com")[1], g = d.f.make({
                        SPAN: {
                            className: d.a.k + "_embed_grid_hd"
                        }
                    }), h = d.f.make({
                        A: {
                ...
                ping: {
                    ...
                    count: function(a, b) {
                        ...
                        if (c) {
                            ...
                            d.f.debug("Pin It button container not found.")
                    },
                    pin: function(a, b) {
                        ...
                        if (c && a.data && a.data[0]) {
                            ...
                            var e = a.data[0], f = {};
                            if (e.images && (f = e.images["237x"]), e && e.id && e.description && f.url && f.width && f.height) {
                                ...
                                l.style.width = f.width + "px", l.style.height = f.height + "px", k.appendChild(l);
                                var m = d.a.k + "_repin";
                                "ja" === h && (m += "_ja");
                                var n = d.f.make({
                                    I: {
                                ...
                                if (k.appendChild(n), e.embed && e.embed.type && "gif" === e.embed.type) {
                                    var o = d.f.make({
                                        I: {
                                ...
                                if (e.repin_count || e.like_count) {
                                    var r = d.f.make({
                                        SPAN: {
                                            className: d.a.k + "_embed_pin_stats"
                                        }
                                    });
                                    if (e.repin_count) {
                                        var s = d.f.make({
                                ...
                                if (i.appendChild(p), e.pinner && e.pinner.profile_url && e.pinner.image_small_url && e.pinner.full_name) {
                                    ...
                                    var u = d.f.make({
                                        A: {
                                            className: d.a.k + "_embed_pin_text"
                                        }
                                    });
                                    u.appendChild(d.f.make({
                                        IMG: {
                                            className: d.a.k + "_embed_pin_text_avatar",
                                            src: e.pinner.image_small_url,
                                            "data-pin-log": "embed_pin_pinner",
                                            "data-pin-href": e.pinner.profile_url
                                        }
                                    })), u.appendChild(d.f.make({
                                        SPAN: {
                                            className: d.a.k + "_embed_pin_text_container",
                                            innerHTML: '<span data-pin-log="embed_pin_pinner" data-pin-href="' + e.pinner.profile_url + '" class="' + d.a.k + '_embed_pin_text_container_pinner">' + d.f.filter(e.pinner.full_name) + '</span><span class="' + d.a.k + '_embed_pin_text_container_board">' + d.f.filter(e.board.name) + "</span>",
                                            "data-pin-log": "embed_pin_pinner",
                                            "data-pin-href": e.pinner.profile_url
                                        }
                                    }));
                                    var v = d.f.make({
                                        B: {
                                            className: d.a.k + "_embed_pin_link_shield",
                                            "data-pin-log": "embed_pin_pinner",
                                            "data-pin-href": e.pinner.profile_url
                                        }
                                    });
                                    u.appendChild(v), i.appendChild(u)
                                }
                                d.f.cssHook(c, i), d.f.replace(c, i)
                            } else 
                                d.f.debug("Not enough data to embed a pin; aborting")
                        }
                    },
                    user: function(a, b) {
                        var c = d.d.getElementById(d.a.k + "_" + b);
                        if (c && a.data && a.data.pins && a.data.pins.length) {
                            ...
                            var f = d.f.make({
                                SPAN: {
                                    className: d.a.k + "_embed_grid"
                                }
                            }), g = d.f.getData(c, "style");
                    ...
                    board: function(a, b) {
                        ...
                        if (c && a.data && a.data.pins && a.data.pins.length) {
                            ...
                            var e = d.f.getData(c, "lang") || d.v.config.lang, f = d.f.make({
                                SPAN: {
                                    className: d.a.k + "_embed_grid"
                                }
                            }), g = d.f.getData(c, "style");
                ...
                parse: function(a, b) {
                    var c, d, e, f, g, h;
                    if (h = {}, c = a.split("#")[0].split("?"), c[1])
                        for (d = c[1].split("&"), f = 0, g = d.length; f < g; f += 1)
                            e = d[f].split("="), 2 === e.length && b[e[0]] && (h[e[0]] = e[1]);
                    return h
                },
                fixUrl: function(a) {
                    var b = "";
                ...
                render: {
                    buttonBookmark: function(a) {
                        ...
                        if ((d.f.getData(a, "zero") || d.v.config.zero) && d.f.set(e, d.a.dataAttributePrefix + "zero", !0), d.a.config.pinItCountPosition[b.config]===!0 && "rect" === b.shape) {
                            ...
                            e.className = e.className + " " + d.a.k + "_pin_it_none";
                    ...
                    buttonFollow: function(a) {
                        ...
                        a.href.match(/\/follow\//) ? e.setAttribute("data-pin-log", "button_follow_auto") : (e.setAttribute("data-pin-log", "button_follow"), a.href.match(/\/$/) || (a.href = a.href + "/"), a.href.match(/pins\/follow\/$/) || (a.href = a.href + "pins/follow/"), e.setAttribute("data-pin-href", a.href + "?guid=" + d.v.guid + "-" + d.v.buttonId)), e.appendChild(d.f.make({
                            B: {}
                        })), e.appendChild(d.f.make({
                            I: {}
                        })), d.f.replace(a, e), d.v.buttonId = d.v.buttonId + 1, d.v.countFollow = d.v.countFollow + 1
                    },
                    embedPin: function(a) {
                        d.f.debug("build embedded pin");
                        var b = a.href.split("/")[4];
                        b && parseInt(b, 10) > 0 && d.f.getPinsIn("pin", "", {
                            pin_ids: b
                        }), d.v.countPin = d.v.countPin + 1
                    },
                ...
                getPinsIn: function(a, b, c) {
                    ...
                    for (e in c)
                        c[e].hasOwnProperty && (f = f + g + e + "=" + c[e], g = "&");
                ...
                build: function(a) {
                    ...
                    for (c = 0, b = h.length; c < b; c += 1)
                        j.push(h[c]);
                    for (c = 0, b = j.length; c < b; c += 1)
                        j[c].href && j[c].href.match(d.a.myDomain) && (e = d.f.getData(j[c], "do"), !e && j[c].href.match(/pin\/create\/button/) && (e = "buttonPin", g = "none", f = d.f.get(j[c], "count-layout"), f && i[f] && (g = i[f]), d.f.set(j[c], "data-pin-config", g)), "function" === typeof d.f.render[e] && (j[c].id = d.a.k + "_" + d.f.callback.length, d.f.render[e](j[c])))
                },
                config: function() {
                    var a, b, c, e = d.d.getElementsByTagName("SCRIPT");
                    for (a = e.length - 1; a>-1; a -= 1)
                        if (d.a.me && e[a] && e[a].src && e[a].src.match(d.a.me)) {
                            for (b = 0; b < d.a.configParam.length; b += 1)
                                c = d.f.get(e[a], d.a.dataAttributePrefix + d.a.configParam[b]), c && (d.v.config[d.a.configParam[b]] = c);
                                d.f.kill(e[a])
                        }
                    "string" === typeof d.v.config.build && (d.w[d.v.config.build] = function(a) {
                        ...
                        "string" === typeof d.v.config.logc ? d.f.log(a + "&logc=" + d.v.config.logc, d.a.endpoint.logc) : d.f.log(a)
                    }, 1e3)
                },
                log: function(a, b) {
                    b || (b = d.a.endpoint.log);
                    var c = "?guid=" + d.v.guid;
                    a && (c += a), c = c + "&via=" + encodeURIComponent(d.v.here), d.f.call(b + c, d.f.ping.log)
                },
                langToDomain: function(a) {
                    ...
                    for (f in d.a.domains)
                        if (!k)
                            for (g = d.a.domains[f], i = 0, n = g.lang.length; i < n; i += 1)
                                if ((g.lang[i] === b || g.lang[i] === b + "-" + c) && (h = f, j = b, g.lang[i] === b + "-" + c)) {
                                    j = b + "-" + c, k=!0;
                                    break
                                }
                ...
                init: function() {
                    if (d.d.b = d.d.getElementsByTagName("BODY")[0], d.d.b) {
                        d.d.h = d.d.getElementsByTagName("HEAD")[0], d.v = {
                            ...
                            guid: "",
                            buttonId: 0,
                            protocol: d.w.location.protocol,
                            ...
                            countBoard: 0,
                            countProfile: 0
                        }, "file:" === d.v.protocol && (d.v.protocol = "http:");
                        for (var a in d.a.endpoint)
                            d.a.endpoint[a] = d.v.protocol + d.a.endpoint[a];
                        null !== d.v.userAgent.match(/MSIE/) && (d.v.hazIE=!0);
                        for (var b = 0; b < 12; b += 1)
                            d.v.guid = d.v.guid + "0123456789ABCDEFGHJKLMNPQRSTUVWXYZ_abcdefghijkmnopqrstuvwxyz".substr(Math.floor(60 * Math.random()), 1);
                        d.w.devicePixelRatio && d.w.devicePixelRatio >= 2 && (d.v.resolution = 2), d.f.config();
                        var c = d.a.defaults.lang;
                        if (d.v.config.lang && "object" === typeof d.a.strings[d.v.config.lang])
                            c = d.v.config.lang;
                        else {
                            var c = d.d.getElementsByTagName("HTML")[0].getAttribute("lang");
                            if (!c) {
                                var e = d.d.getElementsByTagName("META");
                                for (b = 0, n = e.length; b < n; b += 1) {
                                    var f = d.f.get(e[b], "http-equiv");
                                    if (f && (f = f.toLowerCase(), "content-language" === f)) {
                                        var g = d.f.get(e[b], "content");
                                        if (g) {
                                            c = g.split("-")[0];
                                            break
                                        }
                        ...
                        d.v.config.lang && (c = d.v.config.lang);
                        var h = d.f.langToDomain(c);
                        d.v.config.assets = h.assets, d.v.config.lang = h.lang, d.v.config.domain = h.domain, d.v.endpoint = {
                            pinterest: "//" + h.domain + ".pinterest.com",
                            repin: "//" + h.domain + ".pinterest.com/pin/%s/repin/x/",
                            create: "//" + h.domain + ".pinterest.com/pin/create/button/?"
