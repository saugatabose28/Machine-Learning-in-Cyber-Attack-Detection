...
(function(e) {
    ...
    var c = {
        ...
        _init: function() {
            ...
            s.isIE11 = g.indexOf("Trident/")!=-1 && (g.indexOf("rv:")!=-1 || o.appName.indexOf("Netscape")!=-1);
            s.isOpera = e.opera && opera.buildNumber;
            s.isWebKit = /WebKit/.test(g);
            s.isIE=!s.isWebKit&&!s.isOpera && (/MSIE/gi).test(g) && (/Explorer/gi).test(o.appName) || s.isIE11;
            s.isIE6 = s.isIE && /MSIE [56]/.test(g);
            s.isIE7 = s.isIE && /MSIE [7]/.test(g);
            s.isIE8 = s.isIE && /MSIE [8]/.test(g);
            s.isIE9 = s.isIE && /MSIE [9]/.test(g);
            s.isGecko=!s.isWebKit&&!s.isIE11 && /Gecko/.test(g);
...
tinymce.util.Quirks = function(a) {
    var j = tinymce.VK, f = j.BACKSPACE, k = j.DELETE, e = a.dom, m = a.selection, I = a.settings, x = a.parser, p = a.serializer, F = tinymce.each;
    function B(O, N) {
        try {
            a.getDoc().execCommand(O, false, N)
        } catch (M) {}
    }
    function o() {
        var M = a.getDoc().documentMode;
        return M ? M : 6
    }
    function A(M) {
    ...
    function K() {
        function M(S) {
            ...
            O = m.getRng();
            var W = [O.startContainer, O.startOffset, O.endContainer, O.endOffset];
            if (!O.collapsed) {
                S = true
            }
            P = O[(S ? "start" : "end") + "Container"];
            R = O[(S ? "start" : "end") + "Offset"];
            if (P.nodeType == 3) {
                Q = e.getParent(O.startContainer, e.isBlock);
                if (S) {
                ...
                if (Q && (V() ||!O.collapsed)) {
                    ...
                    F(tinymce.grep(Q.childNodes), function(X) {
                        N.appendChild(X)
                    });
                    Q.appendChild(N)
                }
            ...
            O.setEnd(W[2], W[3]);
            m.setRng(O);
            a.getDoc().execCommand(S ? "ForwardDelete" : "Delete", false, null);
            if (N) {
                T = m.getBookmark();
                while (U = e.get("__mceDel")) {
                    e.remove(U, true)
                }
                m.moveToBookmark(T)
            }
        }
        a.onKeyDown.add(function(N, P) {
            var O;
            O = P.keyCode == k;
            if (!A(P) && (O || P.keyCode == f)&&!j.modifierPressed(P)) {
                P.preventDefault();
                M(O)
            }
        });
    ...
    function r() {
        function M(P) {
            var O = e.create("body");
            var Q = P.cloneContents();
            O.appendChild(Q);
            return m.serializer.serialize(O, {
                format: "html"
            })
        }
        function N(O) {
        ...
        a.onKeyDown.add(function(P, R) {
            var Q = R.keyCode, O;
            if (!A(R) && (Q == k || Q == f)) {
                O = P.selection.isCollapsed();
                if (O&&!e.isEmpty(P.getBody())) {
                    return 
                }
                if (tinymce.isIE&&!O) {
                    return 
                }
                if (!O&&!N(P.selection.getRng())) {
                    return 
                }
                P.setContent("");
                P.selection.setCursorLocation(P.getBody(), 0);
                P.nodeChanged()
            }
        })
    }
    function J() {
        a.onKeyDown.add(function(M, N) {
            if (!A(N) && N.keyCode == 65 && j.metaKeyPressed(N)) {
                N.preventDefault();
    ...
    function L() {
        if (!a.settings.content_editable) {
            e.bind(a.getDoc(), "focusin", function(M) {
                m.setRng(m.getRng())
            });
            e.bind(a.getDoc(), "mousedown", function(M) {
                if (M.target == a.getDoc().documentElement) {
                    a.getWin().focus();
                    m.setRng(m.getRng())
                }
            })
    ...
    function C() {
        a.onKeyDown.add(function(M, P) {
            if (!A(P) && P.keyCode === f) {
                if (m.isCollapsed() && m.getRng(true).startOffset === 0) {
                    var O = m.getNode();
                    var N = O.previousSibling;
                    if (N && N.nodeName && N.nodeName.toLowerCase() === "hr") {
                        e.remove(N);
                        tinymce.dom.Event.cancel(P)
                    }
                }
            }
        })
    ...
    function z() {
        if (!Range.prototype.getClientRects) {
            a.onMouseDown.add(function(N, O) {
                if (!A(O) && O.target.nodeName === "HTML") {
                    var M = N.getBody();
                    M.blur();
                    setTimeout(function() {
                        M.focus()
    ...
    function h() {
        a.onClick.add(function(M, N) {
            N = N.target;
            if (/^(IMG|HR)$/.test(N.nodeName)) {
                m.getSel().setBaseAndExtent(N, 0, N, 1)
            }
            if (N.nodeName == "A" && e.hasClass(N, "mceItemAnchor")) {
                m.select(N)
            }
            M.nodeChanged()
        })
    ...
    function c() {
        function N() {
            var P = e.getAttribs(m.getStart().cloneNode(false));
            return function() {
                var Q = m.getStart();
                if (Q !== a.getBody()) {
                    e.setAttrib(Q, "style", null);
                    F(P, function(R) {
                        Q.setAttributeNode(R.cloneNode(true))
                    })
                }
            }
        }
        function M() {
            return !m.isCollapsed() && e.getParent(m.getStart(), e.isBlock) != e.getParent(m.getEnd(), e.isBlock)
        }
        function O(P, Q) {
            Q.preventDefault();
            return false
        }
        a.onKeyPress.add(function(P, R) {
            var Q;
            if (!A(R) && (R.keyCode == 8 || R.keyCode == 46) && M()) {
                Q = N();
        ...
        e.bind(a.getDoc(), "cut", function(Q) {
            var P;
            if (!A(Q) && M()) {
                P = N();
                a.onKeyUp.addToTop(O);
                setTimeout(function() {
                    P();
                    a.onKeyUp.remove(O)
                }, 0)
    ...
    function b() {
        ...
        e.bind(a.getDoc(), "selectionchange", function() {
            ...
            M = window.setTimeout(function() {
                var O = m.getRng();
                if (!N ||!tinymce.dom.RangeUtils.compareRanges(O, N)) {
                    a.nodeChanged();
                    N = O
                }
            }, 50)
    ...
    function u() {
        a.onKeyDown.add(function(M, O) {
            if (!A(O) && O.keyCode === f) {
                if (m.isCollapsed() && m.getRng(true).startOffset === 0) {
                    var N = m.getNode().previousSibling;
        ...
        x.addNodeFilter("pre", function(M, O) {
            ...
            while (P--) {
                ...
                while (N--) {
                    S = R[N];
                    Q = S.prev;
                    if (Q && Q.type === 3 && Q.value.charAt(Q.value - 1) != "\n") {
                        Q.value += "\n"
                    } else {
                        S.parent.insert(new tinymce.html.Node("#text", 3), S, true).value = "\n"
                    }
                }
            }
        });
        p.addNodeFilter("pre", function(M, O) {
            var P = M.length, R, N, S, Q;
            while (P--) {
                R = M[P].getAll("br");
                N = R.length;
    ...
    function g() {
        e.bind(a.getBody(), "mouseup", function(O) {
            var N, M = m.getNode();
            if (M.nodeName == "IMG") {
                if (N = e.getStyle(M, "width")) {
                    e.setAttrib(M, "width", N.replace(/[^0-9%]+/g, ""));
                    e.setStyle(M, "width", "")
                }
                if (N = e.getStyle(M, "height")) {
                    e.setAttrib(M, "height", N.replace(/[^0-9%]+/g, ""));
                    e.setStyle(M, "height", "")
                }
            }
        })
    ...
    function d() {
        a.onKeyDown.add(function(S, T) {
            var R, M, N, P, Q, U, O;
            R = T.keyCode == k;
            if (!A(T) && (R || T.keyCode == f)&&!j.modifierPressed(T)) {
                M = m.getRng();
                N = M.startContainer;
                P = M.startOffset;
                O = M.collapsed;
                if (N.nodeType == 3 && N.nodeValue.length > 0 && ((P === 0&&!O) || (O && P === (R ? 0 : 1)))) {
                    U = N.previousSibling;
                    if (U && U.nodeName == "IMG") {
                        return 
                    }
                    nonEmptyElements = S.schema.getNonEmptyElements();
                    T.preventDefault();
                    Q = e.create("br", {
                        id: "__tmp"
                    });
                    N.parentNode.insertBefore(Q, N);
                    S.getDoc().execCommand(R ? "ForwardDelete" : "Delete", false, null);
                    N = m.getRng().startContainer;
                    U = N.previousSibling;
                    if (U && U.nodeType == 1&&!e.isBlock(U) && e.isEmpty(U)&&!nonEmptyElements[U.nodeName.toLowerCase()]) {
                        e.remove(U)
                    }
                    e.remove("__tmp")
                }
    ...
    function H() {
        a.onKeyDown.add(function(Q, R) {
            var O, N, S, M, P;
            if (A(R) || R.keyCode != j.BACKSPACE) {
                return 
            }
            O = m.getRng();
            N = O.startContainer;
            ...
            while (P && P.parentNode && P.parentNode.firstChild == P && P.parentNode != M) {
                P = P.parentNode
            }
            if (P.tagName === "BLOCKQUOTE") {
                Q.formatter.toggle("blockquote", null, P);
                O = e.createRng();
                O.setStart(N, 0);
                O.setEnd(N, 0);
                m.setRng(O)
    ...
    function G() {
        function M() {
            ...
            B("StyleWithCSS", false);
            B("enableInlineTableEditing", false);
            if (!I.object_resizing) {
                B("enableObjectResizing", false)
            }
        }
        if (!I.readonly) {
            a.onBeforeExecCommand.add(M);
            a.onMouseDown.add(M)
        }
    }
    function t() {
        function M(N, O) {
            F(e.select("a"), function(R) {
                var P = R.parentNode, Q = e.getRoot();
                if (P.lastChild === R) {
                    while (P&&!e.isBlock(P)) {
                        if (P.parentNode.lastChild !== P || P === Q) {
                            return 
                        }
                        P = P.parentNode
                    }
        ...
        a.onExecCommand.add(function(N, O) {
            if (O === "CreateLink") {
                M(N)
            }
        });
        a.onSetContent.add(m.onSetContent.add(M))
    }
    function n() {
        if (I.forced_root_block) {
            a.onInit.add(function() {
                B("DefaultParagraphSeparator", I.forced_root_block)
            })
        }
    }
    function q() {
        ...
        a.onUndo.add(M);
        a.onRedo.add(M);
        a.onSetContent.add(M)
    }
    function i() {
        a.onKeyDown.add(function(N, O) {
            var M;
            if (!A(O) && O.keyCode == f) {
                M = N.getDoc().selection.createRange();
                if (M && M.item) {
                    O.preventDefault();
                    N.undoManager.beforeChange();
                    e.remove(M.item(0));
                    N.undoManager.add()
                }
            }
    ...
    function s() {
        ...
        if (o() >= 10) {
            M = "";
            F("p div h1 h2 h3 h4 h5 h6".split(" "), function(N, O) {
                M += (O > 0 ? "," : "") + N + ":empty"
            });
            a.contentStyles.push(M + "{padding-right: 1px !important}")
        }
    }
    function v() {
        var O, N, ae, M, Z, ac, aa, ad, P, Q, ab, X, W, Y = document, U = a.getDoc();
        if (!I.object_resizing || I.webkit_fake_resize === false) {
            return 
        }
        B("enableObjectResizing", false);
        ab = {
        ...
        function S(ai) {
            ...
            X = X < 5 ? 5 : X;
            W = W < 5 ? 5 : W;
            if (j.modifierPressed(ai) || (ae.nodeName == "IMG" && Z[2] * Z[3] !== 0)) {
                X = Math.round(W / Q);
                W = Math.round(X * Q)
            }
            e.setStyles(M, {
            ...
            if (Z[2] < 0 && M.clientWidth <= X) {
                e.setStyle(M, "left", O + (ad - X))
            }
            if (Z[3] < 0 && M.clientHeight <= W) {
                e.setStyle(M, "top", N + (P - W))
            }
        }
        function af() {
            function ag(ah, ai) {
                if (ai) {
                    if (ae.style[ah] ||!a.schema.isValid(ae.nodeName.toLowerCase(), ah)) {
                        e.setStyle(ae, ah, ai)
                    } else {
                        e.setAttrib(ae, ah, ai)
                    }
                }
            }
            ag("width", X);
            ag("height", W);
            e.unbind(U, "mousemove", S);
            e.unbind(U, "mouseup", af);
            if (Y != U) {
                e.unbind(Y, "mousemove", S);
                e.unbind(Y, "mouseup", af)
            }
            e.remove(M);
            R(ae)
        }
        function R(aj) {
            ...
            F(ab, function(am, ak) {
                var al;
                al = e.get("mceResizeHandle" + ak);
                if (!al) {
                    al = e.add(U.documentElement, "div", {
                        id: "mceResizeHandle" + ak,
                        "class": "mceResizeHandle",
                        style: "cursor:" + ak + "-resize; margin:0; padding:0"
                    });
                    e.bind(al, "mousedown", function(an) {
                        an.preventDefault();
                        af();
                        ac = an.screenX;
                        aa = an.screenY;
                        ...
                        Z = am;
                        M = ae.cloneNode(true);
                        e.addClass(M, "mceClonedResizable");
                        e.setStyles(M, {
                            left: O,
                            top: N,
                            margin: 0
                        });
                        U.documentElement.appendChild(M);
                        e.bind(U, "mousemove", S);
                        e.bind(U, "mouseup", af);
                        if (Y != U) {
                            e.bind(Y, "mousemove", S);
                            e.bind(Y, "mouseup", af)
                        }
                    })
                } else {
                ...
                e.setStyles(al, {
                    left: (ai * am[0] + O) - (al.offsetWidth / 2),
                    top: (ag * am[1] + N) - (al.offsetHeight / 2)
                })
            });
            if (!tinymce.isOpera && ae.nodeName == "IMG") {
                ae.setAttribute("data-mce-selected", "1")
            }
        }
        function T() {
            if (ae) {
                ae.removeAttribute("data-mce-selected")
            }
            for (var ag in ab) {
                e.hide("mceResizeHandle" + ag)
            }
        }
        ...
        function V() {
            var ag = e.getParent(m.getNode(), "table,img");
            F(e.select("img[data-mce-selected]"), function(ah) {
                ah.removeAttribute("data-mce-selected")
            });
            if (ag) {
                R(ag)
            } else {
        ...
        a.onNodeChange.add(V);
        e.bind(U, "selectionchange", V);
        a.serializer.addAttributeFilter("data-mce-selected", function(ag, ah) {
            var ai = ag.length;
            while (ai--) {
                ag[ai].attr(ah, null)
            }
    ...
    function E() {
        if (o() < 9) {
            x.addNodeFilter("noscript", function(M) {
                var N = M.length, O, P;
                while (N--) {
                    O = M[N];
                    P = O.firstChild;
                    if (P) {
                        O.attr("data-mce-innertext", P.value)
                    }
                }
            });
            p.addNodeFilter("noscript", function(M) {
                var N = M.length, O, Q, P;
                while (N--) {
                    O = M[N];
                    Q = M[N].firstChild;
                    if (Q) {
                        Q.value = tinymce.html.Entities.decode(Q.value)
                    } else {
                        P = O.attributes.map["data-mce-innertext"];
                        if (P) {
                            O.attr("data-mce-innertext", null);
                            Q = new tinymce.html.Node("#text", 3);
                            Q.value = P;
                            Q.raw = true;
                            O.append(Q)
                        }
    ...
    function l() {
        a.contentStyles.push("body {min-height: 100px}");
        a.onClick.add(function(M, N) {
            if (N.target.nodeName == "HTML") {
                a.execCommand("SelectAll");
                a.selection.collapse(true);
                a.nodeChanged()
            }
        })
    }
...
tinymce.html.Styles = function(d, f) {
    ...
    return {
        ...
        parse: function(s) {
            ...
            function p(D, G) {
                var F, C, B, E;
                if (z["border-image"] === "none") {
                    delete z["border-image"]
                }
                F = z[D + "-top" + G];
                if (!F) {
                    return 
...
(function(f) {
    ...
    f.html.Schema = function(A) {
        ...
        n = m("non_empty_elements", "td th iframe video audio object script", z);
    ...
    e.create("tinymce.dom.DOMUtils", {
        ...
        setStyle: function(l, i, j) {
            ...
            return k.run(l, function(o) {
                ...
                case"opacity":
                    ...
                    break;
                case"float":
                    (b&&!e.isIE11) ? n.styleFloat = j : n.cssFloat = j;
                    break;
                default:
                    n[i] = j || ""
                }
        ...
        loadCSS: function(i) {
            ...
            g(i.split(","), function(m) {
                ...
                if (b&&!e.isIE11 && l.documentMode && l.recalc) {
                    n.onload = function() {
                        if (l.recalc) {
                            l.recalc()
                        }
        ...
        getClasses: function() {
            ...
            function q(i) {
                ...
                g(i.cssRules || i.rules, function(t) {
                    switch (t.type || 1) {
                    case 1:
                        if (t.selectorText) {
                            g(t.selectorText.split(","), function(r) {
                                r = r.replace(/^\s*|\s*$|^\s\./g, "");
...
(function(d) {
    ...
    d.create("tinymce.dom.Selection", {
        ...
        moveToBookmark: function(q) {
            var v = this, n = v.dom, l, j, g, i, u, k, x, r, s;
            function h(C) {
                var t = q[C ? "start": "end"], z, A, B, y;
                if (t) {
                    B = t[0];
                    for (A = u, z = t.length - 1; z >= 1; z--) {
                        y = A.childNodes;
                        if (t[z] > y.length - 1) {
                            return 
                        }
                    ...
                    if (A.nodeType === 3) {
                        B = Math.min(t[0], A.nodeValue.length)
                    }
                    if (A.nodeType === 1) {
                        B = Math.min(t[0], A.childNodes.length)
                    }
                    if (C) {
                        g.setStart(A, B)
                    } else {
            ...
            function m(D) {
                var y = n.get(q.id + "_" + D), C, t, A, B, z = q.keep;
                if (y) {
                    C = y.parentNode;
                    if (D == "start") {
                        if (!z) {
                    ...
                    if (!z) {
                        B = y.previousSibling;
                        A = y.nextSibling;
                        e(d.grep(y.childNodes), function(E) {
                            if (E.nodeType == 3) {
                                E.nodeValue = E.nodeValue.replace(/\uFEFF/g, "")
                            }
                        });
                        while (y = n.get(q.id + "_" + D)) {
                            n.remove(y, 1)
                        }
                        if (B && A && B.nodeType == A.nodeType && B.nodeType == 3&&!d.isOpera) {
                            t = B.nodeValue.length;
                            B.appendData(A.nodeValue);
                            n.remove(A);
                            if (D == "start") {
                                k = x = B;
                                r = s = t
            ...
            if (q) {
                if (q.start) {
                    ...
                    u = n.getRoot();
                    if (v.tridentSel) {
                        return v.tridentSel.moveToBookmark(q)
                    }
                    if (h(true) && h()) {
                        v.setRng(g)
                    }
                    ...
                    if (q.id) {
                        ...
                        if (q.name) {
                            v.select(n.select(q.name)[q.index])
                        } else {
                            if (q.rng) {
                                g = q.rng;
                                if (g.startContainer) {
        ...
        select: function(l, k) {
            ...
            if (d.isIE&&!d.isIE11 && g && g.setStart && k.selection.createRange().item) {
...
(function(a) {
    ...
    f) {
        ...
        i = i || a.DOM; f = f || new a.html.Schema(e);
...
(function(b) {
    ...
    b.create("tinymce.ui.Button:tinymce.ui.Control", {
        ...
        postRender: function() {
            ...
            b.dom.Event.add(d.id, "keydown", function(f) {
                if (!d.isDisabled() && f.keyCode == b.VK.SPACEBAR) {
                    b.dom.Event.cancel(f);
                    return e.onclick.call(e.scope, f)
                }
            })
        }
...
(function(e) {
    ...
    e.create("tinymce.ui.NativeListBox:tinymce.ui.ListBox", {
        ...
        postRender: function() {
            ...
            b.add(h.id, "change", g);
            b.add(h.id, "keydown", function(q) {
                var n, p = 37, m = 39, l = 38, r = 40, k = 13, o = 32;
                b.remove(h.id, "change", i);
                j = false;
                n = b.add(h.id, "blur", function() {
                    if (j) {
                        return 
                    }
                    j = true;
                    b.add(h.id, "change", g);
                    b.remove(h.id, "blur", n)
                });
                if (q.keyCode == k || q.keyCode == o) {
                    g(q);
                    return b.cancel(q)
                } else {
                    if (q.keyCode == r || q.keyCode == l) {
                ...
                if (typeof H.theme != "function") {
                    ...
                    if (b) {
                        G.onInit.add(function(n) {
                            n.dom.bind(n.getBody(), "beforedeactivate keydown keyup", function() {
                                n.bookmark = n.selection.getBookmark(1)
                            })
                        });
                        G.onNodeChange.add(function(n) {
                            if (document.activeElement.id == n.id + "_ifr") {
                                n.bookmark = n.selection.getBookmark(1)
                            }
                        })
                    }
...
(function(a) {
    a.Formatter = function(aa) {
            ...
            function an(aq, at, aw) {
                ...
                N.walk(aq, function(ax) {
                    ...
                    function az(aA) {
                        ...
                        if (au&&!aC && d(av, aF) && d(aD, av)&&!(!aw && aA.nodeType === 3 && aA.nodeValue.length === 1 && aA.nodeValue.charCodeAt(0) === 65279)&&!b(aA) && (!am.inline ||!H(aA))) {
                            if (!ay) {
                                ay = c.clone(ar, X);
        ...
        function U(ak, ab, ai) {
            ...
            function am() {
                var ao = r.getRng(true), ap, at, aw, av, aq, az, ay = [], au, ax;
                ap = ao.startContainer;
                at = ao.startOffset;
                aq = ap;
                if (ap.nodeType == 3) {
                    if (at != ap.nodeValue.length || ap.nodeValue === G) {
                        av = true
                    }
                    aq = aq.parentNode
                }
                ...
                if (av) {
                    ...
                    ax = ad();
                    aq = ax;
                    for (au = ay.length - 1; au >= 0; au--) {
                        aq.appendChild(c.clone(ay[au], false));
                        aq = aq.firstChild
                    }
                    aq.appendChild(c.doc.createTextNode(G));
                    aq = aq.firstChild;
                    var ar = c.getParent(az, I);
                    if (ar && c.isEmpty(ar)) {
                        az.parentNode.replaceChild(ax, az)
                    } else {
                        c.insertAfter(ax, az)
                    }
...
(function(b) {
    ...
    b.EnterKey = function(f) {
        ...
        function g(B) {
            var v = e.getRng(true), G, j, A, u, p, M, C, o, k, n, t, J, x, D;
            function E(N) {
            ...
            function F(O) {
                var N;
                if (b.isIE&&!b.isIE11 && i.isBlock(O)) {
                    N = e.getRng();
            ...
            function q(Q) {
                var P, O, N;
                if (A.nodeType == 3 && (Q ? u > 0 : u < A.nodeValue.length)) {
                    return false
                }
                if (A.parentNode == p && D&&!Q) {
                    return true
                }
                if (Q && A.nodeType == 1 && A == p.firstChild) {
                    return true
                }
            ...
            function L() {
                var P, O, N;
                if (A && A.nodeType == 3 && u >= A.nodeValue.length) {
                    if ((!b.isIE || b.isIE11)&&!y()) {
                        P = i.create("br");
                        v.insertNode(P);
                        v.setStartAfter(P);
                        v.setEndAfter(P);
                ...
                P = i.create("br");
                v.insertNode(P);
                if ((b.isIE&&!b.isIE11) && t == "PRE" && (!M || M < 8)) {
            ...
            if (A.nodeType == 1 && A.hasChildNodes()) {
                D = u > A.childNodes.length - 1;
                A = A.childNodes[Math.min(u, A.childNodes.length - 1)] || A;
                if (D && A.nodeType == 3) {
