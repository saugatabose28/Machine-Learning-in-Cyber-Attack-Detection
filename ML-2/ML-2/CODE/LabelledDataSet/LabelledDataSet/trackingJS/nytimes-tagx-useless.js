...
(function() {
    ...
    tagger.tag().condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["loaded:webtrends.js"], callback);
    }).run(function() {
        var
        imageViewerTrack;
    ...
    tagger.tag().repeat('many').condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["comscore-pageview-candidate"], callback);
    }).run(function() {
    ...
    tagger.tag().repeat('many').condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["module-impression"], callback);
    }).run(function() {
        var evtData = this.eventsData['module-impression'];
    ...
    tagger.tag().repeat('many').condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["module-interaction"], callback);
    }).run(function() {
        /* ET module interactions tag */
    ...
    tagger.tag().repeat('many').condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["track-page-view"], callback);
    }).run(function() {
        /* tracking page view via the proxy */
    ...
    tagger.tag().run(function() {
        /* if this page is not the top document it should not be counted as a site wide page */
...
;
    ...
    tagger.tag().condition(function (callback) {
        (TAGX.Ops.and.call(this, function (callback) {
            TAGX.Ops.on.call(this, "page.dom.custom", ["loaded:comscoreVendorCode.js"], callback);
        }, function (callback) {
            TAGX.Ops.on.call(this, "page.dom.custom", ["loaded:comscore.js"], callback);
        }))(callback);
    }).run(function() {
    ...
    tagger.tag().condition(function (callback) {
        ...
        TAGX.$(TAGX).on("masthead-search-click", function (evtData) {
    ...
    tagger.tag().condition(function (callback) {
        (TAGX.Ops.and.call(this, function (callback) {
            ...
            TAGX.Ops.on.call(this, "page.dom.custom", ["loaded:WTHelperFunctions.js"], callback);
        }))(callback);
    }).run(function() {
        var dcs = window.dcs || "";
        var source_app_map = {
    ...
    tagger.tag().condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["loaded:controller.js"], callback);
    }).run(function() {
        TAGX.$(TAGX).on("masthead-search-click", function (evtData) {
            var mydata = TAGX.Utils.jsonObjToDCSparams(evtData);
            dcsMultiTrack.apply(this, mydata.concat(["WT.z_dcsm", "1"]));
    ...
    tagger.tag().condition(function (callback) {
        ...
        var eventHandler = function (evtData) {
    ...
    tagger.tag().run(function() {
        ...
        (function() {
            ...
            DY.x = function(w) {
                ...
                s.async = true;
                s.src = ('https:' == d.location.protocol ? 'http://st.dynamicyield.com'.replace('http:', 'https:') : 'http://st.dynamicyield.com') + '/ast?sec=' + DY.scsec;
                d[g]('head')[0][a](s);
            };
    ...
    tagger.tag().repeat('many').condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["page-interaction"], callback);
    }).run(function() {
        ...
        if (eData) {
            ...
            if ((eData.depth && typeof eData.depth === 'number') || eData.priority === true) {
                // ideally we get priority flag in the event
    ...
    tagger.tag().run(function() {
        if (typeof NYTD === "undefined" || typeof NYTD.pageEventTracker == "undefined") {
    ...
    tagger.tag().run(function() {
        ...
        try {
            window._sf_async_config.authors = ("") + "".replace('By ', '').toLowerCase().replace(/\b[a-z]/g, function() {
    ...
    tagger.tag().run(function() {
        var ccLibScript = (document.location.protocol === "https:" ? "https://sb" : "http://b") + ".scorecardresearch.com/c2/3005403/cs.js";
    ...
    tagger.tag().condition(function (callback) {
        TAGX.Ops.on.call(this, "page.dom.custom", ["loaded:ga.js"], callback);
    }).run(function() {
    ...
    tagger.tag().repeat('many').condition(function (callback) {
        (TAGX.Ops.or.call(this, function (callback) {
            TAGX.Ops.on.call(this, "page.dom.custom", ["gateway-load"], callback);
        }, function (callback) {
            TAGX.Ops.on.call(this, "page.dom.custom", ["gateway-login-click"], callback);
        }))(callback);
    }).run(function() {
        var mapping = {
            "common": [
            ...
            "impression" : {
                dcsuri: '/mem/purchase/gateway',
                ti: 'Gateway',
                dcsid: 'dcsv96qcv000008alp4trgo0q_7h8h' 
            },
            "login-click" : {
                dcsuri: '/mem/purchase/gateway/login',
                ti: 'Gateway - Login',
                z_dcsm: '1',
                dcsid: 'dcsv96qcv000008alp4trgo0q_7h8h' 
            }
    ...
    tagger.tag().repeat('many').condition(function (callback) {
        (TAGX.Ops.or.call(this, function (callback) {
            TAGX.Ops.on.call(this, "page.dom.custom", ["growl-load"], callback);
        }, function (callback) {
            TAGX.Ops.on.call(this, "page.dom.custom", ["growl-login-click"], callback);
        }))(callback);
    }).run(function() {
        var mapping = {
            "common": [
            ...
            "login-click": {
                dcsuri: '/mem/purchase/growl/login',
                ti: 'Growl - Login',
                dcsid: 'dcsv96qcv000008alp4trgo0q_7h8h'
            }
        };
