...
var swf = "http://s1.2mdn.net/4447375/AD021AU_MicroCFDsAUS200_160x600.swf";
var gif = "http://s1.2mdn.net/4447375/AD021AU_MicroCFDsAUS200_160x600.jpg";
var minV = 9;
var FWH = ' width="160" height="600" ';
var url = escape("http://adclick.g.doubleclick.net/pcs/click?xai=AKAOjstbPTaq_Ljp64qs5Gm-h_hBCIH4wmG5zwh4fHJjWHuNJ-fMKR7nd5paqEC1HHygCce3TbPmA7314GVHZEEFeysUwN_n9Hj01rWgKfBHpPw6vfw1XSHOpDJyqLue2b_ECrmvEB4&sig=Cg0ArKJSzHKjFzMvkifrEAE&adurl=http://www.forextrading.com.au/%3FCMP%3DSFS-70160000000DSBiAAO%26display%3DforexAU");
var fscUrl = url;
...
var defaultCtVal = escape("http://adclick.g.doubleclick.net/pcs/click?xai=AKAOjstbPTaq_Ljp64qs5Gm-h_hBCIH4wmG5zwh4fHJjWHuNJ-fMKR7nd5paqEC1HHygCce3TbPmA7314GVHZEEFeysUwN_n9Hj01rWgKfBHpPw6vfw1XSHOpDJyqLue2b_ECrmvEB4&sig=Cg0ArKJSzHKjFzMvkifrEAE&adurl=http://www.forextrading.com.au/%3FCMP%3DSFS-70160000000DSBiAAO%26display%3DforexAU");
var ctp=new Array();
var ctv=new Array();
ctp[0] = "clickTAG";
ctv[0] = "";
...
for(var ctIndex = 0; ctIndex < ctp.length; ctIndex++) {
  ...
  if(ctVal != null && typeof(ctVal) == 'string') {
    if(ctVal == "") {
      ...
      ctVal = escape("http://adclick.g.doubleclick.net/pcs/click?xai=AKAOjstbPTaq_Ljp64qs5Gm-h_hBCIH4wmG5zwh4fHJjWHuNJ-fMKR7nd5paqEC1HHygCce3TbPmA7314GVHZEEFeysUwN_n9Hj01rWgKfBHpPw6vfw1XSHOpDJyqLue2b_ECrmvEB4&sig=Cg0ArKJSzHKjFzMvkifrEAE&adurl=" + ctVal);
    }
...
var DCid=(isNaN("283393327"))?"DCF2":"DCF283393327";
