/* ---------------------------------------------------------------------------------
   file-start: js/ads/xtcore.js 
*/

//-- Copyright 2013 AT Internet, All Rights Reserved.
//-- AT Internet Tag 4.3.006
var xt1 = '.livejournal.com', xtLogDom = '.xiti.com/hit.xiti', xtpreview = false, xtfirst = false, xtcode = '', xt46 = '1', xt50 = '1', xt48 = '', xt54 = false, xt58 = false, xtdocl = false, xtud = 'undefined', xt2 = '1', xt3 = 365, xttredir = 500, xtkwv = 'xtmc', xtkwp = 'xtnp', xtadch = new Array, xt4 = new Array;
xt4['sec'] = '20';
xt4['rss'] = '20';
xt4['epr'] = '20';
xt4['erec'] = '20';
...
var xt38 = (xw.xtcustom != null) ? xtserial(xw.xtcustom): '', xt8 = (xw.xtsite != null) ? xw.xtsite: 0, xt9 = (xw.xtn2 != null) ? '&s2=' + xw.xtn2: '', xt8b = ((xt8 == 0) ? '' : 's=' + xt8) + ((xt36 == 0) ? '' : ((xt8 == 0) ? 'sts=' + xt36 : '&sts=' + xt36)), xtp = (xw.xtpage != null) ? xw.xtpage: '', xt10 = xw.xto_force ? xw.xto_force.toLowerCase(): null, xt11 = (xt8 == 'redirect') ? true: false, xtdi = xw.xtdi ? '&di=' + xw.xtdi: '', xt12 = xw.xtidp ? '&idpays=' + xw.xtidp: '', xt13 = xw.xtidprov ? '&idprov=' + xw.xtidprov: '', xtm = (xw.xtparam != null) ? xw.xtparam: '';
xt46 = ((typeof(xw.xtnopage) != 'undefined') && (xw.xtnopage == '1')) ? '0' : xt46;
xt50 = ((typeof(xw.xtergo) != 'undefined') && (xw.xtergo == '0')) ? '0' : xt50;
var xtclzone = ((typeof(xw.scriptOnClickZone) != 'undefined') && (xt50 == '1')) ? xw.scriptOnClickZone: 0, xt15 = (xw.xt_orderid != null) ? xw.xt_orderid: '', xt17 = (xw.xtidcart != null) ? xw.xtidcart: '', xt44 = (xw.xtprod_load != null) ? '&pdtl=' + xw.xtprod_load: '', xt47 = (xw.xtcode != '') ? '&code=' + xw.xtcode: '', xt60 = {
    i: [],
    u: [],
    d: [],
    l: [],
...
function xtserial(obj) {
    ...
    if (t != "object" || obj === null) {
        ...
        for (n in obj) {
            ...
            t = typeof(v);
            if (t == "string")
                v = encodeURIComponent('"' + v.replace(/[^\\]"/g, '\\"') + '"');
...
function xtf3(param, chba, a) {
    ...
    var xturl = (chba == null || chba == xtud) ? xtclURL(xtdeb.toLowerCase().replace(/%3d/g, '=')): chba, xtpos = xturl.indexOf(param + '=');
    if (xtpos > 0) {
...
var AT_click = {
    ...
    tag: function(a, d, e, b, c, g, h, f) {
        if (a.setAttribute)
            this.addElem(a, d, e, b, c, g, h, f);
        else 
            for (var j in a)
                a[j].setAttribute && this.addElem(a[j], d, e, b, c, g, h, f)
    },
    addElem: function(a, d, e, b, c, g, h, f) {
        this.id++;
        a.setAttribute("data-xtclickid",
        this.id);
    ...
    on_click_submit: function(a) {
        try {
            for (var d = a.target || a.srcElement, e, b = {}, c = "", g = a.defaultPrevented, h = AT_click; !d.getAttribute("data-xtclickid") && "BODY" != d.nodeName;)
                d = d.parentNode;
            (e = d.getAttribute("data-xtclickid")) && (b = h.objs[e], "AT" != b.type ? c += "&p=" + b.label + ("C" == b.type ? "&clic=" + b.typeClick : "") : "AT" == b.type && (c += "&type=AT&atc=" +
            b.label), xtf4(b.type, "&s2=" + b.n2 + c), !g && d.redir && (a.preventDefault(), "FORM" != d.nodeName ? h.do_navig(d, b.urlDest, b.target) : h.do_submit(d, null, b.submit)))
        } catch (f) {}
    },
    do_navig: function(a, d, e, b) {
        ...
        if ("A" != a.nodeName)
            for (var g = a.parentNode; g;) {
                ...
                c = a;
        if (c) {
            if (c.target = e || a.target || "_self", c.href = d || a.href, !b || b&&!xtkey)
                if ("_self" == c.target.toLowerCase()) {
                    if (setTimeout('self.location.href="' + c.href + '"', xw.xttredir), b)
                        return !1
                } else if ("_top" == c.target.toLowerCase()) {
                    if (setTimeout('top.location.href="' +
                    c.href + '"', xw.xttredir), b)
                        return !1
                } else if ("_parent" == c.target.toLowerCase()) {
                    if (setTimeout('parent.location.href="' + c.href + '"', xw.xttredir), b)
                        return !1
                } else if ("_blank" == c.target.toLowerCase() && (setTimeout('(xw.open("' + c.href + '","_blank")).focus();', 1), b))
                    return !1
        } else 
            d && ("_blank" == e ? setTimeout('(xw.open("' + d + '","_blank")).focus();', xw.xttredir) : setTimeout('self.location.href="' + d + '"', xw.xttredir));
        if (b)
            return xtkey=!1, !0
    },
...
function xtf4(x1, x2, x3, x4) {
    if (((xtclzone == 0) || (xtclzone == 3) || (x1 != 'C')) && (x1 != 'P')) {
        ...
        if (xtnop && xt46 == '0' && x1 == 'F') {
            ...
            if (window.navigator && window.navigator.loadPurpose === "preview" && xtg.userAgent.indexOf('Safari')!=-1 && xtg.userAgent.indexOf('Chrome') < 0) {
                if (xtpreview)
                    xtLhit(Xt_param + x2 + "&pvw=1")
                } else if (xd.webkitVisibilityState == "prerender") {
                xtpre = true;
                Xt_param = Xt_param + x2;
...
function xt_ParseUrl(hit, xtch, xtrefP, thit) {
    ...
    if (xtch.length > 0) {
        var xtlg = 1600 - xtrefP.length, i = 0, j = 0, xtch_prec = '', xterr = 0;
...
function xt_ParseUrl3(str1, str2, nt, ntg, name, sep, idp) {
    ...
    var xt_imgc = new Image(), lim = 1500, mh = '&mh=' + nt + '-' + ntg + '-' + idp;
    if (str2.length > lim) {
        var reg = new RegExp('[' + sep + ']', 'gi'), tab = str2.split(reg), hit = '', l = tab[0].length, i = 0;
...
function xtLhit(hitclick) {
    if ((!xtpre && xtone) || (!xd.webkitHidden && xtone)) {
        if (hitclick) {
            xt_ParseUrl(Xt_id, (typeof hitclick == "string" ? hitclick : Xt_param) + (xtfirst ? '&idclient=' + xt40 : ''), '&ref=' + Xt_r.replace(/&/g, '$'), '1');
            xtone = false
        } else if (xt46 == '1') {
...
if ((xt8 != 0) || (xt36 != 0) || (xt11)) {
    ...
    var xtanc = xtf1(xtpan), xtattc = xtf1(xtpat), xtanct = xtf1(xtpant), xtxp = new Date(), xt29 = new Date(), xt30 = new Date();
    if (!xt11) {
    ...
    var xt31 = (xt26 != null) ? xt26.indexOf('-'): 0, xt57 = (xt55 != null) ? xt55.indexOf('-'): 0, xtan2 = (xt27 != null) ? '': ((xt26 != null) && (xt31 > 0)) ? '&ac=' + xt26.substring(0, xt31) + '&ant=0&an=' + xt26.substring(xt31 + 1, xt26.length): (xtanc != null) ? '&anc=' + xtanc + '&anct=' + xtanct: '', xtat2 = (xt56 != null) ? '': ((xt55 != null) && (xt57 > 0)) ? '&ac=' + xt55.substring(0, xt57) + '&ant=0&at=' + xt55.substring(xt57 + 1, xt55.length): (xtattc != null) ? '&attc=' + xtattc + '&anct=' + xtanct: '', xt32 = (xtvrn.indexOf('$' + xt8 + '$') < 0) ? '&vrn=1': '', xt35 = ((xtf3('xtatc') != null) && (xtf3('atc', xtm) == null)) ? '&atc=' + xtf3('xtatc'): '';
    if (xt32 != '') {
    ...
    var xt33 = '', Xt_r = (xt25 != null) ? xt25.replace(/[<>]/g, ''): xtf1('xtref');
    if (Xt_r == null) {
        Xt_r = xt20.replace(/[<>]/g, '');
    }
    if (Xt_r != null)
        Xt_r = Xt_r.substring(0, 1000);
    if (!xt11) {
        ...
        var xtnet = (xtnav.indexOf('Netscape') >= 0), xtmac = (xtnav.indexOf('Mac') >= 0), xtOP = (xtg.userAgent.indexOf('Opera') >= 0);
        ...
        var xthl = '&hl=' + xt21.getHours() + 'x' + xt21.getMinutes() + 'x' + xt21.getSeconds(), xt45 = (xtdocl) ? '&docl=' + encodeURIComponent(xt6.location.href.replace(/&/g, '#ec#')): '', Xt_param = xt8b + xt9 + '&p=' + xtp + xthl + xtdi + xt12 + xt13 + xt32 + xt45 + xt47 + xtm + xtconn + xthome + xtlang + '&vtag=' + xtv + '&idp=' + xtidpg;
