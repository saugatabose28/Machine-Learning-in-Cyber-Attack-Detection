...
window.Typekit.config = {
    "c": [".tk-museo-sans", "\"museo-sans\",sans-serif"],
    "f": "//use.typekit.net/c/c9e2ed/1w;museo-sans,2,Py9:P:i1,PyB:P:i3,PyD:P:i5,PyG:P:i7,Py8:P:n1,Py6:P:n3,PyC:P:n5,PyF:P:n7/{format}{/extras*}?3bb2a6e53c9684ffdc9a9bf4195b2a62ac2abccc2253da0ff4783ed54ea65564037a33124192d45cdf35572a54df43ee4fb028798792c83de6451a687777b127e2b86ba3d8111d6376ba78748d63b25d200f053aa94c9a73e62e588e2ace7fa09376be55016e30c55fb29aea900270de355a19b2da004d59172815",
    "fn": ["museo-sans", ["i1", "i3", "i5", "i7", "n1", "n3", "n5", "n7"]],
    "k": "//use.typekit.net/{id}.js",
    "p": "//p.typekit.net/p.gif?s=1&k=ozk3ufk&ht=tk&h={host}&f=2003.2004.2005.2006.2007.2008.2009.2010&a=173933&_={_}",
    "w": "ozk3ufk"
};
/*{"k":"1.8.1","created":"2014-05-02 10:17:03 UTC"}*/
;
(function(window, document, undefined) {
    ...
    function z(a) {
        ...
        a = B(a.e, /(Linux|Mac_PowerPC|Macintosh|Windows|CrOS|PlayStation)/, 1);
    ...
    function oa(a) {
        ...
        "BuiltinBrowser" == g ? p = "Unknown" : "Silk" == g ? p = B(a.e, /Silk\/([\d\._]+)/, 1) : "Chrome" == g ? p = B(a.e, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2) : - 1 != a.e.indexOf("Version/") ? p = B(a.e, /Version\/([\d\.\w]+)/, 1) : "AdobeAIR" == g ? p = B(a.e, /AdobeAIR\/([\d\.]+)/, 1) : "Opera" == g ? p = B(a.e, /OPR\/([\d.]+)/, 1) : "PhantomJS" == g && (p = B(a.e, /PhantomJS\/([\d.]+)/, 1));
        h = x(p);
        L = "AdobeAIR" == g ? 2 < h.g || 2 == h.g && 5 <= h.n : "BlackBerry" == b ? 10 <= d.g : "Android" == b ? 2 < d.g || 2 == d.g && 1 < d.n : 526 <= f.g || 525 <= f.g && 13 <= f.n;
        return new y(g, h, p, "AppleWebKit", f, e, b, d, c, C(a.R),
        new t(L, 536 > f.g || 536 == f.g && 11 > f.n, "iPhone" == b || "iPad" == b || "iPod" == b || "Macintosh" == b))
    }
    function B(a, b, c) {
    ...
    var Ua = {
        ...
        d: function(a, b) {
            ...
            new u(534, 50))) && (R(a) || S(a)) || Na(a) && (b.U && "iPad" === a.m && w(a.l, new u(5)) || Ha(a, b) && w(a.l, new u(5))) || "Opera" === a.getName() && w(a.o, new u(11, 10)) && (R(a) || U(a) || S(a) || T(a, b)) || "MSIE" === a.getName() && 9 <= a.S && (P(a) && w(a.l, new u(6, 1)) || P(a) && 0 === v(a.l, new u(6, 0))) || "MSIE" === a.getName() && b.ya && "Windows Phone" === a.m && w(a.l, new u(8)) || Qa(a) && (b.ka && "BlackBerry" === a.m && w(a.l, new u(10)) || U(a))
        },
        f: function(a, b) {
