...
* http://parse.ly
2014 Parsely, Inc.*/
window.PARSELY = window.PARSELY || {}, function(e) {
    function t(e) {
    ...
    function o(e) {
        for (var t=!1, n = 0; e.scripts.length > n; n++)
            e.scripts[n].ready && e.scripts[n].exec_trigger && (t=!0, e.scripts[n].exec_trigger(), e.scripts[n].exec_trigger = null);
        return t
    }
    function s(e, t, n, r) {
    ...
    function a(e) {
        ...
        for (var t = 0; e.finished_listeners.length > t; t++)
    ...
    function c(e, t, n, r, i) {
        setTimeout(function() {
            ...
            if ("item"in v) {
                if (!v[0])
                    return setTimeout(arguments.callee, 25), void 0;
                v = v[0]
            }
    ...
    function l() {
        ...
        function m(e, t, n, i) {
            ...
            t.src = r(t.src, e[h]), t.real_src = t.src + (e[g] ? (/\?.*$/.test(t.src) ? "&_" : "?_")+~~(1e9 * Math.random()) + "=" : ""), x[t.src] || (x[t.src] = {
                ...
                o.ready=!0;
                for (var e = 0; o.ready_listeners.length > e; e++)
                    o.ready_listeners[e]();
                o.ready_listeners = []
            } : function() {
                a(o)
                ...
                script: function() {
                    for (var o = 0; arguments.length > o; o++)(function(o, s) {
                        ...
                        for (var p = 0; s.length > p; p++)
                            a(), o = s[p], t(o) && (o = o()), o && (n(o) ? (d = [].slice.call(o), d.unshift(p, 1), [].splice.apply(s, d), p--) : ("string" == typeof o && (o = {
                                src: o
                            }), o = i(o, {
                                ready: !1,
                                ready_cb: e,
        ...
        return L[d]=!0, L[f]=!1, L[p]=!1, L[g]=!1, L[h] = "", A = {
            ...
            runQueue: function() {
                for (var e, t = A, n = w.length, r = n; --r >= 0;)
                    e = w.shift(), t = t[e.type].apply(null, e.args);
                return t
            },
            noConflict: function() {
                return e.$LAB = u, A
    ...
    var e = PARSELY.console, t = PARSELY.$LAB, n = "parsely-cfg", r = document.getElementById(n);
    if (!r)
        return e.log("Parse.ly disabled because configuration root element missing: #" + n), void 0;
    var i = function(e) {
        return 10 > e ? "0" + e : e
    ...
    PARSELY.pInit = function(n) {
        if (void 0 != n.error)
            return e.log("Unable to load configuration"), void 0;
