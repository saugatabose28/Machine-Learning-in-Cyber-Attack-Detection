...
var Index = {
  ...
  fbJoin: function(context) {
    ...
    var oauthUrl = 'https://graph.facebook.com/oauth/authorize?client_id='+cur.fbApp+'&redirect_uri='+encodeURIComponent(redirectUri)+'&scope=offline_access,email,user_birthday,publish_stream&display=popup&state='+cur.fbState;
