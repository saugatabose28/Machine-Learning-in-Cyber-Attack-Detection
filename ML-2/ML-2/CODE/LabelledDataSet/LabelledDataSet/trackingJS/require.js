...
(function(global) {
    ...
    function newContext(contextName) {
        ...
        function checkLoaded() {
            var map, modId, err, usingPathFallback, waitInterval = config.waitSeconds * 1000, expired = waitInterval && (context.startTime + waitInterval) < new Date().getTime(), noLoads = [], reqCalls = [], stillLoading = false, needCycleCheck = true;
            if (inCheckLoaded) {
                return 
            }
            inCheckLoaded = true;
...
(function() {
    ...
    function f(n) {
        ...
        if (l) {
            if (l.attributes.id.value === n) {
                return l
            } else {
                var m = document.all[n];
                for (var k = 1, j = m.length; k < j; k++) {
                    if (m[k].attributes.id.value === n) {
                        return m[k]
                    }
                }
            }
    ...
    function c(i) {
        ...
        if (i) {
            if (window.getComputedStyle) {
                j = document.defaultView.getComputedStyle(i, null).getPropertyValue("z-index")
            } else {
                if (i.currentStyle) {
                    j = i.currentStyle.zIndex
                }
            }
            j =+ j;
            return j
    ...
    function d(j) {
        ...
        i.id = j;
        i.className = "addedByCssp";
        i.setAttribute("style", "position: absolute; width: 1px; height: 1px; top: -1px; left: -1px;");
        document.body.insertBefore(i, document.body.firstChild);
        return i
    }
    define("cssp", {
        load: function(i, p, r, k) {
            var o = i.lastIndexOf("?"), l = (o > 0 ? i.substring(0, o) : i), n = (o > 0 ? i.substring(o + 1, i.length) : "cssp-" + i.replace(/[^a-z0-9_]/gi, "-")), j = "cssp!" + l, q = document.getElementsByTagName("head")[0], m = document.createElement("link");
            l = k.paths["cssp!" + l] ? k.paths["cssp!" + l] : l;
            if (!l) {
...
define("domReady", function() {
    var h, l, g, j = typeof window !== "undefined" && window.document, d=!j, k = j ? document : null, c = [];
    function b(n) {
        var e;
    ...
    if (j) {
        if (document.addEventListener) {
            ...
            if (window.attachEvent) {
                ...
                if (l.doScroll && h && window.external) {
...
require.addPaths = function() {
    var g = {}, f, c;
    for (var e = 0, b = arguments.length; e < b; e += 2) {
        f = arguments[e];
        c = arguments[e + 1];
