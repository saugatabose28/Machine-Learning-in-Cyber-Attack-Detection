//tealium universal tag - utag.428 ut4.0.201411261511, Copyright 2014 Tealium.com Inc. All Rights Reserved.
...
try {
    (function(id, loader, u) {
        ...
        u.initialized = false;
        u.data = {};
        u.data.google_conversion_id = 1051291126;
        ...
        u.map = {
            "cp.countrysite1": "custom.dynx_itemid2",
            "gsp_product": "custom.dynx_itemid,custom.dynx_pagetype"
        };
        u.extend = [];
        u.send = function(a, b) {
