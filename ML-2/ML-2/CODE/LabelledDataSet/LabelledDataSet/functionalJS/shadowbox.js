...
(function(window, undefined) {
    ...
    /* FQ  var ua=navigator.userAgent.toLowerCase();  */
    var ua = navigator.userAgent.toLowerCase();
    if (ua.indexOf("ipad")>-1 || ua.indexOf("ipod")>-1 || ua.indexOf("android")>-1) {
        S.isMobile = true
    };
    /*end of alteration*/
    ...
    /* FQ function setSize(){container.style.height=S.getWindowSize("Height")+"px";container.style.width=S.getWindowSize("Width")+"px"}
    ...
    function setPosition() {
        if (S.isMobile) {
            container.style.top = window.pageYOffset - 30 + "px";
