    ...
    e.widget("ui.autocomplete", {
        ...
        _create: function() {
            ...
            "body", b)[0]).mousedown(function(c) {
                ...
                e(c.target).closest(".ui-menu-item").length || setTimeout(function() {
                    e(document).one("mousedown", function(g) {
                        g.target !== a.element[0] && g.target !== d&&!e.ui.contains(d, g.target) && a.close()
                    })
                }, 1);
                setTimeout(function() {
...
(function(e) {
    e.widget("ui.menu", {
        ...
        activate: function(a, b) {
            this.deactivate();
            if (this.hasScroll()) {
                var f = b.offset().top - this.element.offset().top, c = this.element.attr("scrollTop"), d = this.element.height();
                if (f < 0)
                    this.element.attr("scrollTop", c + f);
                else 
                    f >= d && this.element.attr("scrollTop", c + f - d + b.height())
            }
            ...
            if (this.hasScroll())
                if (!this.active || this.last())
                    ...
                    var b = this.active.offset().top, f = this.element.height(), c = this.element.children(".ui-menu-item").filter(function() {
                        var d = e(this).offset().top - b - f + e(this).height();
                        return d < 10 && d>-10
                    });
            ...
            if (this.hasScroll())
                if (!this.active || this.first())
                    ...
                    result = this.element.children(".ui-menu-item").filter(function() {
                        var c = e(this).offset().top - b + f - e(this).height();
                        return c < 10 && c>-10
                    });
    ...
    d.widget("ui.tabs", {
        ...
        _tabify: function(b) {
            ...
            this.anchors.each(function(g, f) {
                ...
                if (h.test(i))
                    a.panels = a.panels.add(a._sanitizeSelector(i));
                else if (i && i !== "#") {
            ...
            this.anchors.bind(c.event + ".tabs", function() {
                var g = this, f = d(g).closest("li"), i = a.panels.filter(":not(.ui-tabs-hide)"), l = d(a._sanitizeSelector(g.hash));
