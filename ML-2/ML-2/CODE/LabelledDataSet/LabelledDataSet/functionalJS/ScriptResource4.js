...
Type.prototype.registerEnum = function Type$registerEnum(name, flags) {
    ...
    for (var j in this.prototype) {
        ...
        if (!Type.__identifierRegExp.test(j)) 
            throw Error.invalidOperation(String.format(Sys.Res.enumInvalidValueName, j));
...
Sys.UI.Control = function Sys$UI$Control(element) {
    ...
    if (e) 
        throw e;
    if (element.control !== null && typeof(element.control) !== 'undefined') 
