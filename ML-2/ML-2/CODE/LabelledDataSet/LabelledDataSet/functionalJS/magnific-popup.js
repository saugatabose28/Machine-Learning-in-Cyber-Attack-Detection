!function(a) {
    var b, c, d, e, f, g, h, i = "Close", j = "BeforeClose", k = "AfterClose", l = "BeforeAppend", m = "MarkupParse", n = "Open", o = "Change", p = "mfp", q = "." + p, r = "mfp-ready", s = "mfp-removing", t = "mfp-prevent-close", u = function() {}, v=!!window[jimdoData.jQuery], w = a(window), x = function(a, c) {
        b.ev.on(p + a + q, c)
    }, y = function(b, c, d, e) {
...
}(window[jimdoData.jQuery] || window.Zepto);
