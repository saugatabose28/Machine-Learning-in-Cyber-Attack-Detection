(function() {
    ...
    window.NATIVEADS.onReady = function(ads) {
        ...
        ads.insertPreview({
            ...
            unit: {
                "server": "ibw",
                "id": get_polar_mn("desktop", label0),
                "mobile": false
            },
        ...
        ads.insertPreview({
            ...
            unit: {
                "server": "ibw",
                "id": get_polar_mn("desktop", label1),
                "mobile": false
            },
            location: "#the_blogs",
        ...
        ads.insertPreview({
            ...
            unit: {
                "server": "ibw",
                "id": get_polar_mn("desktop", label2),
                "mobile": false
            },
        ...
        ads.insertPreview({
            ...
            unit: {
                "server": "ibw",
                "id": get_polar_mn("desktop", label3),
                "mobile": false
            },
    ...
    compiledTemplate0 = function (Handlebars, depth0, helpers, partials, data) {
        ...
        if (stack2 = helpers.pubDate) {
            stack2 = stack2.call(depth0, {
                hash: {},
                data: data
            });
        } else {
            stack2 = depth0.pubDate;
            stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2;
        }
        buffer += escapeExpression(stack2)
    ...
    compiledTemplate2 = function (Handlebars, depth0, helpers, partials, data) {
        ...
        stack2 = helpers['if'].call(depth0, ((stack1 = ((stack1 = depth0.author), stack1 == null || stack1 === false ? stack1 : stack1.image)), stack1 == null || stack1 === false ? stack1 : stack1.href), {
            hash: {},
            inverse: self.noop,
