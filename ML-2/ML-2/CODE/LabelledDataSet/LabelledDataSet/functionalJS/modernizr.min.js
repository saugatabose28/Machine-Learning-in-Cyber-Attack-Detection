...
/*
 * 
 * Forked and minified for use in trackHTMLinGA
 * 2010 Seth Meranda - http://seth.meranda.org/
 * http://go.unl.edu/trackHTML5inGA
 * 
 */
window.Modernizr = function(i, e, y) {
    function v(a, b) {
        return ("" + a).indexOf(b)!==-1
    }
    function C(a, b) {
        for (var c in a)
            if (k[a[c]] !== y && (!b || b(a[c], D)))
                return true
    }
    function r(a, b) {
        var c = a.charAt(0).toUpperCase() + a.substr(1);
        c = (a + " " + E.join(c + " ") + c).split(" ");
        return !!C(c, b)
    }
    function Q() {
        j.input = function(a) {
        ...
        j.inputtypes = function(a) {
            for (var b = 0, c, n = a.length; b <
            n; b++) {
                g.setAttribute("type", a[b]);
                if (c = g.type !== "text") {
                    g.value = L;
                    if (/^range$/.test(g.type) && g.style.WebkitAppearance !== y) {
                        t.appendChild(g);
                        c = e.defaultView.getComputedStyle && e.defaultView.getComputedStyle(g, null).WebkitAppearance !== "textfield" && g.offsetHeight !== 0;
                        t.removeChild(g)
                    } else 
                        /^(search | tel)$ / .test(g.type) || (c = /^(url|email)$/.test(g.type) ? g.checkValidity && g.checkValidity() === false : g.value != L)
                }
                M[a[b]]=!!c
            }
            return M
    ...
    var j = {}, t = e.documentElement, D = e.createElement("modernizr"), k = D.style, g = e.createElement("input"), L = ":)", N = Object.prototype.toString, w = " -webkit- -moz- -o- -ms- -khtml- ".split(" "), E = "Webkit Moz O ms Khtml".split(" "), O = {
    ...
    P = typeof F !== "undefined" && typeof F.call !== "undefined" ? function(a, b) {
        return F.call(a, b)
    } : function(a, b) {
    ...
    d.flexbox = function() {
        ...
        (function(n, h, o, q) {
            h += ":";
            n.style.cssText = (h + w.join(o + ";" + h)).slice(0, - h.length) + (q ||
            "")
    ...
    d.canvastext = function() {
        return !!(j.canvas && typeof e.createElement("canvas").getContext("2d").fillText == "function")
    };
    d.webgl = function() {
        var a = e.createElement("canvas");
        try {
    ...
    d.websqldatabase = function() {
        ...
        if (a)
            try {
                a=!!openDatabase("modernizrtestdb", "1.0", "modernizrtestdb", 2E4)
        } catch (b) {
            a = false
        }
        return a
    ...
    d.hashchange = function() {
        return s("hashchange", i) &&
        (document.documentMode === y || document.documentMode > 7)
    };
    d.historymanagement = function() {
        return !!(i.history && history.pushState)
    };
    d.draganddrop = function() {
        return s("drag") && s("dragstart") && s("dragenter") && s("dragover") && s("dragleave") && s("dragend") && s("drop")
    };
    ...
    d.rgba = function() {
        ...
        return v(k.backgroundColor, "rgba")
    };
    d.hsla = function() {
        k.cssText = "background-color:hsla(120,40%,100%,.5)";
        return v(k.backgroundColor,
        "rgba") || v(k.backgroundColor, "hsla")
    };
    ...
    d.cssgradients = function() {
        ...
        k.cssText = a;
        return v(k.backgroundImage, "gradient")
    };
    d.cssreflections = function() {
        return r("boxReflect")
    };
    d.csstransforms = function() {
        return !!C(["transformProperty", "WebkitTransform", "MozTransform",
    ...
    d.csstransforms3d = function() {
        ...
        if (a) {
            ...
            b.textContent = "@media (" + w.join("transform-3d),(") + "modernizr){#modernizr{height:3px}}";
    ...
    d.fontface = function() {
        var a, b = e.head || e.getElementsByTagName("head")[0] || t, c = e.createElement("style"), n = e.implementation || {
            hasFeature: function() {
                return false
            }
        };
        ...
        b = n.hasFeature("CSS2", "") ? function(h) {
            if (!(a && h))
                return false;
            var o = false;
            try {
                a.insertRule(h, 0);
                o=!/unknown/i.test(a.cssRules[0].cssText);
    ...
    d.svg = function() {
        return !!e.createElementNS&&!!e.createElementNS(O.svg, "svg").createSVGRect
    };
    d.inlinesvg = function() {
        var a = document.createElement("div");
        a.innerHTML = "<svg/>";
        return (a.firstChild && a.firstChild.namespaceURI) == O.svg
    };
    d.smil = function() {
        return !!e.createElementNS &&
        /SVG/.test(N.call(e.createElementNS("http://www.w3.org/2000/svg", "animate")))
    };
    d.svgclippaths = function() {
        return !!e.createElementNS && /SVG/.test(N.call(e.createElementNS("http://www.w3.org/2000/svg", "clipPath")))
    };
    for (var z in d)
        if (P(d, z))
            R.push(((j[z.toLowerCase()] = d[z]()) ? "" : "no-") + z.toLowerCase());
    j.input || Q();
    ...
    (function() {
        ...
        function c(f, l) {
            if (q[f])
                q[f].styleSheet.cssText += l;
            else {
                var m = h[G], p = b[A]("style");
                p.media = f;
                m.insertBefore(p, m[G]);
                q[f] = p;
                c(f, l)
            }
        }
        function n(f, l) {
            for (var m = RegExp("\\b(" + H + ")\\b(?!.*[;}])", "gi"), p = function(B) {
                return ".iepp_" + B
            }, x =- 1; ++x < f.length;) {
                l = f[x].media || l;
                n(f[x].imports, l);
                c(l, f[x].cssText.replace(m, p))
            }
        }
        for (var h = b.documentElement, o = b.createDocumentFragment(), q = {}, H = "abbr|article|aside|audio|canvas|command|datalist|details|figure|figcaption|footer|header|hgroup|keygen|mark|meter|nav|output|progress|section|source|summary|time|video",
        I = H.split("|"), u = [], J =- 1, G = "firstChild", A = "createElement"; ++J < I.length;) {
            b[A](I[J]);
            o[A](I[J])
        }
        o = o.appendChild(b[A]("div"));
        a.attachEvent("onbeforeprint", function() {
            for (var f, l = b.getElementsByTagName("*"), m, p, x = RegExp("^" + H + "$", "i"), B =- 1; ++B < l.length;)
                if ((f = l[B]) && (p = f.nodeName.match(x))) {
                    m = RegExp("^\\s*<" + p + "(.*)\\/" + p + ">\\s*$", "i");
                    o.innerHTML = f.outerHTML.replace(/\r|\n/g, " ").replace(m, f.currentStyle.display == "block" ? "<div$1/div>" : "<span$1/span>");
                    m = o.childNodes[0];
                    m.className += " iepp_" + p;
                    m = u[u.length] =
                    [f, m];
                    f.parentNode.replaceChild(m[1], m[0])
                }
            n(b.styleSheets, "all")
        });
        a.attachEvent("onafterprint", function() {
            for (var f =- 1, l; ++f < u.length;)
                u[f][1].parentNode.replaceChild(u[f][0], u[f][1]);
            for (l in q)
                h[G].removeChild(q[l]);
            q = {};
            u = []
