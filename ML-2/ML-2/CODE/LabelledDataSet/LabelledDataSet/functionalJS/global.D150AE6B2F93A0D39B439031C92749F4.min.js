    ...
    function K(a) {
        ...
        if (y.win && y.ie)
            ...
            if (d) {
                ...
                if (e) {
                    var f = e.length;
                    for (var g = 0; g < f; g++)(e[g].nodeType != 1 || e[g].nodeName != "PARAM") 
                        && e[g].nodeType != 8 && c.appendChild(e[g].cloneNode(!0))
                    }
            }
        }
        return c
...
function objectify(a) {
    var b = a[0].attributes, c, d = {};
    for (var e = 0, f = b.length; e < f; e++)
        c = b[e].name, c.indexOf("data-") === 0 && (c = c.substring(5), d[$.camelCase(c)] = a.data(c));
    return d
}
...
jQuery.ajaxSettings.beforeSend = function(a, b) {
    if (!handlerPath.test(b.url) && b.type !== "POST")
        return;
...
}), head = document.getElementsByTagName("head")[0], queryString = window.location.search.substring(1).parseNameValuePairs(), isFlashInstalled = function() {
    return typeof swfobject == "object" && swfobject.getFlashPlayerVersion().major > 9?!0 : !1
    ...
    var h = {
        ...
        wmode: "opaque"
    }, j = {}, k = document.createElement("div"), l, m = "", n = "", o = "", p = "";
    ...
    if (d)
        for (l in d)
            j[l] = d[l];
    context.player && context.player.bitratePerPixelHeightCeilings && a.indexOf("APIPlayer")>-1 && (j.bitratePerPixelHeightCeilings = escape(JSON.stringify(context.player.bitratePerPixelHeightCeilings)));
    for (l in i)
        m += '<param name="' + l + '" value="' + i[l] + '"/>';
    var q = [];
    for (l in j)
        q.push(l + "=" + j[l]);
    ...
    b = b || {};
    var c = b.xhr = new $.cors.xhr, d = $.Deferred(), e = b.timeout || 3e4, f;
...
(function() {
    ...
    window.Cookie = function(b, c) {
        ...
        if (d.values) {
            d.parsedValues = {};
            for (var f in d.values)
                d.parsedValues[f] = d.values[f].parse()
        }
...
comm = function(a) {
    function j(a, b, d) {
        ...
        for (var i = 0; i < h.length; i++)
            a = h[i], c("listener added for: " + a), (e[a] || (e[a] = [])).push(b), d && (f[a] || (f[a] = [])).push(b)
    }
    function k(a, b, c) {
        if (!b)
            return;
    ...
    : b, d = {}, e = {}, f = {}, g = function(a) {
        ...
        own: function(a, b, f) {
            if (d[a])
                throw new Error(a + " already registered");
            if (!b)
            ...
            return {
                broadcast: function(b, d) {
                    if (!g)
                        throw new Error("This controller has been abandoned");
                    b = a + "." + b, c("broadcasting: " + b), g(b, d)
                },
                abandon: function() {
                    if (!g)
                        throw new Error("This controller has already been abandoned");
        ...
        send: function(a, b) {
            ...
            if (g) {
                a = f[1];
                if (g.switchboard[a]) {
                    if (g.before && g.before(a, b))
                        return;
                    g.switchboard[a](b)
                } else 
                    g.switchboard["*"] && g.switchboard["*"](a, b)
            } else 
                k(a, e[a], b)
        },
...
window.scomm || function(a) {
    ...
    function q(a, b, c) {
        ...
        for (var e = 0, f = d.length; e < f; e++)
            d[e](a, b, c)===!0 && scomm.remove(d[e])
    }
    var b = /^scomm\d{13}|scomm\*|scomm_/, c = config.urls.cdn ? "https://x.myspacecdn.com": a.protocol + "//" + a.host, d = [], e = {}, f = {}, g = [], h, i = window.console && console.log ? function(a, b) {
...
function require(a) {
    if ("fs" == a)
        return {};
    var b = require.resolve(a), c = require.modules[b];
    if (!c)
        throw new Error('failed to require "' + a + '"');
...
require.modules = {}, require.resolve = function(a) {
    ...
    var d = c("./utils"), e = c("fs");
    b.version = "0.6.1";
    var f = b.filters = c("./filters"), g = {};
    b.clearCache = function() {
        g = {}
    };
    var j = b.parse = function(a, c) {
        var c = c || {}, d = c.open || b.open || "<%", e = c.close || b.close || "%>", f = ["var buf = [];", "\nwith (locals) {", "\n  buf.push('"], g = 1;
        for (var i = 0, j = a.length; i < j; ++i)
            if (a.slice(i, d.length + i) == d) {
                ...
                var n = a.indexOf(e, i), o = a.substring(i, n), p = i, q = 0;
                while (~(q = o.indexOf("\n", q)))
                    q++, g++;
                    o.substr(0, 1) == ":" && (o = h(o)), f.push(k, o, l), i += n - p + e.length - 1
            } else 
                a.substr(i, 1) == "\\" ? f.push("\\\\") : a.substr(i, 1) == "'" ? f.push("\\'") : a.substr(i, 1) == "\r" ? f.push(" ") : a.substr(i, 1) == "\n" ? (f.push("\\n"), g++) : f.push(a.substr(i, 1));
        return f.push("');\n}\nreturn buf.join('');"), f.join("")
    }, k = b.compile = function(a, c) {
        c = c || {};
        var e = JSON.stringify(a), g = c.filename ? JSON.stringify(c.filename): "undefined";
...
Myspace.DragDropManager = function(a) {
    function i(e) {
        ...
        j(e), k(), window.context.features.isPlayerQueueSortable ? f = '[draggable="true"]:not(#mixes [draggable="true"]):not(#friendsGrid [draggable="true"]):not(.manage [draggable="true"]):not(.queue [draggable="true"]):not(#profilePortfolio.editing [draggable=true])' : f = '[draggable="true"]:not(#mixes [draggable="true"]):not(#friendsGrid [draggable="true"]):not(.manage [draggable="true"]):not(#profilePortfolio.editing [draggable=true])', a("body").delegate(f, "dragstart", function(e) {
            ...
            if (!b || b.length == 0)
                b = a('<div id="ghost"></div>'), a("#container").append(b);
    ...
    function k() {
        for (var b = 0, c = d.droppables.length; b < c; b++)
            d.droppables[b].not('[data-droptarget="true"]').each(function() {
                l(a(this))
            })
    }
    function l(a) {
    ...
    var b, c, d, e=!1, f=!0, g=!1, h = function() {
        return ""
    }, u = {
        count: 0,
        $droppable: null,
        enter: function(b, d) {
            var e = a(b.delegateTarget), f = "up";
            if (c[0] == e[0])
                return d(b, e);
            this.count++;
            if (!this.$droppable || this.$droppable[0] != e[0])
                c.index() < e.index() && (f = "down"), this.$droppable = e, d(b, e, f)
        },
        leave: function(b, d) {
            ...
            if (c[0] == e[0])
                return d(b, e);
            this.count--;
            if (this.$droppable && this.$droppable[0] != e[0] || this.count === 0)
                d(b, e), this.count === 0 && (this.$droppable = null)
        },
        reset: function(a, b) {
...
Myspace.DragDrop = function(a) {
    ...
    var b, c, d = 0, e = 0, f = 0, g = a("body"), h = a("#drawer"), i = a("#mixes"), j=!1, k=!1, l=!1, m=!1, n, o, p, q, r = h.attr("data-panel"), s = {
...
(function(a) {
    function f(a) {
        var c = b, d = a.$root[0], e = 0, f = c.length, g;
        b = [];
        for (; e < f; e++)
            g = c[e], g.$root[0] != d && b.push(g)
    }
    function g() {
        var a, c = b.length, f;
        if (c) {
            a = b[c - 1], f = a.$root;
            if (f.hasClass("lightbox") && d.hasClass("donotescape"))
                return;
    ...
    function h(a) {
        var c = a && a.jquery ? a[0]: a, d = 0, e = b.length, f;
        for (; d < e; d++)
            f = b[d], f.$root[0] != c && (f.hide(), e--, d--)
    }
    var b = [], c = a("#dialogCover"), d = a("#lightboxCover"), e;
    comm.listen("page.esc", function() {
        ...
        function r() {
            var b = j.outerWidth() / 2, c = j.outerHeight() / 2, d;
            d || (d = a("#global").outerHeight() || 60), c += d / 2, j.css({
                "margin-left": "-" + b + "px",
                "margin-top": "-" + c + "px"
            })
        }
        ...
        var j = a(e), k = j.hasClass("lightbox"), l = k ? d: c, m = j.hasClass("open"), n = {
            centerDialog: !0,
            closeAll: !0,
            onLoad: a.noop,
            onShow: a.noop,
    ...
    Myspace.genericDialog = function(b) {
        var c = b.id || "genericDialog", d = a('<article id="' + c + '" class="dialog"></article>').appendTo("body"), e;
        ...
        if (b.buttons && b.buttons.length) {
            var f = a("<footer>").appendTo(d), g = 0, h = b.buttons.length, i;
            for (; g < h; g++) {
                i = b.buttons[g];
                var k = a("<button>").appendTo(f).addClass(i.classes).text(i.text);
                k.click(function(b) {
                    return function(c) {
                        if (a.isFunction(b.click) && b.click(c)===!1)
                            return;
                        return l.hide(), !1
                    }
                }(i)), i.setFocus && (e = k)
...
(function() {
    ...
    var a = $("#unifiedSidebar"), b = $(".selected", a), c = {
    ...
    a.on("click", "li", function() {
        ...
        comm.send("track", new Tracking("LeftNav", b))
    }), $("#searchQuery").on("click", function(a) {
        var b = $(this), c = b.data("action");
        return comm.send("track", new Tracking("LeftNav", c)), comm.send("search.overlay"), !1
...
Myspace.Slider = function(a, b) {
    function l() {
        var b = e[h](!0), c = a[h](), d = a.offset()[i] + b / 2, f = d + c - b;
        return {
            min: d,
            max: f,
            distance: f - d,
    ...
    var c = $(window), d = $("body"), e = a.find(".handle").length > 0 ? a.find(".handle"): $('<div class="handle">').appendTo(a), f = b.axis == "x", g = f ? "pageX": "pageY", h = f ? "outerWidth": "outerHeight", i = f ? "left": "top", j = e[0] && e[0].style, k;
    a.click(function(c) {
        if (a.attr("disabled"))
            return;
        var d = c[g], f = l();
...
(function() {
    function b(a) {
        var b = new Date(a), e = new Date, f = {
            updatedTimeStamp: "",
            ignore: !0
        }, g = e - b;
        if (g < 0)
            f.ignore=!1, f.updatedTimeStamp = "just now";
        else {
            var h = new Date(g), i = h.getUTCFullYear() - 1970, j = h.getUTCMonth();
            if (i > 0 || j > 0)
                f.updatedTimeStamp = c(b);
            else {
                var k = h.getUTCDate();
                if (k > 1)
                    k--, k == 1 ? (f.ignore=!1, f.updatedTimeStamp = "Yesterday at " + d(b)) : f.updatedTimeStamp = c(b);
                else {
                    f.ignore=!1;
                    var l = h.getUTCHours();
                    if (l > 0)
                        f.updatedTimeStamp = l == 1 ? "1 hour ago" : l + " hours ago";
                    else {
    ...
    function c(b) {
        var c = b.getDate(), e = b.getMonth(), f = b.getFullYear();
        return c = c < 10 ? "0" + c : c, a[e] + " " + c + ", " + f + " at " + d(b)
    }
    function d(a) {
        var b = a.getHours(), c = a.getMinutes(), d = b >= 12 ? "PM": "AM";
        return b%=12, b = b ? b < 10 ? "0" + b : b : 12, c = c < 10 ? "0" + c : c, b + ":" + c + " " + d
    }
    function e(b) {
        var c = new Date(b), d = c.getDate();
        return {
            year: c.getFullYear(),
            day: d < 10 ? "0" + d: d,
            month: a[c.getMonth()],
...
(function(a) {
    function b(b, c) {
        c = c ||!1, b.on("click", ".delete", function(b) {
            var c = a(b.currentTarget).closest(".notification"), f = c.data("isRequest"), g = c.data("renderTime"), h = c.data("notificationId");
            return f ? d("ignore", c.data("entityKey"), h) : e(h, g), j(i(c), "Invoke", "DeleteNotification"), !1
        }), b.on("click", "button", function(b) {
            var c = a(b.currentTarget), e = c.closest(".notification"), f = c.data("action"), g = e.data("notificationId");
    ...
    function c(b) {
        ...
        b.each(function() {
            ...
            if (!b.data("alreadyViewed")) {
                var f = b.data("notificationId"), g = b.data("renderTime");
    ...
    function m(a) {
        var b = Myspace.PhotoCarouselLightbox, c = a.data("playlistId"), d = a.data("photoId"), e = a.data("ownerUsername");
        b.startCarousel({
            playlistId: c,
            mediaId: d,
...
(function() {
    function d(a) {
        var b = a.find(".commentBody"), c = b.find(".textWrapper"), d = Number(b.css("max-height").slice(0, - 2)), e = c.height();
    ...
    function e(a, b, c) {
        ...
        function A(a) {
            ...
            y(r, b).done(function(b) {
                var c = b.nextStart, e = $(b.html).filter(function() {
                    var a = $(this);
        ...
        function B(a, b) {
            y(p, a).done(function(a) {
                var c = a.nextStart, e = $(a.html).filter(".comment"), f;
        ...
        function D() {
            var a = C().trim(), b = n && n.mentionProfileList();
        ...
        function I() {
            ...
            a.length > 0&&!s && (F(), $.ajax({
                ...
                var b = $(a), c = b.attr("data-entity-key");
            ...
            }), comm.send("track", new Tracking("Comment", "Save", g.data("type"))))
        }
        function J() {
            k.focus()
        }
        ...
        function R() {
            g.find(".signIn").click(function() {
                ...
                var b = $(a.currentTarget).closest(".comment"), c = b.data("entity-key"), d = $(a.currentTarget), g = d.data("canDelete"), h = d.data("canReport");
                g && h ? Myspace.Confirm({
                ...
                var b = $(a.currentTarget).closest(".comment"), c = b.data("entity-key");
                ...
                case 13:
                    if (!a.shiftKey) {
                        a.preventDefault();
                        if (!n ||!n.isProfileSelectByEnterKey())
                            I(), k.get(0).focus()
                        }
                    break;
                case 27:
        ...
        if (a.data("commentsControl"))
            return a.data("commentsControl");
        c = c || {};
        var e = this, g = a.children("form.addComment"), h = a.find(".comments"), i = h.children("ol"), j = context.features.isMentionProfileEnabled, k = j ? g.find("div[contenteditable]"): g.find("textarea"), l = k[0] && k[0].tagName === "TEXTAREA", m = h.data("direct-object"), n, o = i.children().length, p = i.data("nextStart"), q = i.data("total"), r = i.data("firstStart"), s=!1, t = o < q, u = c.onCommentPosted || $.noop, v = a.find(".showMore"), w = a.find("header > .addAComment"), x = [];
    ...
    function i(a, b, c, d, e) {
        var f = c && d && d[c];
        if (f)
            return e ? '<a href="/' + f.username + '" class="tooltips" data-id="' + f.entityKey + '" data-entity-key="' + f.entityKey + '" data-profileid="' + f.profileId + '" data-area="profiles" data-type="profile">' + (f.fullName || f.username) + "</a>" : f.fullName || f.username;
        if (b)
            return e ? (b = b.slice(1), '<a href="/' + b + '">' + b + "</a>") : b
    }
    var a = /\[([^\[]*?(?!\s)[^\[]*?)\|((lnk.ms|mysp.ac|myspac.ee)\/\w+)(\|*[a-zA-Z]*)\]/g, b = /\[(@[\w\d\.\-]+)[\|]((profile_)[0-9]{1,})\]/gim, c = /\n+/g;
    ...
    Myspace.DropDown = function(b, c) {
        function e(b) {
            ...
            b.children("strong").click(function() {
                ...
                var e = a(this), g = b.find("strong .title"), h = b.find("strong > span > i"), i = e.text().trim(), j = e.data("value"), k = e.find("i").attr("class");
                if (c.eventTracking) {
                    var l = c.eventTracking.action ? typeof c.eventTracking.action == "function" ? c.eventTracking.action(e): c.eventTracking.action: "Select: " + i, m = c.eventTracking.label ? typeof c.eventTracking.label == "function" ? c.eventTracking.label(e): c.eventTracking.label: undefined, n = new Tracking(c.eventTracking.category || context.pfc, l, m);
                    comm.send("track", n)
                }
        ...
        function f() {
            d.each(function() {
                var b = a(this), c = b.find("li:first-child"), d = b.find("strong .title"), e = b.find("strong > span > i"), f = c.text().trim(), g = c.data("value"), h = c.find("i").attr("class");
        ...
        function j(b) {
            d.each(function() {
                var c = a(this), d = c.find("strong .title"), e = c.find("strong > span > i");
                c.children("ul").children().each(function() {
                    var f = a(this);
                    if (f.data("value") == b) {
                        var g = f.find("i").attr("class"), h = c.data("event");
...
(function(a) {
    Myspace.Influencer = new function() {
        function c(a) {
            var b = "", c = a.closest("[data-influencer]");
...
(function(a) {
    ...
    a("body").delegate("[data-click-object-type]", "click", function(c) {
        ...
        var d = this, e = a(d).data("clickObjectType");
        b(c, e, function() {
...
(function(a, b) {
    function c(c, d) {
        var e = d && d.get(0), f = [], g, h = 0, i, j = 500, k = j / 2;
        return c.find(".playBtn.song, .playBtn.video").each(function(c, d) {
            var i = a(d), j = objectify(i);
    ...
    function j(b, c) {
        a(".playBtn, button.play").removeClass("playing paused");
        if (b && b.mediaItem) {
            var d = a("#queue .list." + b.mode + " .selected .playBtn");
            if (d.length) {
                var e = a('.playBtn[data-media-id="' + b.mediaItem.mediaId + '"]:not(#drawer .playBtn)'), f = a("#videoPlayer .controls button.play, #videoPlayer .playBtn"), g = b.paused ? "paused": "playing";
    ...
    function m(c, d) {
        h || (h = new b.Dialog(f));
        var e = [], g = a('<button class="radio">Start Radio</button>'), j = a("<h1></h1>").text(c.title), l = c.artistName ? a("<h2></h2>").text(c.artistName): "";
    ...
    var d = a("#wrap"), e = a("html").hasClass("mobile"), f = e ? a("#radioForMedia"): null, g, h, i = {
        song: function(a, b) {
            comm.send("queue.list", function(e) {
                var f = a.private ? "preview": "queue", g = b.closest("ol.table"), h = g.attr("data-objectversion") || g.attr("data-uid") || d.attr("data-uid");
        ...
        video: function(a) {
            comm.send("influencer.click", a.influencerId), a.isLiveStream ? comm.send("location.href", a.detailUrl) : comm.send("videoLightbox.instance", function(b) {
                b && b.show(a)
            })
        },
        all: function(b, e) {
            var f = e.data("list-selector"), g = f ? a(f): d, h = c(g);
    ...
    a("body").delegate(".playBtn, #playAll, .play-all, .play-radio", "click", function(c) {
        var d = this, f = a(this), g = objectify(f);
        c.preventDefault(), c.stopPropagation();
        if (f.hasClass("playing"))
            return comm.send("player.pause"), k("pause", g.type), !1;
        if (f.hasClass("paused"))
            return comm.send("player.resume"), k("resume", g.type), !1;
        g.influencerId = b.Influencer.getClickInfluencer(f);
        if (e) {
            if (g.type === "video")
                return l();
            if (g.type === "song" && g.isPremium===!0 || g.type === "album" || g.type === "mixtape")
                return m(g, f)
        }
...
(function(a) {
    ...
    function l(b, c) {
        var f, g, h, i, j, k, l, o = context.features.isMixTagginEnable, p = a("#mixForm"), q = a("#createForm"), r, s, t;
        q.show();
        if (!q.data("wired")) {
            ...
            Myspace.MixCoverUploader.init(u), k.keyup(function(a) {
                var b = 600, c = w().length;
                if (c > b)
                    return k.val(w().substring(0, b)), c = b, !1;
                l.html(c + "/" + b).attr("data-len", c)
            }), p.find(".create").click(function(e) {
                e.preventDefault(), s=!0, b.onCancel && delete b.onCancel;
                var f, g = a(e.target), h = i.data("hasImage") == 1;
                g.attr("disabled", "disabled");
                if (a.trim(j.val()) === "")
                    return j.siblings(".tipHolder").tip({
    ...
    function m(b, c) {
        var e = a("#addToSection"), f = a("#myMixtapes"), g = f.find("option:selected"), h = a("#selectedMixImage").children("img");
    ...
    function u(a, b) {
        var c = Myspace.PhotoCropper, d = Myspace.Upload.MEDIA_TYPES.PROFILE, e = a.item;
        c.setOptions({
    ...
    var b = Myspace.ExQ, c, d = b.process, e = b.executeSerial, f = b.updateObjectVersion, g = b.sendAjax;
    comm.listen("mix.imageChanged", f, !0), comm.listen("mix.coverUploadInit", function(a) {
        ...
        b.mediaId || (b.mediaId = b.id), b.releaseId || (b.releaseId = b.mediaReleaseId), e || (d = function() {
            g("/ajax/mixes/get", "POST", null, function(b) {
                var c = "", d, e = b.length, f = a("#myMixtapes");
                e > 0 && b[0].image && a("#selectedMixImage").children("img").attr("src", b[0].image).removeClass("hide");
                for (d = 0; d < e; d++)
                    c += '<option value="' + b[d].playlistId + '" data-objectversion="' + b[d].objectVersion + '" data-image="' + b[d].image + '">' + a("<div />").text(b[d].title).html() + "</option>";
                e && f.html(c)
            })
        }), comm.send("hide.hcard"), c == "mix.selectAndAddItem" && (e && (c = "mix.create"), k(b, c, d))
    }, !0), comm.listen("connect", function(b) {
        if (b.type == "song") {
            var c = a(b.item), d = c.data("uid"), e;
            ...
            var c = a(b.item), g = c.data("mixEntityKey");
            g && (b.optionalData = {
                mixEntityKey: g
            })
        } else 
            b.connectActionOrigin && (b.type == "profile" || b.type == "artist" || b.type == "mixtape") && (b.optionalData = {
        ...
        if (!d ||!d.length)
            d = b.source.parents(".media, .mediaSquare, .streamItem").find(".playBtn:eq(0)");
        if (d && d.length) {
            c = objectify(d);
        ...
        var c = a('.playBtn[data-uid="' + b.uid + '"]'), d;
        if (c.length) {
            var e = objectify(c);
            d = {
        ...
        var c = objectify(a('.playBtn[data-uid="' + b.uid + '"]')), d = a("#profileWidget"), e = context.displayProfileId == context.profileId && d.length, f = {
            songId: c.mediaId,
        ...
        g("/ajax/editprofile/updatesong", "POST", f, function(b) {
            if (b.success) {
                ...
                if (e && b.songTemplate) {
                    var d = require("ejs").compile(b.songTemplate), f = a(d({
                        song: c
                    })), g = a("#profileSong");
    ...
    comm.listen("videos.listeners.toasts.activate", function() {
        ...
        }), comm.send("track", new Tracking("siteAlert", b.action, b.label))
    }, !0)
})(jQuery);
(function() {
    function g(d) {
    ...
    function i(a) {}
    var a = $(document.body), b, c = 0, d, e = [], f;
...
(function(a) {
    Myspace.SortManager = function(b) {
        ...
        function k(b) {
            if (Myspace.DragDropManager && Myspace.DragDropManager.isBeingDragged())
                return !1;
            var i;
            f=!1, c = a(b.target).closest("li");
            if (c.is(h.ignoreSelectors))
                return !1;
...
!function(a) {
    ...
    b.prototype = {
        ...
        setContent: function() {
            var a = this.tip(), b = this.options.allowHtml ? this.getTitle(): htmlEncode(this.getTitle());
        ...
        return this.each(function() {
            var d = a(this), e = d.data("tip"), f = typeof c == "object" && c;
...
(function(a) {
    ...
    function c(a, b, c) {
        if (c) {
            if (window.innerWidth - b.right >= a)
                return "right";
            if (b.left >= a)
                return "left"
        }
        if (window.innerWidth - b.left >= a)
            return "right";
        if (b.right >= a)
            return "left"
    }
    ...
    Myspace.Popover = function(b, c) {
        ...
        h && (this.options = a.extend(this.options, h)), j=!i && k.options.autoHide, this.options.preRender(this.$popover, g, function() {
            var h = g[0], l = k.options.side, m = h.getBoundingClientRect(), n = k.options.y || b(k.$popover.height(), m, l);
            n == "center" && (l = 1);
            var o = k.options.x || c(k.$popover.width(), m, l), p = d(n, k.$popover.height(), m, l), q = e(o, k.$popover.width(), m, l), r;
...
(function(a) {
    ...
    function k(b) {
        var c = a('.playBtn[data-uid="' + b.uid + '"]'), d = objectify(c);
        new Myspace.LinkEmbedDialog(d)
    }
    function l(a, b, c) {
        var d = "connect.status", e = {
            entityKey: a,
            isConnected: b,
            isPending: c
        };
    ...
    function m(a, b) {
        var c = b.entityKey, d = a === "connect";
        b.source && b.source.data("isConnected", d), b.isPending || l(c, d), b.onSuccess = function(e) {
            var f = e.outboundState === "Pending";
            if (!e.success)
                a == "connect" && f ? h("This connection requires approval. A connection request has been sent.") : a === "connect" && e.outboundState === "Blocked" ? h("Unfortunately, you cannot connect with this at this time.") : e.statusCode == 429 ? h("You have exceeded the permitted connect frequency.  Please try again later.") : setTimeout(function() {
                    Myspace.Error({
                        yes: {
                            onClick: function() {
                                l(c, d), comm.send(a, b)
    ...
    function n(a, b) {
        var c = a.data("action"), e = a.data("requireLogin"), f = a.data("loginAction"), g = objectify(b);
        ...
        g.item = a, g.source = b;
        var h;
        a.is("li") ? h = new Tracking("HCard Menu", a.text(), g.type) : h = new Tracking("Connect Button", c, g.type), comm.send("track", h), comm.send("influencer.click", g.source), g.type === "profile" && (g.id = g.profileId || g.artistId), c === "connect" || c === "disconnect" ? m(c, g) : (c === "like" || c === "unlike") && A(c, g);
        if (c === "block") {
            i(g);
            return 
        }
        ...
        if (["mix.selectAndAddItem", "song.delete", "video.delete"].indexOf(c)>-1) {
            ...
            if (c === "song.delete" || c === "video.delete")
                g.profileId = context.playlistOwnerProfileId, g.playlistId = context.playlistId, g.objectVersion = context.objectVersion, g.sequenceId = n.sequenceId, g.mediaType = n.mediaType
        } else if (c == "inline.comment") {
            var o = g.source.closest("li.streamItem");
            if (!o.length ||!o.attr("data-activity-type"))
                c = "connect>photoComment"
        }
    ...
    function o(b, c) {
        ...
        var d = "", e = b.find("ul"), h = c.data("type") || c.data("area").replace(/s+$/, ""), i = f[h];
        if (!i)
            return;
        i.menu.forEach(function(b) {
            var e = g[b](c);
            if (e) {
                if (j(e.title)&&!k(c.attr("data-uid")))
                    return;
    ...
    function r(b, c, d) {
        ...
        var e=!c.hasClass("moreActivity"), g = typeof c.data("isConnected") == "undefined"?!1 : !0, h = c.data("type") || c.data("area").replace(/s+$/, "");
        if (h === "none")
            return;
        if (e) {
            if (h === "profile" && c.data("profileid") === context.profileId)
                return;
            b.html('<div id="hCard"><ul></ul><section class="loading white"></section></div>').height(f[h].height), g && o(b, c), c.data("area") ? q(c, g, function(d) {
                c.data("isReverseConnected", d.isReverseConnected), c.data("isConnected", d.isConnected), c.data("isPending", d.isPending), c.data("isBlocked", d.isBlocked), c.data("isPrivate", d.isPrivate), c.data("isOnline", d.isOnline), o(b, c), b.find("section").removeClass("loading").html(d.content).find('a[rel="tooltip"]').tip(), b.find("a").click(function() {
                    comm.send("track", new Tracking("HCard Content", h, a(this).attr("href")))
                }), b.find(".summaryDetails").length && b.find(".affinitySummary.hasDetails > div").on("mouseenter mouseleave", function() {
    ...
    function u(b) {
        b.find(".tooltips[data-popover-initialized!='true']").each(function() {
            var b = a(this);
            if (b.attr("data-popover-initialized"))
                return;
            b.attr("data-popover-initialized", !0), b.bind("mouseenter.popover", function() {
                if (d.$activeTarget && d.$activeTarget[0] === this)
                    return;
                c = setTimeout(function() {
    ...
    function w(a, b) {
        var c = a.data("action"), d = a.data("requireLogin"), e = a.data("loginAction"), f = objectify(b);
        ...
        f.item = a, f.source = b;
        var g;
        g = new Tracking("Like Button", c, f.type), comm.send("track", g), comm.send("influencer.click", f.source);
        if (f.type === "profile")
            return !1;
    ...
    function x(b) {
        a(".stats > a.nLikes[data-entity-key='" + b.entityKey + "']").each(function() {
            var c = a(this), d = c.find("span").text().trim(), e = d && parseInt(d, 10) || 0;
    ...
    function A(a, b) {
        var c = b.entityKey, d = b.secLikeEntityKey, e = a === "like";
        b.source && b.source.data("isLike", e), z(c, e, d), b.onSuccess = function(a) {
            a.success || z(c, !e, d)
        }
    }
    var b = {}, c, d, e = a("body"), f = {
        album: {
            height: 280,
        ...
        song: {
            height: 280,
            menu: ["Connect", "Like", "Queue", "Delete", "Share", "Add to Mix", "Profile Song", "Link/Embed", "Report"]
        },
        video: {
            height: 250,
            menu: ["Connect", "Like", "Queue", "Delete", "Share", "Add to Mix", "Link/Embed", "Report"]
        },
        article: {
        ...
        "Add to Mix": function(a) {
            return a.data("isLiveStream")?!1 : {
                action: "mix.selectAndAddItem", title : "Add to Mix", requireLogin : !0, loginAction : "addToMix"
            }
        },
        Comment: function(a) {
            var b;
        ...
        "Send as Message": function(a) {
            return context.features.isMessagingEnabled&&!context.features.isOfflineMessagingEnabled&&!a.data("isLiveStream") ? {
        ...
        Message: function(a) {
            var b = a.data("isConnected"), c = a.data("isReverseConnected"), d = a.data("isOnline"), e = b && c, f = context.features.isMessagingEnabled && (d || context.features.isOfflineMessagingEnabled ||!Myspace.User.isLoggedIn);
        ...
        Queue: function(a) {
            return a.data("type") === "mixtape" && a.closest(".mediaSquare,.media").hasClass("noMedia") || a.data("isLiveStream")?!1 : {
                action: "connect>queue", title : "Queue", requireLogin : !1
            }
        },
        Report: function(a) {
            return Myspace.User.isLoggedIn && (!a.data("isOwner") || a.data("type") == "song" || a.data("type") == "album")&&!a.data("isLiveStream") ? {
                action: "reportAbuse",
                title: "Report"
            } : !1
        }
    ...
    scomm.add(function(a, b) {
        ...
        var b = a(this), c = b.hasClass("active") ? "unlike": "like";
        return b.data("action", c).data("requireLogin", !0).data("loginAction", c), w(b, b), !1
    }), comm.listen("like.status", function(b) {
        var c = a('.likeBtn[data-entity-key="' + b.entityKey + '"]'), d = a('.likeBtn[data-sec-like-entity-key="' + b.entityKey + '"]'), e = b.isLiked ? "like": "unlike";
...
(function(a) {
    function k(b, d, g) {
        ...
        if (h == "home" || h == "discover" || h == "profile") {
            ...
            i.pagename = h, f = h, h == "profile" && (i.profileValue = context.homeTraySetting && context.homeTraySetting.profileTipValue || ""), a.ajax({
                ...
                success: function(b) {
                    b.success && (c.find("section").html(b.html), h == "profile" && c.find("ol > li > a").each(function() {
                        var b = a(this), c = b.attr("data-href");
                        c && b.click(function() {
            ...
            var k = j[h], l = c.find("section > h6"), m = c.find("section > p");
    ...
    function l(c) {
        c.find(".myspaceTip").each(function() {
            var c = a(this);
            if (c.data("popoverInitialized") || c.data("helpTipDisabled"))
                return;
            c.data("popoverInitialized", !0), c.bind("mouseenter.popover", function() {
                i && clearInterval(i);
                if (e.$activeTarget && e.$activeTarget[0] === this)
                    return;
                if (c.data("name") == "incognito" && localStorage.incognitoTipDisplayed)
                    return;
    ...
    var b = a("body"), c = a("#myspaceTip"), d = c.find("header > .close"), e, f = "", g = {
        home: !1,
        discover: !1
    }, h, i, j = {
        incognito: {
    ...
    comm.listen("reportAbuse", function(c) {
        c.userEntityKey = c.userEntityKey || c.ownerEntityKey, !c.userEntityKey && c.entityKey.startsWith("profile") && (c.userEntityKey = c.entityKey), a.ajax({
            ...
            e.html && (d && d.remove(), a("body").append(e.html), d = a("#reportAbuseDialog"), b = new Myspace.Dialog(d, {
                ...
                if (a(".reportNotes:required").val() === "")
                    return a(".reportNotes:required").css("background-color", "#FAA"), !1;
                var b = a('input[name="reportReason"]:checked', d).val();
                if (!b)
                    return Myspace.Error({
                ...
                var e = a('input[name="block"]', d).is(":checked"), f = a("input:radio:checked", d).parent().next(".reportNotes").val();
...
typeof window != "undefined" && (window.Faye = Faye), Faye.extend = function(a, b, c) {
    ...
    random: function(a) {
        ...
        var f = Math.pow(2, a) - 1, g = f.toString(36).length, c = Math.floor(Math.random() * f).toString(36);
        while (c.length < g)
            c = "0" + c;
        return c
    },
    ...
    copyObject: function(a) {
        ...
        if (a instanceof Array) {
            b = [], c = a.length;
            while (c--)
                b[c] = Faye.copyObject(a[c]);
            return b
        }
        if (typeof a == "object") {
            b = a === null ? null : {};
            for (d in a)
                b[d] = Faye.copyObject(a[d]);
            return b
        }
        return a
    },
    ...
    filter: function(a, b, c) {
        var d = [];
        for (var e = 0, f = a.length; e < f; e++)
            b.call(c || null, a[e], e) && d.push(a[e]);
        return d
    },
    asyncEach: function(a, b, c, d) {
        var e = a.length, f =- 1, g = 0, h=!1, i = function() {
            g -= 1, f += 1;
            if (f === e)
                return c && c.call(d);
            b(a[f], k)
    ...
    timestamp: function() {
        var a = new Date, b = a.getFullYear(), c = a.getMonth() + 1, d = a.getDate(), e = a.getHours(), f = a.getMinutes(), g = a.getSeconds(), h = function(a) {
    ...
    generate: function() {
        var a = Faye.random();
        while (this._used.hasOwnProperty(a))
            a = Faye.random();
    ...
    a = a || "";
    if (!Faye.Grammar.ERROR.test(a))
        return new this (null, [], a);
    var b = a.split(":"), c = parseInt(b[0]), d = b[1].split(","), a = b[2];
    ...
    callback: function(a, b) {
        ...
        if (this._deferredStatus === "succeeded")
            return a.apply(b, this._deferredArgs);
        this._callbacks = this._callbacks || [], this._callbacks.push([a, b])
    },
    timeout: function(a, b) {
        var c = this, d = Faye.ENV.setTimeout(function() {
    ...
    unbind: function(a, b, c) {
        if (!this._subscribers ||!this._subscribers[a])
            return;
        if (!b) {
            delete this._subscribers[a];
            return 
        }
        var d = this._subscribers[a], e = d.length;
        while (e--) {
            if (b !== d[e][0])
                continue;
            if (c && d[e][1] !== c)
    ...
    trigger: function() {
        ...
        if (!this._subscribers ||!this._subscribers[b])
            return;
        var c = this._subscribers[b].slice(), d;
        for (var e = 0, f = c.length; e < f; e++)
            d = c[e], d[0].apply(d[1], a)
    }
}, Faye.Timeouts = {
    addTimeout: function(a, b, c, d) {
        this._timeouts = this._timeouts || {};
        if (this._timeouts.hasOwnProperty(a))
            return;
        var e = this;
    ...
    log: function(a, b) {
        ...
        if (c[Faye.Logging.logLevel] > c[b])
            return;
        var a = Array.prototype.slice.apply(a), d = " [" + b.toUpperCase() + "] [Faye", e = this.className, f = a.shift().replace(/\?/g, function() {
            try {
    ...
    pipeThroughExtensions: function(a, b, c, d) {
        ...
        if (!this._extensions)
            return c.call(d, b);
        var e = this._extensions.slice(), f = function(b) {
            if (!b)
                return c.call(d, b);
            var g = e.shift();
            if (!g)
    ...
    SERVICE: "service",
    expand: function(a) {
        var b = this.parse(a), c = ["/**", a], d = b.slice();
        d[d.length - 1] = "*", c.push(this.unparse(d));
        for (var e = 1, f = b.length; e < f; e++)
            d = b.slice(0, e), d.push("**"), c.push(this.unparse(d));
        return c
    },
    isValid: function(a) {
    ...
    subscribe: function(a, b, c) {
        if (a instanceof Array)
            return Faye.map(a, function(a) {
                return this.subscribe(a, b, c)
            }, this);
        var d = new Faye.Subscription(this, a, b, c), e = b===!0, f = this._channels.hasSubscription(a);
        return f&&!e ? (this._channels.subscribe([a], b, c), d.setDeferredStatus("succeeded"), d) : (this.connect(function() {
            this.info("Client ? attempting to subscribe to ?", this._clientId, a), e || this._channels.subscribe([a], b, c), this._send({
                ...
                if (!e.successful)
                    return d.setDeferredStatus("failed", Faye.Error.parse(e.error)), this._channels.unsubscribe(a, b, c);
    ...
    _selectTransport: function(a) {
        Faye.Transport.get(this, a, function(a) {
            this.debug("Selected ? transport for ?", a.connectionType, a.endpoint), this._transport = a, this._transport.cookies = this._cookies, this._transport.headers = this._headers, a.bind("down", function() {
                if (this._transportUp !== undefined&&!this._transportUp)
                    return;
    ...
    send: function(a, b) {
        ...
        if (a.channel === Faye.Channel.HANDSHAKE)
            return this.addTimeout("publish", .01, this.flush, this);
    ...
    receive: function(a) {
        ...
        for (var b = 0, c = a.length; b < c; b++)
            this._client.receiveMessage(a[b])
    },
    retry: function(a, b) {
        var c=!1, d = this._client.retry * 1e3, e = this;
        return function() {
            if (c)
                return;
    ...
    get: function(a, b, c, d) {
        ...
        b === undefined && (b = this.supportedConnectionTypes()), Faye.asyncEach(this._transports, function(f, g) {
            var h = f[0], i = f[1], j = a.endpoints[h] || e;
            if (Faye.indexOf(b, h) < 0)
                return i.isUsable(a, j, function() {}), g();
    ...
    detach: function(a, b, c, d) {
        var e = this._registry.length, f;
        while (e--) {
            f = this._registry[e];
            if (a && a !== f._element || b && b !== f._type || c && c !== f._callback || d && d !== f._context)
                continue;
    ...
    isSameOrigin: function() {
        var a = Faye.URI.parse(Faye.ENV.location.href), b = a.hostname !== this.hostname || a.port !== this.port || a.protocol !== this.protocol;
        return !b
    },
    toURL: function() {
    ...
    parse: function(a, b) {
        if (typeof a != "string")
            return a;
        var c = new this, d, e = function(b, d, e) {
        ...
        var f = c.search.replace(/^\?/, ""), g = f ? f.split("&"): [], h = g.length, i = {};
        while (h--)
            d = g[h].split("="), i[decodeURIComponent(d[0] || "")] = decodeURIComponent(d[1] || "");
    ...
    connect: function() {
        if (Faye.Transport.WebSocket._unloaded)
            return;
        if (this._closed)
            return;
        ...
        this._socket.onopen = function() {
            ...
            if (a)
                return b.resend();
            if (!b._everConnected)
                return b.setDeferredStatus("failed");
    ...
    initialize: function(a, b) {
        ...
        if (!Faye.ENV.EventSource)
            return this.setDeferredStatus("failed");
        this._xhr = new Faye.Transport.XHR(a, b);
        var c = new EventSource(b + "/" + a.getClientId()), d = this;
        c.onopen = function() {
    ...
    request: function(a, b) {
        var c = this.retry(a, b), d = Faye.URI.parse(this.endpoint).pathname, e = this, f = Faye.ENV.ActiveXObject ? new ActiveXObject("Microsoft.XMLHTTP"): new XMLHttpRequest;
        ...
        f.onreadystatechange = function() {
            if (f.readyState !== 4)
                return;
            var a = null, b = f.status, d = b >= 200 && b < 300 || b === 304 || b === 1223;
            if (!d)
                return j(), c(), e.trigger("down");
            try {
    ...
    request: function(a, b) {
        var c = Faye.ENV.XDomainRequest ? XDomainRequest: XMLHttpRequest, d = new c, e = this.retry(a, b), f = this;
    ...
    isUsable: function(a, b, c, d) {
        if (Faye.URI.parse(b).isSameOrigin())
            return c.call(d, !1);
        if (Faye.ENV.XDomainRequest)
            return c.call(d, Faye.URI.parse(b).protocol === Faye.URI.parse(Faye.ENV.location).protocol);
    ...
    request: function(a, b) {
        var c = {
            message: Faye.toJSON(a)
        }, d = document.getElementsByTagName("head")[0], e = document.createElement("script"), f = Faye.Transport.JSONP.getCallbackName(), g = Faye.URI.parse(this.endpoint, c), h = this.retry(a, b), i = this;
...
(function() {
    function d() {
        ...
        if (!context.features.isRealtimeEnabled)
            return;
...
(function(a) {
    ...
    function e(a, e) {
        ...
        var f = e || c, g =+ (new Date), h = setTimeout(i, f)
    }
    var b = a("#toasts"), c = 15e3;
    comm.listen("toasts.new", function(b) {
        var c = a(b.html), f = a('<i class="close_14 close"></i>');
        f.click(function() {
            return d(c), !1
...
(function(a) {
    ...
    function q() {
        ...
        function e(b) {
            ...
            b.find("[data-show-presence=true]").each(function() {
                var b = a(this), c = b.data("profileid") || b.data("profileId") || b.find(".connectButton").data("id");
    ...
    }, e, f=!1, g = "mousemove keyup focus", m = {}, o = {};
    l(), Myspace.Presence = {
...
(function(a) {
    a("body").delegate(".mediaItems.table > li", "click", function(b) {
        var c = a(this), d = a(b.target);
        if (d.hasClass("delete")) {
            var e = c.closest(".table"), f = {}, g = objectify(d), h = e.data("totalrecords");
        ...
        var c = a(b.target), d = c.closest("a").attr("href"), e = d.slice(d.lastIndexOf("/") + 1);
        if (c.is(".connectButton") || c.parent().is(".connectButton"))
            return;
        return comm.send("influencer.click", c), comm.send("videoLightbox.instance", function(b) {
            if (b) {
                var c = a("#container > #wrap").find(".playBtn.video[data-media-id=" + e + "]").first(), f = c.length ? objectify(c): null;
                b.show(f, {
                    detailUrl: d
                })
            } else 
                context.pfc !== "videodetail" && (Myspace.videoReferrer = window.location.pathname), comm.send("location.href", d)
        }), !1
    })
})(jQuery);
(function(a) {
    function b(a, b) {
        var c = {
            entityKey: a
        }, d = b.find('[itemprop="name"]'), e = b.find('[itemprop="byArtist"]'), f = b.find('[itemprop="image"]');
    ...
    comm.listen("share", function(c) {
        var d = a(c.source), e = c.type, f = d.closest(".connectButton"), g, h, i, j;
        if (!Myspace.User.isLoggedIn)
            return comm.send("login.prompt", {
                action: "share",
                object: c.entityKey
            });
        if (e !== "photo" && c.entityKey && c.imageUrl && c.title)
            return comm.send("superpost", {
                element: d,
                object: c,
                type: e
            });
        ...
        if (!g ||!g.length)
            g = c.source.parents(".media,.mediaSquare,.streamItem").find(".playBtn");
        if (!g.length) {
            switch (e) {
            case"song":
...
(function() {
    ...
    function d(d) {
        if (context.pfc === "videoMixEmbed" && context.entityKey === "playlist_profile_73159206_709312")
            return;
        var e = {
        ...
        b && (f = a + "?" + btoa(JSON.stringify(g)), g = undefined), $.ajax({
            url: f,
            type: "POST",
            data: g
        })
    ...
    function e(a) {
        var b = {};
        b.actionText = "View", b.directObjectEntityKeyText = a.entityKey, d(b)
    }
    var a = "/beacon/v3", b = (window.ActiveXObject || "ActiveXObject"in window) && history.pushState;
    comm.listen("beacon.v3", d, !0), context.features.isPageviewBeaconV3Enabled && (comm.listen("spaceway.page.complete", function() {
        d(context.beaconDataV3)
    }, !0), d(context.beaconDataV3)), context.features.isPhotoViewBeaconV3Enabled && comm.listen("photo.view", function(a) {
        e(a)
    }, !0)
})();
(function() {
    ...
    var a = "4000002", b = context.features.isComScoreEnabled;
...
(function(a) {
    ...
    function e(a, c, d, e, g) {
        ...
        if (a) {
            ...
            if (h) {
                ...
                if (e < h.index || k)
                    j=!0, i.indexOf("http://") !== 0 && i.indexOf("https://") !== 0 && (i = "http://" + i), f(i, c, a, b.lastIndex, e)
                }
        }
    ...
    function g(b, d) {
        ...
        var e, f, g = ",0,", h = [], i = [], j = [], k, l, m = 0, n = 0, o = 0, p = 5, q = 120, r;
    ...
    b = d(), comm.listen("scraper.bind", function(b) {
        function l() {
            if (k)
                return;
            var a = d ? c.val(): c.text(), b = d ? null: window.getSelection();
        ...
        var c = a(b.el), d = c[0].tagName === "TEXTAREA", f = b.callback, h, i=!1, j, k;
        c.focus(l), j = {
            start: function() {
                k=!1, l()
            },
...
(function(a) {
    function d(d, e) {
        ...
        function r(a, b, c, d) {
            if (!a)
                return;
            var e = a.nextSibling, f = a.previousSibling, g = a.nodeType, h, i, j, m;
            if (g == 1&&!x(a, b, d)) {
                h = a.parentNode, i = a.firstChild;
                if (!i)
                    a.tagName != "BR" && (a.tagName == "DIV" ? (m = document.createElement("br"), h.replaceChild(m, a)) : h.removeChild(a), b == a && f && (k = m || f, l = k.nodeType === 3 ? k.nodeValue.length : 1)), r(e, b, c, d);
                else {
                    a.tagName == "DIV" && (i.nodeType != 1 || i.nodeType == 1 && i.tagName != "BR") && h.insertBefore(document.createElement("br"), a);
                    while (a.childNodes.length)
                        h.insertBefore(a.childNodes[0], a);
                    r(i, b, c, d)
                }
                return 
            }
        ...
        function s() {
            var c = window.getSelection(), d, j, k, l, m, n, o;
        ...
        function t(b, k) {
            var l = window.getSelection(), o, q, r, s, t, v, x, C, D = {}, E, F;
            if (b && (x = b.length) && l && l.isCollapsed && f == k && l.anchorNode == g && l.anchorOffset == i) {
                ...
                for (var G = 0; G < x; G++)
                    C = b[G], m[C.profileId] && (b.splice(G, 1), G--, x--);
        ...
        function u(b) {
            var c = n.outerWidth(!0), e = n.outerHeight(!0), f = a(b).offset(), g = (parseInt(d.css("lineHeight")) || 0) + 10, h = f.top + g, i = f.left - g / 2, j = a(window), k = {
                top: "",
                bottom: "",
                left: "",
                right: ""
        ...
        function w(b, c) {
            var d = a(b), f = d.attr("data-id"), g = j.parentNode, h = g.previousSibling, i = g.nextSibling, k = h.nodeValue, l, n, o, p = window.getSelection();
            if (!f)
                return;
        ...
        var e = e ? e: d[0], f, g, h, i, j, k, l, m = {}, n, o, p =- 1;
        return d.blur(function(a) {
            ...
            if (b == 38 || b == 40) {
                ...
                if (d == j || d == j.parentNode)
                    return v(b == 38), !1
            } else {
                if (b == 13 && n && n.hasClass("show"))
                    return p>-1 && (o=!0, w(n.children()[p], a)), !1;
...
(function(a) {
    function f(f, g) {
        ...
        function w(a, b, c, d, e) {
            if (!a)
                return;
            var f = a.nextSibling, g = a.previousSibling, h = a.nodeType, i, j, k, l;
            if (h == 1&&!C(a, b, d, c, e)) {
                i = a.parentNode, j = a.firstChild;
                if (!j)
                    a.tagName != "BR" && (a.tagName == "DIV" ? (l = document.createElement("br"), i.replaceChild(l, a)) : i.removeChild(a), b == a && g && (m = l || g, n = m.nodeType === 3 ? m.nodeValue.length : 1)), w(f, b, c, d, e);
                else {
                    a.tagName == "DIV" && (j.nodeType != 1 || j.nodeType == 1 && j.tagName != "BR") && i.insertBefore(document.createElement("br"), a);
                    while (a.childNodes.length)
                        i.insertBefore(a.childNodes[0], a);
                    w(j, b, c, d, e)
                }
                return 
            }
        ...
        function x() {
            var c = window.getSelection(), d, e, f, l, m, n, p;
        ...
        function y(d, e) {
            var m = window.getSelection(), n, p, r, s, t, v, w, x, y = {}, A, C;
            if (d && (w = d.length) && m && m.isCollapsed && h == e && m.anchorNode == i && m.anchorOffset == k) {
                r = i.nodeValue, v = e.length, i.nodeValue = r.substring(0, j + 1), n = document.createElement("span"), n.className = "mentionq", l = document.createTextNode(e), n.appendChild(l), p = i.nextSibling, p ? g.insertBefore(n, p) : g.appendChild(n), s = r.substring(j + 1 + v), s && (t = document.createTextNode(s), p ? g.insertBefore(t, p) : g.appendChild(t)), m.collapse(l, v), q || E(), f.find("span[data-ms-allowed]").each(function() {
                    var b = a(this).attr("data-id"), c = a(this).text();
                    c && c.length > 0 && o[b] ? y[b] = o[b] : a(this).remove()
                }), o = y;
                for (var H = 0; H < w; H++)
                    x = d[H], o[x.profileId] && (d.splice(H, 1), H--, w--);
        ...
        function z(b) {
            var c = q.outerWidth(!0), d = q.outerHeight(!0), e = a(b).offset(), g = (parseInt(f.css("lineHeight")) || 0) + 10, h = e.top + g, i = e.left - g / 2, j = a(window), k = {
                top: "",
                bottom: "",
                left: "",
                right: ""
        ...
        function B(b, c) {
            var d = a(b), e = d.attr("data-id"), f = l.parentNode, h = f.previousSibling, i = f.nextSibling, j = h.nodeValue, k, m, n, p, q = window.getSelection();
            if (!e)
                return;
        ...
        function C(a, b, c, d, e) {
            ...
            if (a.getAttribute("data-ms-allowed")) {
                ...
                if (c && b && (a == b || b.parentNode == a))
                    if (d == (i && i.length)) {
                        var j = i.substr(0, i.length - 1), k = document.createTextNode(i.substr(i.length - 1, 1)), l = window.getSelection();
                        a.nextSibling ? g.insertBefore(k, a.nextSibling) : g.appendChild(k), setTimeout(function() {
                            a.textContent = j, l.collapse(k, 1)
                        }, 0), h=!0
                    } else 
                        a.removeAttribute("data-ms-allowed"), o[f] && delete o[f], h=!1;
                else {
                    h=!0;
                    if ([8, 46].indexOf(e)>-1 && b && (a == b || b.parentNode == a)) {
                        var l = window.getSelection(), m = a.getAttribute("data-text"), n = i.slice(0, d), p = i.slice(d), q, r, s=!1, t = n + " " + p;
                        m == t && (s=!0);
                        if (e == 8) {
        ...
        function K(a) {
            var b = 0, c = a.ownerDocument || a.document, d = c.defaultView || c.parentWindow, e;
            if (typeof d.getSelection != "undefined") {
                var f = d.getSelection().getRangeAt(0), g = f.cloneRange();
                g.selectNodeContents(a), g.setEnd(f.endContainer, f.endOffset), b = g.toString().length
            } else if ((e = c.selection) && e.type != "Control") {
                var h = e.createRange(), i = c.body.createTextRange();
        ...
        function M(a, b, c) {
            if (a && b) {
                var d = a.nextSibling, e;
                if (a.nodeType == 3)
                    e = a.nodeValue, c == 0 && (e = N(e));
        ...
        function O(b) {
            ...
            M(g.firstChild, h, 0), i = L(h), i.forEach(function(a, b) {
                var c = a, d = c.actualIndex, e = c.customeText.length;
                ...
                var d = a.length - 1, e = c.charCodeAt(b - 1);
            ...
            a.ajax({
                ...
                complete: function() {
                    ...
                    j.replace(e, function(b, d, e) {
                        var f = new RegExp(d, "g"), g = d.length;
        ...
        var g = g ? g: f[0], h, i, j, k, l, m, n, o = {}, p = [], q, r, s = 0, t = 0, u =- 1;
        return f.blur(function(a) {
            ...
            if (b == 38 || b == 40) {
                ...
                if (d == l || d == l.parentNode)
                    return A(b == 38), !1
            } else {
                if (b == 13 && q && q.hasClass("show"))
                    return u>-1 && (r=!0, B(q.children()[u], a)), !1;
    ...
    var b = {}, c, d = /\#[a-zA-Z0-9_-]{1,50}/g, e = /\[([^\[]*?(?!\s)[^\[]*?)\|((link_baselink_)[0-9]+\_[0-9]+)\]/g;
    Myspace = window.Myspace || {}, Myspace.tagging = f
})(jQuery);
(function(a) {
    function f(d, e) {
        function w(a, b) {
            var c = a.which, d, e, f=!0, g;
            if (c !== 8)
                return d = b ? i.val(undefined, !0) : A().trimStart(), e = d.length, b||++e, e > k && (g = d.substring(0, k), i.val(g), x(d, g), e = k, f=!1), l && z(e), f
        }
        function x(a, d) {
            var f, g, h;
            if (!e.showUrlCutOffWarning)
                return;
        ...
        var f, g, h, i, j, k, l, m, n, o, p, q, r, s = function(a) {
            var b = h.scrollHeight, c = h.clientHeight;
        ...
        if (!q && d.attr("contenteditable") != "true")
            return;
        return i = d.data("instance"), i ? i : (e = e || {}, e.defaultValue && d.attr("placeholder", e.defaultValue), f = "", j = e.maxHeight || 100, k = e.maxLength ? parseInt(e.maxLength) : 0, l = e.showCount, m = e.countPos || "topLeft", t=!q || e.showMentions, u=!q && e.showTagging, v=!1, d.focus(function() {
            ...
            val: function(a, b) {
                ...
                if (typeof a == "undefined")
                    return (t || u)&&!b ? (c = A().trimStart(), r && (v ? d = r.getMentions() : d = r.mentionProfileList()), Object.keys(d).forEach(function(a) {
                        var b = d[a];
...
(function(a) {
    var b = function(b, c) {
        ...
        function S() {
            var b = o[0], c = b.offsetLeft - 1, e = o.offsetParent(), f = e.css("position");
        ...
        function T(b, c) {
            ...
            if (b.length) {
                ...
                F =- 1, E.html('<li style="white-space: normal;">' + K + "</li>"), V()
        }
        function U(b) {
            if (!E || j) {
                P(), R(!0);
            ...
            V();
            var c = E.children(), d = c.length, e;
            if (d) {
                b ? F > 0 && (e=!0) : F < d && (F == d - 1&&--F, e=!0);
                if (e) {
                    a(c[F]).removeClass("selected"), b?--F:
                    ++F;
                    var f = c[F], g = E.scrollTop(), h = b ? g - f.offsetTop: f.offsetTop + f.offsetHeight - E.innerHeight() - g;
        ...
        function X(b) {
            if (E) {
                var c = b.target;
                if (c == d[0] || c == E[0] || a.contains(E[0], c))
                    return;
                if (p && p.length && c == p.parent()[0])
                    return 
            }
            Z()
        }
        ...
        var d = a(b), e = c.dataHandler || c.handlerUrl;
        if (!d.length || d[0].type !== "text" && d[0].type !== "textarea"&&!d.hasClass("contentEditable") ||!c ||!c.data&&!e)
            return null;
        var f = c.data, g = c.template || "<% locals.forEach(function(item) { %><li> <% = item.text  %> </li><% }) %>", h = c.minLength || 2, i = c.interval || 300, j = c.autocomplete === undefined?!0 : c.autocomplete, k = c.fitToElement, l = c.noListOnFocus, m = c.onSelectItem, n = c.onSelectionModified, o = c.positionEl || d, p = c.customListRoot, q = c.customClass, r = c.requestData || {}, s = c.onGetDataSuccessfully, t = c.onSelectionCleared, u = c.onLoading, v = c.onBeforeRendering, w = c.onBlur, x = c.onType, y = c.allowClickDefault, z = c.sessionRequired, A = c.disableHideListOnBlur, B, C, D = {}, E, F =- 1, G, H, I, J = "", K = c.noResultsMessage || "No results found.", L;
...
(function(a) {
    ...
    function o() {
        var b = window.location.search, c = 0;
    ...
    function r() {
        a("#siteTourTemplate a, #siteTourTemplate img").click(function() {
            var b = a(this).data("tour-page-url"), c = a(this).data("tour-type");
    ...
    function s() {}
    var b = [], c, d = a("body"), e = a(window), f, g, h = "", i = "#notificationbar", j = ["AT", "CH", "DE", "IE", "ES", "FI", "FR", "IT", "NO", "NL", "PT", "RU", "SE", "GB"], k;
    c = Myspace.siteTour = function() {
        function n(e) {
            p();
            if (e>-1) {
                l = e;
                var h = m.tourItems, i = m.tourLength, j = e + 1, k = h[e], n, q = k.tourItemId;
                if (q && q.length > 0) {
        ...
        function r(b, d) {
            var f = 0, h = 0, k, m, o, p, q, r, u, v = a(i), w = a(j), x = a.extend({}, b.content), y = x.scrollTo, z = b.bracket && a.extend({}, b.bracket), A = 0, B = 0;
            ...
            if (k && m) {
                ...
                b.bracket&&!b.bracket.css && (z = null);
            c.css({
                left: A,
                top: B
            });
        ...
        function s(c) {
            ...
            if (d && d == "left") {
                ...
                d && d == "down" && (window.scroll(0, c.move), b.height(a(window).scrollTop() + a(window).height() - 76))
        }
        function t() {
            a("button.x_14", a(i)).click(function(a) {
                ...
                var c = a(this), e = c.hasClass("tourhomeicon"), f = c.data("callback") || "", g = c.data("index");
                e ? (p(), q(), d.hasClass("queueOpen") && comm.send("drawer.forceOpen", !1), comm.send("track", new Tracking("TourPopupFooter", "Invoke", "Tour")), comm.send("tour.dialogbox")) : f.length > 0 ? (p(), comm.send("tour.button", {
                    element: f,
                    nextItemIndex: g
                })) : (q(), n(g))
            })
        }
        var b = a("<div class='tour_container'>"), c = a("<div id='tour_dialog'>"), f = a("<div class='tour_bracket'>"), g = a("<div class='tourArrow'>"), h = "div.tourArrow", i = "#tour_dialog", j = "div.tour_bracket", k = "div.tour_container", l = 0, m, u = function() {
            m && n(0)
        }, v = function(b) {
            m = a.extend({}, {}, b), u(0)
        };
        ...
        var b = context.toursetting && context.toursetting.tourSettingVersion, e;
...
(function(a) {
    Myspace.AutocompleteSearchV1 = function(b, c) {
        ...
        function u(b) {
            var c = b.which, g = 27, h = v();
            if ([13, 37, 38, 39, 40].indexOf(c)!==-1)
                return !1;
        ...
        var d, e=!1, f = new Myspace.ResetTimer(x, context.searchOverlay.delay), g = context.searchOverlay.minimumQueryLength, h = c.url || "/ajax/search/autocomplete/?q=", i = c.limit || 2, j = c.onHide, k = c.onClear || a.noop, l = c.onLoading || a.noop, m = c.onSuccess || a.noop, n = c.onError || a.noop, o = c.onReset || a.noop, p = c.page, q = "", r;
...
(function(a) {
    ...
    function A() {
        p = e.find(".shortResults"), n = p.first().children("li"), p.click(function(b) {
            var c = a(b.target), d = c.closest(".verticalContent"), e;
    ...
    function D(a) {
        var b = a.which, c, e, f;
        if (b === 40)
            a.preventDefault(), o ? (o.removeClass("selected"), c = o.next(), c.length > 0 ? o = c.addClass("selected") : o = n.eq(0).addClass("selected")) : (n = p.first().children("li"), o = n.eq(0).addClass("selected"), l = 0, d.blur());
        else if (b === 38) {
            if (!o)
                return;
            a.preventDefault(), o.removeClass("selected"), c = o.prev(), c.length > 0 ? o = c.addClass("selected") : (o = null, l = 0, d.focus())
        } else if (b === 37 && o)
            a.preventDefault(), e = n.index(o), m = l, l--, l < 0 && (l = p.length - 1), f = p.eq(l), f.length ? (n = f.children("li"), c = f.children("li").eq(e), o.removeClass("selected"), c.length || (c = f.children("li").last()), o = c.addClass("selected")) : l = m;
        else if (b === 39 && o)
            a.preventDefault(), e = n.index(o), m = l, l++, l > p.length - 1 && (l = 0), f = p.eq(l), f.length ? (n = f.children("li"), c = f.children("li").eq(e), o.removeClass("selected"), c.length || (c = f.children("li").last()), o = c.addClass("selected")) : l = m;
        else if (b === 13)
            return !o && a.target.id == "q"?!1 : (d.blur(), comm.send("location.href", o.find(".mainLink").attr("href")), !1)
    }
    var b, c = a("#searchDialog"), d = a("#q"), e = a("#searchResults"), f = a("#noResults"), g, h = {}, i, j, k = a(window), l = 0, m, n, o, p, q=!1;
...
(function(a) {
    function g(b) {
        var c = a("#wrap").find("> .horizontalContent > div"), d = c.scrollLeft();
    ...
    var b=!1, c = /chrome/.test(navigator.userAgent.toLowerCase()), d = a("body"), e = a("#photoCarouselLightbox"), f = a(window);
    d.bind("keydown", function(d) {
        var e = d.which;
        if (e === 27)
            a("#q").blur(), d.preventDefault();
        else {
            if ([17, 224, 91, 93].indexOf(e)>-1)
                return b=!0, !0;
            c && h(e) && (b=!1)
        }
    }), d.bind("keyup", function(a) {
        var c = a.target, d = a.which, h = c.tagName;
        b && [17, 224, 91, 93].indexOf(a.which)>-1 && (b=!1);
        if (d === 27)
            comm.send("dialog.isOpen", function(a) {
                comm.send("page.esc", {
                    isDialogOpen: a
                })
            });
        else if (h !== "INPUT" && h !== "TEXTAREA" && c.contentEditable !== "true"&&!b&&!a.ctrlKey&&!a.altKey&&!e.hasClass("open")) {
            if ([33, 37].indexOf(d)!=-1)
                return g( - f.width() * .7), !1;
            if ([34, 39].indexOf(d)!=-1)
                return g(f.width() * .7), !1
        }
    }), context.features.isSearchEnabled && d.bind("keypress", function(d) {
        var e = d.target, f = d.which, g = e.tagName;
...
(function(a) {
    Myspace.HtmlUploader = function(b, c, d) {
        ...
        function p(a) {
            ...
            var b = a.target.files || a.originalEvent.dataTransfer.files, c, f, h = i.length;
            if (!b || b.length === 0)
                return;
        ...
        function w() {
            ...
            var c = new FormData;
            for (var e in d.POST_PARAMS)
                c.append(e, d.POST_PARAMS[e]);
        ...
        var e = {
            ...
            upload_canceled: 0,
            queue_errors: 0
        }, f = new XMLHttpRequest, g = b, h = c, i = [], j = 0, k=!1, l=!1, m = Myspace.Upload, n = d.MEDIA_TYPE == m.MEDIA_TYPES.TEMP ? d.POST_PARAMS.type : d.MEDIA_TYPE;
...
(function(a) {
    Myspace.LiteUploader = function(b) {
        function f() {
            a.extend(!0, d, b);
            var f = a(d.html.filesInput), g = a(d.html.dragDropArea);
...
(function(a) {
    var b = {
        ...
        this.buffer = f;
        if (!(b.NodeBuffer && f instanceof Buffer)&&!(b.ArrayBuffer && f instanceof ArrayBuffer) && typeof f != "string")
        ...
        if (this._isDataView)
            ...
            for (var k in c) {
                if (!c.hasOwnProperty(k))
                    continue;
                    var l;
                    k === "Int8" || k === "Uint8" ? l = "read" + d[k] : i ? l = "read" + d[k] + "LE" : l = "read" + d[k] + "BE", function(a, b, d) {
                        var e = c[a];
                    ...
                    if (!c.hasOwnProperty(k))
                        ...
                        (function(b, d) {
                            ...
                            d["get" + b] = function(c, f) {
                                ...
                                if (d._isArrayBuffer && (d._start + c)%e === 0 && (e === 1 || f))
                                    return (new a[b + "Array"](d.buffer, d._start + c, 1))[0];
                                    if (typeof c != "number")
                                        throw new TypeError("jDataView byteOffset is not a number");
                                        if (c + e > d.byteLength)
    ...
    b.NodeBuffer ? e.createBuffer = function() {
        ...
        var a = new ArrayBuffer(arguments.length), b = new Int8Array(a);
        ...
        getString: function(a, b) {
            ...
            if (typeof b != "number")
                throw new TypeError("jDataView byteOffset is not a number");
            if (a < 0 || b + a > this.byteLength)
                throw new Error("jDataView length or (byteOffset+length) value is out of bounds");
            if (this._isNodeBuffer)
                c = this.buffer.toString("ascii", this._start + b, this._start + b + a);
            else {
                c = "";
                for (var d = 0; d < a; ++d) {
        ...
        _getFloat64: function(a, b) {
            var c = this._getUint8(this._endianness(a, 0, 8, b)), d = this._getUint8(this._endianness(a, 1, 8, b)), e = this._getUint8(this._endianness(a, 2, 8, b)), f = this._getUint8(this._endianness(a, 3, 8, b)), g = this._getUint8(this._endianness(a, 4, 8, b)), h = this._getUint8(this._endianness(a, 5, 8, b)), i = this._getUint8(this._endianness(a, 6, 8, b)), j = this._getUint8(this._endianness(a, 7, 8, b)), k = 1 - 2 * (c>>7), l = ((c<<1 & 255)<<3 | d>>4) - (Math.pow(2, 10) - 1), m = (d & 15) * Math.pow(2, 48) + e * Math.pow(2, 40) + f * Math.pow(2, 32) + g * Math.pow(2, 24) + h * Math.pow(2, 16) + i * Math.pow(2, 8) + j;
            return l === 1024 ? m !== 0 ? NaN : k * Infinity : l===-1023 ? k * m * Math.pow(2, - 1074) : k * (1 + m * Math.pow(2, - 52)) * Math.pow(2, l)
        },
        _getFloat32: function(a, b) {
            var c = this._getUint8(this._endianness(a, 0, 4, b)), d = this._getUint8(this._endianness(a, 1, 4, b)), e = this._getUint8(this._endianness(a, 2, 4, b)), f = this._getUint8(this._endianness(a, 3, 4, b)), g = 1 - 2 * (c>>7), h = (c<<1 & 255 | d>>7) - 127, i = (d & 127)<<16 | e<<8 | f;
        ...
        _getUint32: function(a, b) {
            var c = this._getUint8(this._endianness(a, 0, 4, b)), d = this._getUint8(this._endianness(a, 1, 4, b)), e = this._getUint8(this._endianness(a, 2, 4, b)), f = this._getUint8(this._endianness(a, 3, 4, b));
        ...
        _getUint16: function(a, b) {
            var c = this._getUint8(this._endianness(a, 0, 2, b)), d = this._getUint8(this._endianness(a, 1, 2, b));
            return (c<<8) + d
        },
        _getInt8: function(a) {
    ...
    if (typeof jQuery != "undefined" && jQuery.fn.jquery >= "1.6.2") {
        var f = function(a) {
            ...
            var e = IEBinaryToArray_ByteStr_Last(a), f = "", g = 0, h = b.length%8, i;
            while (g < h)
                i = b.charCodeAt(g++), f += String.fromCharCode(i & 255, i>>8);
            h = b.length;
            while (g < h)
                f += String.fromCharCode((i = b.charCodeAt(g++), i & 255), i>>8, (i = b.charCodeAt(g++), i & 255), i>>8, (i = b.charCodeAt(g++), i & 255), i>>8, (i = b.charCodeAt(g++), i & 255), i>>8, (i = b.charCodeAt(g++), i & 255), i>>8, (i = b.charCodeAt(g++), i & 255), i>>8, (i = b.charCodeAt(g++), i & 255), i>>8, (i = b.charCodeAt(g++), i & 255), i>>8);
...
var JpegAPPMarkers = function() {
    function c(a, b) {
        try {
            ...
            if (c.length != 3)
                return null;
            var f = d(c[0]), g = d(c[1]), h = d(c[2]), i = e(f + g / 60 + h / 3600) * b;
    ...
    function d(a) {
        var b = a.split("/");
        if (b.length == 2) {
            var c = parseFloat(b[0]), d = parseFloat(b[1]);
            return c / d
        }
    }
    function e(a) {
        var b = Math.pow(10, 6), c = Math.round(a * b) / b;
        return c
    }
    function f(a) {
        if (!a)
    ...
    function g(a, b) {
        if (b.type === 65505) {
            ...
            if (c.getString(4) === "Exif")
                return c
        }
        return 
    }
    function h(a, b, c, d, e) {
        var f = d.getUint16(c, e), g = [];
        for (var h = 0; h < f; h++) {
            var j = d.getUint16(c + 2, e), k = a[j];
            if (k) {
                var l = d.getUint16(c + 4, e), m = d.getUint32(c + 6, e), n = d.getUint32(c + 10, e);
                g[k] = i(d, l, m, c, n + b, e)
            }
            c += 12
        }
    ...
    function i(a, b, c, d, e, f) {
        ...
        case 5:
            ...
            if (c === 3) {
                var j = [];
                for (var k = 0; k < c; k++)
                    h = a.getUint32(e + k * 8, f), i = a.getUint32(e + 4 + k * 8, f), j.push(h + "/" + i);
                return j.join(" ")
            }
        }
    }
    function j(a, b, c) {
        ...
        var e = c - b, f = new Uint8Array(a), g = new ArrayBuffer(e), h = new Uint8Array(g);
        for (var i = 0; i < e; i++)
            h[i] = f[i + b];
        return h
    }
    ...
    function l(a) {
        ...
        var c = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, d = new c;
    ...
    function n(a, b, c) {
        ...
        c || (c = m(a));
        var f = m(b);
        if (!c.valid || c.appMarkers.length === 0 ||!f.valid)
            return l([b]);
        var g;
        ...
        for (var h = 0; h < c.appMarkers.length; h++)
            e = c.appMarkers[h], d.push(j(a, e.position, e.position + (e.size + 2)));
        for (var h = 0; h < f.markers.length; h++)
            e = f.markers[h], d.push(j(b, e.position, e.position + (e.size + 2)));
    ...
    function o(d, e) {
        ...
        e || (e = m(d));
        if (!e.valid || e.appMarkers.length === 0)
            return i;
        var j;
        ...
        if (!j)
            return i;
        var l = j.tell() + 2, n = j.getUint16(j.tell() + 2) === 18761;
        if (j.getUint16(j.tell(), n) != 42 || j.getUint32(j.tell(), n) != 8)
            return i;
        ...
        if (o) {
            ...
            if (o.GPSInfoIFDPointer) {
                var p = h(b, l, o.GPSInfoIFDPointer + 6, j, n), q = f(p.GPSLatitudeRef), r = f(p.GPSLongitudeRef);
                if (q !== null && r !== null) {
                    var s = c(p.GPSLatitude, q), t = c(p.GPSLongitude, r);
...
(function(a) {
    ...
    function d(a) {
        ...
        var c = a.split(",")[0].split(":")[1].split(";")[0], d = new ArrayBuffer(b.length), e = new Uint8Array(d);
        for (var f = 0; f < b.length; f++)
            e[f] = b.charCodeAt(f);
        return d
    }
    Myspace.Upload = {}, Myspace.Upload.ERROR_CODES = {
        ...
        var e = this.ERROR_CODES, f = "", g = "", h = "", i = [];
        if (a) {
            f = b(a);
        ...
        var b = this.MEDIA_TYPES, c = this.MAX_FILE_SIZES;
        switch (a) {
        case b.PHOTO:
            return c.PHOTO;
        case b.STREAM:
        ...
        var b = this.MEDIA_TYPES, c = this.FILE_TYPES;
        switch (a) {
        case b.PHOTO:
        case b.STREAM:
        case b.COVER:
        ...
        if (context.roles === undefined || context.roles.indexOf("Photographer")===-1) {
            var g = 2048, h = 2097152, i = window.FileReader ? new FileReader: null, j = b(e);
            !i || j !== ".jpg" && j !== ".jpeg" ? f(e) : (i.onload = function(a) {
                try {
                    var b = new Blob([a.target.result]), j = window.URL || window.webkitURL, k = new Image;
                    k.src = j.createObjectURL(b), k.onload = function() {
                        try {
                            if (e.size > h || k.width >= g || k.height >= g) {
                                var a = document.createElement("canvas").getContext("2d"), l = c(k, g, g);
                                a.canvas.height = l.height, a.canvas.width = l.width, a.drawImage(k, 0, 0, k.width, k.height, 0, 0, l.width, l.height);
                                var m = a.canvas.toDataURL("image/jpeg", .98), n = JpegAPPMarkers.copyMarkers(i.result, d(m));
        ...
        var f = new XMLHttpRequest, g = new FormData, h = this;
        for (var i in b)
            g.append(i, b[i]);
...
(function(a) {
    var b = function() {
        ...
        function u(i, l) {
            ...
            if (i.photoUrl) {
                var m = h.find(".cropContainer"), q = m.children("img"), r = o.GetMinimumDimensions(c), s = v(r);
        ...
        function v(a) {
            ...
            if (d) {
                ...
                if (!a || c === e)
                    b = [0, 0, d.width, d.height];
                else {
                    var f = Math.floor(d.width / e), g = d.height * e, h = Math.floor((d.width - g) / 2), i = Math.floor((d.height - f) / 2);
        ...
        var b = "", c = "", d = undefined, e = 1, f = null, g = null, h, i, j = {
            width: 0,
            height: 0,
            x: 0,
            y: 0
        }, k, l=!1, m = templates["common/views/generic/photos/_photoCropper"], n, o = Myspace.Upload;
        return comm.listen("dialog.hiding", function(a) {
...
(function(a) {
    a.Jcrop = function(b, c) {
        ...
        function o(a, b, c) {
            ...
            if (a === "move")
                return cb.activateHandlers(q(b), v, c);
        ...
        function q(a) {
            var b = a;
            return db.watchKeys(), function(a) {
...
(function(a) {
    Myspace.PhotoCarousel = function(b, c) {
        function A() {
            J();
            var b = a(".left_half .left_arrow"), c = a(".right_half .right_arrow");
            d.on("mousemove", function(a) {
                ...
                a.clientX < d.width() * .5 ? (C(), comm.send("track", new Tracking("photodetail", "Invoke", "MainLeftArrow"))) : (B(), comm.send("track", new Tracking("photodetail", "Invoke", "MainRightArrow")));
                if (!z.lightboxMode || x == 0)
                    return !1
            }), i.on("click", function(b) {
                var c = a(b.target), d = c.data("action");
        ...
        function E(b, c, g) {
            ...
            if (z.animation === "default") {
                ...
                var m = a('<img src="' + u.urls[0].url + '" />'), n = a('<div class="cell"></div>').append(m), o = a('<div class="tbl"></div>').append(n), p = a('<div class="container"></div>').css({
                    display: "none"
                }).append(o);
            ...
            Q() || (j.data("entityKey", u.entityKey).data("userEntityKey", u.relatedEntityKey), k.html('Photo from <a href="' + u.mixDetailUrl + '">' + u.mixTitle + "</a>"), l.html("(" + (u.albumIdIndex + 1) + " of " + u.albumIdTotalCount + ")")), !c&&!Q() && (L(u), M(u.photoDetailUrl), w.push(u.photoDetailUrl), x++, comm.send("location.href", {
                ...
                loadState: function(a, b, c) {
                    var e = w[x + 1], f = w[x - 1];
                    if (e === null || f === a)
                        x--, comm.send("backButton.pressed");
                    else if (f === null || e === a)
                        x++, comm.send("forwardButton.pressed");
        ...
        function N(a) {
            var b = a.target, c = a.which, d = b.tagName;
            if (d === "INPUT" || d === "TEXTAREA" || b.contentEditable === "true")
                return;
            ...
            if (!z.isSlideShow&&!Q()) {
                ...
                a.ajax({
                    ...
                    if (typeof a.ads.adCalls != "undefined")
                        for (var b = 0; b < a.ads.adCalls.length; b++)
                            comm.send("ads.loadAd", a.ads.adCalls[b])
                })
            }
            z.onScroll()
        }
        function S() {
            var a = z.items[z.currentIndex + 1] || z.items[0], b = z.items[z.currentIndex - 1] || z.items[z.items.length - 1];
            (new Image).src = a.urls[0].url, (new Image).src = b.urls[0].url
        }
        var d = a(b), e = d.find(".photoItems"), f = e.find(".cell"), g = d.children("i.prevItem"), h = d.children("i.nextItem"), i = d.find(".details"), j = i.find(".left > a"), k = i.find(".photoFrom"), l = i.find(".position"), m = d.find(".exit"), n = m.find(".tip"), o = a(window), p = a("#footer"), q = d.next(), r = d.parent(), s = null, t = a("#global", p).outerHeight(), u = null, v=!1, w = [], x =- 1, y = {
            speed: 0,
            onScroll: function(a) {},
            items: [],
            currentIndex: 0,
...
(function(a) {
    var b = function() {
        ...
        var b = a("#lightboxCover").children(), c = a("#photoCarouselLightbox"), d = c.find(".photoCarousel"), e = d.find(".slideShowLegend"), f = d.find(".exit"), g = a("#lightboxCover"), h = new Myspace.Dialog(c, {
            centerDialog: !1
        }), i = new Myspace.PhotoCarousel(d, {
            lightboxMode: !0
        }), j=!1, k=!1, l = 5e3, m = 0, n=!1, o = "";
        return comm.listen("dialog.hiding", function(a) {
            c[0] === a[0] && q()
...
(function(a) {
    a("body").delegate("i.gifPlayBtn", "click", function(b) {
        ...
        var c = a(this), d = c.data("loadingParent"), e = c.closest("li"), f = c.closest("a"), g = a(".mediaBackground", f), h = g.length ? g: f, i = h.css("background-image"), j = "photoObject loading", k = f && a("img", f);
        if (!k)
            return !1;
        e.hasClass("streamItem") ? (e = f, j = " loading") : d && (e = c.closest("." + d));
        var l = k.attr("src"), m = l.lastIndexOf("/"), n, o, p = l.substr(0, m), q = k.attr("data-actual-size");
        return q || (q = l.substr(m + 1), k.attr("data-actual-size", q)), n = p + "/full.gif", o = p + "/" + q, c.hasClass("playing") ? (k.attr("src", o), i.indexOf("url")>-1 && (h.css("background-image", "url(" + o + ")"), k.css("opacity", "0")), c.removeClass("playing"), c.hasClass(".bindPause") || (c.addClass(".bindPause"), comm.send("track", new Tracking("playButton", "pause", "gif")))) : (e.addClass(j), k.attr("src", n).load(function() {
            e.removeClass(j), c.hasClass(".bindPlay") || (c.addClass(".bindPlay"), comm.send("track", new Tracking("playButton", "play", "gif")))
...
(function(a) {
    var b = {
        ...
        connectThirdParty: function(b, c, d) {
            if (b == "myspaceoriginal")
                return Myspace.ThirdPartyHelper.connectClassicMyspace(c, d), !1;
            var e = this;
            e.callbackSent=!1, e.callback = d, e.provider = b, a.ajax({
                ...
                success: function(a) {
                    if (a.token) {
                        var c = "/thirdpartyauth/" + b + "/generic?mstoken=" + a.token, f = e.popupCenter(c, 800, 800, "Third Party Authentication");
                        if (!f) {
                            d(!1, {
                                canceled: !0,
                                additionalData: {
                        ...
                        var g = setInterval(function() {
                            if (!f || f.closed)
                                clearInterval(g), window.setTimeout(function() {
                                    e.callbackSent || (d(!1, {
                                        canceled: !0,
                                        additionalData: {
        ...
        connectThirdPartyPage: function(a, b, c) {
            var d = this, e = "/thirdpartyauth/connecttoken/" + a, f = d.popupCenter(e, 800, 800, "Third Party Authentication");
            ...
            var g = setInterval(function() {
                if (!f || f.closed)
                    clearInterval(g), d.callbackSent || (c(!1, {
                        canceled: !0,
                        additionalData: {}
                    }), d.callbackSent=!0)
            }, 1e3)
        ...
        init: function() {
            ...
            }), comm.listen("thirdParty.genericRejected", function(b) {
...
(function(a) {
    function k(b) {
        function K() {
            d.addClass("webcamSupported"), a(".photoUploadDropdown").on("click", "button", function() {
                ...
                }), comm.send("track", new Tracking("POST", "Invoke", "Webcam")))
            })
        }
        function M(b) {
        ...
        function Q() {
            function b(b, c) {
                var f = {
                    ...
                    index: c
                }, i = "superpost_selectedImage" + (h ? " dotted top" : ""), j = "<div class='" + i + "'>" + "<img src='" + config.urls.emptyVideoImage + "'/>" + "<progress value='0' max='" + f.fileSizeInBytes + "'>0</progress>" + "<div class='legend'><span class='completed'>0</span> of " + f.userFriendlyFileSize + "</div>" + "<i class='close x_14'></i>" + "</div>", k = function(a) {
                    y.SetPostParams({
            ...
            y = new Myspace.Uploader({
                ...
                if (d.data("video-upload-response")) {
                    var f = new Date, g = d.data("video-upload-response").file, h = {
                        origin: "quickPost",
                        description: b,
        ...
        function eb(b, c) {
            ...
            if (J) {
                var h = Myspace.Upload, i = new XMLHttpRequest, l = new FormData, m = t.find("img").prop("src"), n = ob(m);
                ...
                if (b || j || e)
                    b && b.charAt(0) === '"' && b.charAt(b.length - 1) === '"' && (b += " "), w.SetPostParams({
                        location: e,
                        target: f,
                        caption: b
                    });
        ...
        function gb(b, f, h) {
            var i=!0, l = d.hasClass("share"), m = {}, n, o;
            ...
            if (d.hasClass("link") && x) {
                var q = x.title, r, t, u = e.find("div.linkImage > img");
        ...
        function hb(a, b) {
            if (!a) {
                var c = q.val().trim(), d = q.getMentions();
        ...
        var c, d = a(b.container), e = a(d.find(".superpost_selectedLink")), f = a(d.find(".superpost_statusShare")), g = d.find("button.primary"), h = d.hasClass("inline"), i = d.hasClass("isMinimized"), j, k, l, m = context.features.isMentionProfileEnabled, n = context.features.isPostTaggingEnabled, o = context.features.isLinkScrapeEnabled, p, q, r = d.find(".error"), s, t, u, v, w, x, y, z, A, B=!0, C, D, E, F, G, H, I = null, J=!1;
        p = {
            maxLength: 1024,
            showCount: !0,
    ...
    comm.listen("superpost", function(l) {
        ...
        if (!context.features.isPostInEnable ||!context.features.isShareIsEnable)
            return c || (c = Myspace.Confirm({
        ...
        var n = a(l.element), o = a(l.container), p = context.features.isMentionProfileEnabled, q = context.features.isLinkScrapeEnabled, r;
        ...
        }, !0)), e = m.css("z-index")), j = m.hasClass("media"), m.removeClass("media"), l.photoUpload ? (b.$root.addClass("photo").find("button.primary").attr("disabled", ""), a("#superpostPhotoFile").click()) : b.$root.removeClass("photo"), b.show(!0), d.focus(), a("#lightboxCover").css("z-index", 5), comm.send("track", new Tracking("POST", "Invoke", l.type)), i = location.href.replace(location.origin, ""), comm.send("location.href", {
            url: "/post",
            loadState: function(a, b, c) {
                return !0
            }
...
(function(a) {
    Myspace.Flippers = function(b, c) {
        ...
        var d = a(b), e = c.leftFlipper ? a(c.leftFlipper): d.parent().find(".leftFlipper"), f = c.rightFlipper ? a(c.rightFlipper): d.parent().find(".rightFlipper"), g = c.scrollToNextLi == 1 ? d.children().first().outerWidth(!0): 20, h = c.scrollIntervalDelay || 40, i = null, j = null, k = null;
...
(function(a) {
    function b(b, e, f, g) {
        ...
        function x(a) {
            var b = a.getBoundingClientRect(), c = b.left, d = b.right, e = b.top, f = b.bottom;
        ...
        var h = e.type === "horizontal" ? new d(b, e): new c(b), i = a(window), j = h.getScrollArea(), k = a(b), l = k.is(e.content) ? k: k.find(e.content).eq(0), m = 100, n=!0, w = 300, y = [], z = [], B, F = null;
        return D(), {
            start: J,
            stop: K,
            reset: L,
    ...
    var c = function(b) {
        var c = b === "body" ? a(window): a(b), d = c.scrollTop();
        ...
        var d = a(b), e = c.isMobile ? d: d.children("div"), f = e[0], g = f.scrollLeft;
        this.getScrollArea = function() {
            return e
        }, this.isAtEnd = function(a) {
            return f.scrollWidth === 0?!1 : f.scrollWidth - f.offsetWidth <= f.scrollLeft + a
        }, this.isAtStart = function(a) {
            return f.scrollLeft <= a
        }, this.getScrollDirection = function() {
            var a = f.scrollLeft, b;
...
(function(a) {
    ...
    Myspace = Myspace || {}, Myspace.ThreeDotsMenu = function(c) {
        function k() {
            if (!d) {
                var f = 0, j = c.choices.length, k = a("<ul></ul>");
                for (; f < j; f++) {
        ...
        var d, e = a("body"), f, g = c.customClass || "", h = c.direction || "bottom", i = c.$target, j = c.filter || a.noop;
        return k(), {
            show: l,
            hide: m,
            replaceChoice: n
...
(function(a) {
    ...
    function d() {
        ...
        function f(b) {
            if (!b.conversationId)
                return e(b.participants, b.bodyText);
            var d = Myspace.Utils.guid(), f = {
        ...
        comm.listen("messages.markAsRead", function(a) {
            ...
            var b = a.author.profileImageUri || a.author.profile140x140ImageUri || window.context.emptyProfileImage, c = {
    ...
    function e() {
        ...
        function d(b) {
            ...
            var d = Myspace.Utils.guid(), e = a.trim(b.bodyText), f = {
            ...
            c(f);
            if (Myspace.MessagingManager.getSettings().IsIMEnabled)
                return g(), d;
            Myspace.Confirm({
...
(function(a) {
    ...
    Myspace = Myspace || {}, Myspace.MessageTimestamp = {
        get: function(a) {
            var c = new Date(a), d = b[c.getMonth()], e = c.getDate(), f = c.getHours(), g = c.getMinutes(), h = f >= 12, i = h ? "pm": "am";
            return f = h ? f - 12 : f, f === 0 && (f = 12), g = g < 10 ? "0" + g : g, d + " " + e + ", " + f + ":" + g + i
        },
        set: function(b) {
            b.find("time").each(function() {
                var b = a(this), c = Myspace.MessageTimestamp.get(b.attr("data-datetime"));
                b.text(c)
            })
        }
        ...
        function p() {
            j.click(function(b) {
                b.preventDefault(), b.stopPropagation();
                var c, d = a(b.target), e = d.closest("li"), f = e.children("a"), g = e.attr("data-folder");
        ...
        function s() {
            var b = k.find("li[data-conversation-id]").last().data("conversationId"), c = k.attr("data-folder");
            y({
                url: l,
                folder: c,
                start: b,
                ...
                if (b.threadsSuccess && b.folder === c && b.threadsMarkup !== "") {
                    var d = a(b.threadsMarkup), e = d.siblings("[data-conversation-id=" + window.context.privateMessagingConversationId + "]");
            ...
            if (c) {
                ...
                if (c.threadsSuccess) {
                    ...
                    if (c.threadsMarkup !== "") {
                        ...
                        k.parent().addClass("noConversations"), i=!0;
                    g && g.stop(), q()
                }
            }
        }
        ...
        function y(b, c, d, e) {
            var f = b.url, g = b.folder, h = b.start, i = b.includeConversation;
            a.ajax({
                url: f + (g ? "/" + g : ""),
                type: "POST",
                data: {
        ...
        function A(a, b) {
            var c = j.find('[data-folder="' + a.folderCode + '"] span'), d = parseInt(c.attr("data-value"), 10);
        ...
        function B(b) {
            if (k.attr("data-folder") == b.folderCode.toLowerCase()) {
                ...
                if (c.length&&!b.to)
                    c.find(".nameplate > p").text(b.lastMessage), c.find(".nameplate > time").attr("data-datetime", b.lastUpdated), !c.hasClass("selected")&&!b.read && c.addClass("unread"), Myspace.MessageTimestamp.set(c), k.prepend(c), comm.send("page.changed", c);
                else {
                    var e = a(f.render(d, {
                        thread: b
                    }));
        ...
        var d = templates["common/views/footer/messages/_thread"], e = ["connectionsUnseenConversationsQuantity", "otherUnseenConversationsQuantity", "archiveUnseenConversationsQuantity"], f = require("ejs"), g, h=!1, i=!1, j = b.find(".folders"), k = b.find(".threads > ul"), l = "/ajax/messages/folders", c = c || {}, m=!!c.includeConversationOnLoad, n = c.onHeaderClick || a.noop, o = c.onFolderSuccess || a.noop;
    ...
    Myspace = Myspace || {}, Myspace.MessageThreads = function(b, c) {
        function j() {
            ...
            f && (b = [{
                ...
                filter: function(a, b) {
                    var c = d.attr("data-folder"), e = b.closest("li").hasClass("unread") ? "unread": "read";
                ...
                e || (e = new Myspace.ThreeDotsMenu(c)), e.show(f, function(a) {
                    var b = f.closest("li"), c = a.split(".")[2];
                    comm.send(a, {
            ...
            }), Myspace.MessageTimestamp.set(d)), d.on("touchstart click", "> li", function(b) {
                var c = a(this), d = a(b.target);
        ...
        var d = b, e, f=!!c.hasMenu, g=!!c.selectable, h = "Open full page", i = c.onThreadClick || a.noop;
        return j(), comm.listen("messages.markAsUnread,messages.showAsUnread", function(a) {
            ...
            var b = d.find("li[data-conversation-id=" + a.conversationId + "]"), c = d.attr("data-folder");
...
(function(a) {
    ...
    function k() {
        if (!j)
            return j=!0, d.empty(), c.addClass("loading white"), h=!0, l().done(function(a) {
    ...
    var b = a("#notificationsPopout"), c = b.children("section"), d = b.find(".notifications"), e = a("#showNotificationsNavLink"), f = e.find(".count"), g = new Myspace.FooterPopout(b, {
        onClose: i
    }), h=!0;
    Myspace.Notifications.wireList(d, !0), e.click(function(b) {
        var c = a('.tip[data-name="notifications"]'), d = g.toggle();
...
(function(a) {
    function b() {
        ...
        var b = a("#messagePopout"), d = b.find("form"), e = d.find(".messageMedia"), f = d.find(".message"), g = d.find("button[type=submit]"), h = d.find("input[name=search]"), i = d.find("textarea[name=message]"), j = d.find("input[name=media]"), k = d.find("input[name=recipient]"), l;
        return d.submit(function() {
            o();
            var a = k.val(), b = j.val(), c = i.val(), d = e.html(), f = {
                toEntity: a,
                messageText: c,
                mediaEntityKey: b,
                mediaHtml: d
    ...
    var c = '<% locals.forEach(function(user) { %><li data-name="<%= user.name %>" data-entity-key="<%- user.entityKey %>"><%= user.name %></li><% }); %>', d;
...
(function(a) {
    function d() {
        ...
        var d = a("#conversationsPopout"), e = d.find(".folders"), f = d.find(".threads > ul"), g = new Myspace.MessageFolders(d), h = new Myspace.MessageThreads(f, {
            onThreadClick: l
        }), i = new Myspace.FooterPopout(d), j=!1, k=!1;
        c.find(".list.options > li").on("click", function(b) {
            ...
            var f = a('.tip[data-name="messaging"]'), g = i.toggle();
    ...
    function f() {
        function e(b) {
            var c = Myspace.MessagingManager.getSettings(), e=!c[b], f = c.objectVersion, g = d[b];
        ...
        var b = a("#isIMEnabled"), c = a("#isIMSoundEnabled"), d = {
            IsIMEnabled: b,
            IsIMSoundEnabled: c
        };
        comm.listen("messaging.togglesetting", function(a) {
            ...
            if (a === "messaging.setting") {
                var c = b.name, e = b.setting, f = d[c];
    ...
    function g() {
        ...
        context.features.isOfflineMessagingEnabled ? d() : e(), f(), comm.listen("drawer.panel", function(a) {
            ...
            var c = b.connectionsUnseenConversationsQuantity || 0, d = b.otherUnseenConversationsQuantity || 0;
            a(c + d)
        }), a(window.context.messaging.unseenConversationsTotal)
    }
    var b = a("#messagingLink"), c = a("#messaging");
    g()
})(jQuery);
(function(a) {
    function l() {
        ...
        function m() {
            i = new Myspace.AutoComplete(g, {
                ...
                onSelectItem: function(b) {
                    var c = a(b), d = objectify(c);
                    if (c.hasClass("ignore"))
                        return;
    ...
    function m(e, i) {
        function C(c) {
            ...
            return g.find("input[name=message]").keypress(function(a) {
                ...
                b.preventDefault(), b.stopPropagation();
                var d = a(this).find("input[name=message]"), e = a.trim(d.val());
                if (!e)
                    return;
                f()
        ...
        function J() {
            if (!context.features.isOfflineMessagingEnabled)
                return;
            if (I)
                return;
            var a = 20;
        ...
        function N(c) {
            ...
            if (M[c.itemId])
                return;
            var d = c.author.profileEntityKeyText, e = d === "profile_" + context.profileId, f = new Date(c.createdDateTimeOffset), h = a.extend({
        ...
        function O(c) {
            ...
            if (M[c.messageId] || M[c.itemId])
                return;
            c.messageId && (M[c.messageId]=!0), M[c.itemId]=!0;
            var e = d, f = e === "profile_" + context.profileId, h = L(), j = h && w, o = new Date, q = a.extend({
        ...
        var j = i.conversation || {}, k = null, l = null, m = j.conversationId || null, n = null, o, p, q, r, u, v, w=!1, x = "online", y=!1, z, A = 0, B, I=!1, M = {}, U = new Myspace.ResetTimer(X, 15e3), V=!1;
    ...
    function p(c, d) {
        ...
        var e = a(b.render(j, d)), f=!1, g = null, h = null;
        e.click(function() {
            var a = e.parent("ul");
    ...
    function q(c, d) {
        ...
        var e = new m(c, d), f = new p(c, d), g = d.conversation || {}, h = g.unseenItemsQuantity || 0, j = 0, k=!1, l=!1, n=!1, o = this;
    ...
    function r() {
        ...
        function j() {
            comm.listen("chat.open", function(a) {
                var b = a.entityKey, c = a.userData;
                f(b, function(b) {
        ...
        function k() {
            ...
            if (context.features.isOfflineMessagingEnabled)
                comm.listen("messages.new", b, !0), comm.listen("messages.sent", a, !0), scomm.add(function(b, c) {
                    if (b !== "messages.sent")
                        return;
                        a(c)
        ...
        var r = document.getElementById("newIMAudio"), s = document.getElementById("newIMConversationAudio");
    ...
    var b = require("ejs"), c = a("#messageBar"), d = {
        ESC: 27,
        ENTER: 13
    }, e = '<div class="chat popout new"><header><a>New Message</a><div class="actionBar"><i class="close close_chat_14"></i></div></header><section><div class="messages"><form class="dotted bottom"><i class="addParticipant search_14"></i><input type="text" name="nameSearch" placeholder="Type a name" /></form><div class="peopleList"><ul></ul></div></div><form><input disabled type="text" autocomplete="off" name="message"/></form></section></div>', f = '<div class="chat popout" data-dest="sendinstantmessage" data-entity-key="<%- locals.entityKey %>" data-username="<%- locals.username %>"><header><a href="/<%- locals.username.toLowerCase() %>"><%= locals.name %></a><div class="actionBar"><i class="options_22 options"></i><i class="close close_chat_14"></i></div></header><section><div class="messages"></div>' + (context.features.isOfflineMessagingEnabled ? "" : '<p class="offlineMessage"><%= locals.name %> is offline and can\'t receive messages.</p>') + '<div class="newMessageIndicator hide">new message</div>' + "<form>" + '<input type="text" autocomplete="off" placeholder="" name="message" maxlength="' + context.messageMaxLength + '"/>' + "</form>" + "</section>" + "</div>", g = templates["common/views/footer/messages/_message"], h = templates["common/views/footer/messages/_typing"], i = '<li class="instantMessage" data-influencer="<%- locals.profileId %>"><div class="slat small"><img src="<%= locals.imgUrl %>"/><div><h5><a href="/<%- locals.username.toLowerCase() %>"><%= locals.name %><a/></h5><p><%= (locals.bodyText || "") %></p><% if(locals.mediaHtml) { %><div><%- locals.mediaHtml %></div><% } %></div></div></li>', j = '<li data-profile-id="<%- locals.profileId %>" data-entity-key="<%- locals.entityKey %>" data-img-url="<%- locals.imgUrl %>" data-username="<%= locals.username %>" data-name="<%= locals.name %>"><img src="<%- locals.imgUrl %>" /><div class="info"><h6><a title="<%= locals.name %>" href="/<%- locals.username.toLowerCase() %>"><%= locals.name %></a></h6></div><div class="controls"><span class="count empty">0</span></div></li>', k = templates["common/views/generic/superpost/_mention"], n = a("#messaging"), o = {
...
(function() {
    ...
    var a = $("body"), b = $("#footer"), c = $("#player"), d = $("#drawer"), e = d.children("header"), f = $("#switcher"), g = $("#message"), h = $("#queue"), i = $("#mixes"), j = $("#popover"), k = $("#isIMEnabled"), l = $("#isIMSoundEnabled"), m = new CookieHelper("player"), n=!$("#incognito").hasClass("on"), o = new Myspace.Popover($("#incognitoTooltip"), {
        preRender: function(a, b, c) {
            a.height(n ? 125 : 78), c()
        }
    });
    n || $("#playerFacebookPrivacy").parent().hide(), $("#playerFacebookPrivacy").click(function() {
        ...
        var c = $(b.target), e = c.closest("[data-action]").data("action");
        switch (e) {
        case"incognito":
            $("#myspaceTip").hide();
            var f = c.hasClass("on");
    ...
    var r = d.find(".leftFlipper"), s = d.find(".rightFlipper"), t = new Myspace.Flippers(h.find(".horizontal"), {
        leftFlipper: r,
        rightFlipper: s
    });
    r.bind({
    ...
    var v = ["queue", "mixes", "messaging", "radio"], w, x = comm.own("drawer", {
        toggle: F,
        togglePanel: function(b) {
            var c = d.attr("data-panel"), e = a.hasClass("queueOpen");
            F(!e || c !== b), E(b)
        },
        open: function(a) {
            a && E(a), F(!0)
    ...
    a.on("click", function(a) {
        var b = $(a.target);
        !b.closest("#global, #drawer, #videoPlayer, .tour_footer, #messageBar").length&&!d.hasClass("pinned") && F(!1)
    });
    var z, A, B=!1, C = a.hasClass("queueOpen");
...
(function(a) {
    ...
    !Cookies.eucookie && d.indexOf(context.ipDerivedIsoCountryCode) > 0 && (comm.send("showSiteAlert", {
        text: 'Myspace uses cookies to ensure we give you the best experience on Myspace. If you continue to use Myspace without changing your settings, we’ll assume you are happy to receive all cookies from Myspace. For more information about the cookies Myspace uses <a href="/pages/cookiepolicy">click here</a>',
        action: "cookieNotice",
        label: "eucookie",
        "class": "eucookie"
...
(function(a) {
    ...
    Myspace.verifyEmail = function() {
        ...
        function e() {
            c && (a("#verifyEmail").remove(), a(c).appendTo("body"), a("body").addClass("scrollLocked"))
        }
        var c;
        return {
...
(function(a, b) {
    ...
    e.prototype.setOptions = function(b) {
        ...
        var b = this.$container.find(".railHeader").height() + a("#global").height() + 70, c = a(window).height() - b;
        ...
        var a = this.getEntity(), b = a.activityHtml, c = this.$container, d = c.find(".railHeader"), e = "", f = a.type.toLowerCase(), g = this;
        ...
        var d = this.$container.find("section." + a), e = d.find(".commentsControl"), f = this;
        if (e.length) {
        ...
        var b = this.getEntity(), c = "info", d = this, f = b.type ? b.type: b.entityKey.split("_")[0];
        switch (f) {
        case"song":
            this.renderSection({
                section: c,
        ...
        var b = this.getEntity(), c = "comments", d = this;
        this.renderSection({
            section: c,
            commentEntityKey: b.commentEntitykey,
            entityKey: b.entityKey,
        ...
        var b = this.getEntity(), c = this, d = function() {
            var a = c.$container.find("section.connections"), d = a.find(".grid"), e = c.$rail.height() - a.find("h3").outerHeight(!0) - d.outerHeight(), f = d.find("li").outerHeight(!0);
            if (f < e && f > 0) {
                var g = parseInt(e / f, 10), h = a.find(".pager").data("next-start");
        ...
        var e = b.paging ||!1, f = this.$container.find("section." + b.section), g = this;
        ...
        h.done(function(d) {
            if (e)
                f.find("h3, .loading").remove(), f.prepend(d.markup), f.find(".content").first().hide().slideDown();
            else {
                f.html(d.markup);
                var h = g.getEntity();
            ...
            if (b.entityType === "mixtape") {
                var j = a("#mixMetaData", g.$container), k = g.$container.find("div.mixtape > div:last-child");
        ...
        this.$nav.on("click", "a", function(c) {
            ...
            var d = a(c.target).closest(".pager"), e = d.data("next-start"), f = 50, g = b.getEntity();
            e>-1 && b.renderSection({
                section: "connections",
...
(function(a) {
    function b(a) {
        ...
        var b = a.find(".likes"), c = b.find("> div"), d = a.data("likesEntityKey"), f = "/ajax/rightRail/likes";
        return {
            show: g,
            hide: h,
            fetch: i
    ...
    function c(a) {
        ...
        var b = a.find(".connects"), c = b.find("> div"), d = a.data("connectsEntityKey"), f = "/ajax/rightRail/connects", g = 0;
        return {
            show: h,
            hide: i,
            fetch: j
    ...
    function d(b, c) {
        ...
        function q() {
            if (!g ||!g.length)
                g = b.closest(".photoRailContainer,.videoRailContainer,.liveStreamRail").first();
            if (o(g)) {
        ...
        function r(a, c) {
            if (a === b.attr("data-comments-entity-key")) {
                var d = b.find('a[data-view="comments"] > span'), e = parseInt(d.text(), 10) || 0;
        ...
        var d, e = b.children(".comments"), f = b.data("commentsEntityKey"), g, h = c.isStream, i;
    ...
    Myspace.RR = function(e, f) {
        function m(a, b) {
            if (j.active !== a) {
                var c = j[a];
                j[j.active].hide(), j.active = a, c ? (c.show(), b && b()) : (n(), c = j[a], c.fetch(function() {
                    c.wire && c.wire(), b && b()
                }), c.show())
            }
        }
        ...
        var g = a(e), h = g.find("> header"), f = f || {}, i = f.isStream ||!1, j = {}, k, l=!1;
        g.scroll(function(b) {
            if (a("a[data-view=connects]").attr("class") === "active") {
                var c = g.scrollTop(), d = g[0].scrollHeight - g.height();
                c / d > .7 && l===!1 && (l=!0, view = j[j.active], view.fetch(function() {
                    l=!1
                }))
            }
        }), a.each(g.children("section"), function(b, c) {
            var d = a(c), e = d.attr("class"), f = e.match(/(likes|connects|comments)/)[0];
...
(function() {
    var a;
    comm.listen("clipboard.ready", function(b) {
        b == "clipboard" && (a = $("#" + b))
    }, !0), comm.listen("clipboard.set", function(b) {
        if (!a)
            return;
        var c = b.$target.get(0).getBoundingClientRect();
        a.css(c).get(0).setText(b.text)
    }, !0), comm.listen("clipboard.hide", function() {
        a.css({
            top: - 1e3,
            left: - 1e3
        })
...
comm.listen("report>song", function(a) {
    var b = objectify($('.playBtn[data-uid="' + a.uid + '"]')), c = [];
    for (var d in b)
        c.push(d + ":" + b[d]);
...
(function(a) {
    function c(c) {
        var d = c.id, e = document.getElementById(d), f, g, h, i;
        if (!c.locationId) {
        ...
        if (c.format != "img" && c.format != "js"&&!e)
            return;
        f = b[d], f && (g = c.refreshDelay ? c.refreshDelay * 1e3 : 2e3, !( + (new Date) - f < g)), h = document.location.protocol + "//" + c.subdomain + ".vindicosuite.com/", h += c.subdomain == "x2" ? "imp/" : "", h += "?l=" + c.locationId + "&sz=" + c.size;
        var k = c.querystring || context.ads.querystring;
        k && (h += "&" + k), h += "&rnd=" + Math.floor(Math.random() * 1e8);
        if (c.format == "img")(new Image).src = h + "&t=i";
        else if (c.format == "js") {
            var l = encodeURIComponent(document.location), m = encodeURIComponent(document.referrer), n = document.createElement("script");
    ...
    function j() {
        if (!context.ads)
            return;
        var b = context.ads.adCalls || [], e = context.ads.pixels || [];
...
spaceway.logger = function() {
    ...
    function g() {
        if (queryString.dockedLogger)
            f('.logger { z-index: 1000000000; overflow:scroll; color:#fff; white-space:nowrap; position:fixed; top:0; left:0; background-color:#000; width:30%; height:100%; font-size:14px; font-family:"Courier New"; } .logger a:link { color:inherit; text-decoration:none; } .logger .success { color:lime; } .logger .info { color:cyan; } .logger .warn { color:magenta; } .logger .error { color:red; }').className = "spaceway", b = document.createElement("div"), document.body.appendChild(b);
            ...
            spaceway.logger.log = function(a, b) {
                console.log(a)
            };
...
spaceway.enabled=!0, comm.listen("location.href", function(a) {
    var b = spaceway.sendRequest, c = spaceway.pushState;
    ...
    function _(d) {
        s = d, lb(), I.add(function(a) {
            ...
            if (s.templates)
                for (var i in s.templates)
                    templates[i] = s.templates[i];
    ...
    function bb() {
        qb("cleaning up"), P.broadcast("page.beforeCleanup"), comm._clearListeners(), ab(window, 1), ab(document), a.isReady=!1, J || (a(e).empty(), a("#header, #sidebar").remove()), g.add(c).add(d).attr("style", ""), a("> :not(div#player):not(object):not(div#container):not(div#dialogCover):not(#lightboxCover):not(.dialog):not(.lightbox):not(footer):not(script):not(iframe):not(article#loginDialog):not(article#signupDialog):not(div.logger):not(#LocalConnection):not(#popover):not(#myspaceTip):not(#fb-root):not(#webcam)", document.body).remove(), Array.forEach(j, V), Array.forEach(k, V), j.length = k.length = 0, a('link[type="text/css"], style:not(.spaceway)').each(function(a, b) {
            ...
            if (l.indexOf(b) >= 0)
                return;
            if (!c ||!n[(b.href.indexOf("://")>-1 ? "" : t) + b.href])
                ob("removing " + (c ? "linked style" : "style node") + " that was not tracked" + (c ? ": " + b.href : "")), V(b);
            B&&!c && console.log(b)
        });
        if (!spaceway.washer)
            return;
        ...
        if (J && c.sheet.deleteRule) {
            ...
            for (var e = 0; e < d.length; e++)
                try {
                    if (d[e].media) {
                        var f = "@media ", g = "";
                        if (d[e].media.mediaText)
                            f += d[e].media.mediaText;
                        else 
                            for (var h = 0; h < d[e].media.length; h++)
                                f += d[e].media[h] + " ";
                                var i = "." + x;
                                for (var j = 0; j < d[e].cssRules.length; j++) {
                                    var k = d[e].cssRules[j], m = i + " " + k.selectorText.replace(/,/igm, ", " + i).replace(new RegExp(i + " html", "g"), i);
                            ...
                            if (!d[e].style)
                                continue;
                                var n = d[e].selectorText, o = d[e].style.cssText;
                                if (!n ||!o)
                                    continue;
    ...
    function hb() {
        Array.forEach(s.styles, function(a) {
            if (a.href) {
                var b = a.href.indexOf("://")>-1, c = a.href.indexOf("://") + 3, d;
                if (n[(b ? "" : t) + a.href])
                    return;
    ...
    function jb() {
        Array.forEach(s.scripts, function(a) {
            var b;
            if (a.src) {
                var c = a.src.indexOf("://")>-1, d = a.src.indexOf("://") + 3, e;
                if (m[(c ? "" : t) + a.src])
                    return;
    ...
    function kb(a) {
        if (!a._events ||!a._events.load)
            return;
        for (var b = 0; b < a._events.load.length; b++)
            a._events.load[b].handler(new Sys.UI.DomEvent({}))
    }
    function lb() {
    ...
    if (!spaceway ||!spaceway.enabled || sessionStorage && sessionStorage.spaceway === "off" ||!window.history.pushState)
        return;
    var c = a("#wrap")[0], d = c, e = c, f = a(b), g = a(document.body), h, i = new spaceway.logger, j = [], k = [], l = [], m = {}, n = {}, o = [], p = [], q = a("head")[0], r = a("title"), s, t = window.location.origin, u = window.location.href.replace(t, ""), v, w, x, y, z = {}, A = typeof XDomainRequest != "undefined" || typeof XMLHttpRequest != "undefined", B = queryString["debugger"], C=!queryString.js, D, E, F, G, H = 0, I, J=!0, K = ["www.myspace.com", ".myspacecdn.com", window.location.host], L = window.sessionStorage, M = 0, N = 0, O = spaceway.timeout || 5e4, P = comm.own("spaceway", {}), Q = /^([\w:\/.]+(myspace|las1-app001.poc.myspacecdn)\.(com|dev)(?::?\d*))(\/?[^#]*)#?(.*)/i, R = /\/(ad_wrapper|msglobal|wim)/i, S = a("#nav").append('<span class="spacewayLoader">Loading</span>'), T = {
        send: function() {
            return;
            var a, b
        }
        ...
        start: function() {
            if (!spaceway.primer)
                return;
            U.running=!0;
            for (var a = 0; a < spaceway.prime.length; a++)
                U.add(spaceway.prime[a], - 1, !0);
            window.setTimeout(function() {
                if (!U.running)
                    return;
    ...
    a(window).bind("hashchange", function() {
        var a = window.location.hash, b = a.substr(2);
        if (a.substr(0, 3) !== "#!/" || b === v) {
...
(function(a) {
    comm.listen("text.limit", function(b) {
        var c = b.container, d = b.parent, e = b.lineHeight || 20, f = b.showLessLines || 1, g = b.enableScroll, h = b.clickCallBack, i = b.noBind, j = b.expandAtStart, k = e * f;
        c.find(".postText").each(function() {
            var b, c, f, l = a(this), m, n = d || l.parent(), o;
            n.removeClass("expanded showMore keep enablescroll"), b = this.scrollHeight, c = this.offsetHeight, f = b - c, o = g && b >= n[0].offsetHeight * .6, f > e ? (m = l.next(), n.addClass("showMore"), i || (f > k ? m.children("a").click(function() {
                var b = a(this), c = d || b.parent().parent();
...
Myspace.MixCoverUploader = function(a) {
    ...
    function k(a, b) {
        if (!window.FileReader)
            c.autoUpload ? (c.showLoading(), l()) : c.fileAttached(a, b);
        else {
...
(function() {
    function d(a) {
        var b = {}, c = "type,title,url,artistName,imageUrl,embedUrl".split(",");
    ...
    function i(a) {
        if (a.keyCode == 46 || a.keyCode == 8 || a.keyCode == 9 || a.keyCode == 27 || a.keyCode == 13 || a.keyCode == 65 && a.ctrlKey===!0 || a.keyCode >= 35 && a.keyCode <= 39)
            return;
        (a.shiftKey || (a.keyCode < 48 || a.keyCode > 57) && (a.keyCode < 96 || a.keyCode > 105)) && a.preventDefault()
    }
    var a = location.protocol + "//" + location.hostname, b = '<iframe width="{width}" height="{height}" src="{embedUrl}" frameborder="0" allowtransparency="true" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><p><a href="{url}">{title}</a> from <a href="{artistUrl}">{artistName}</a> on <a href="{host}">Myspace</a>.</p>', c = '<script src="{miniplayerUrl}"></script>';
    Myspace.LinkEmbedDialog = function(a) {
        ...
        function z(a) {
            t = $(a.currentTarget), comm.send("clipboard.set", {
                $target: t,
                text: t.find("input").val()
            }), comm.listen("clipboard.complete", A, !0), comm.listen("clipboard.mouseOut", C, !0)
        }
        function A() {
            B(t), t.addClass("copied").tip("show")
        }
        function B(a) {
            l.not(a).removeClass("copied").tip("hide")
        }
        function C() {
            comm.send("clipboard.hide"), comm.stopListening("clipboard.complete", A), comm.stopListening("clipboard.mouseOut", C)
        }
        function D(a) {
            k.css("z-index", a)
        }
        var b = d(a), c = require("ejs").render(templates["common/views/_linkEmbedDialog"], {
            options: b
        ...
        }), k = $("#dialogCover"), l = j.$root.find(".field"), m = j.$root.find(".link .field input"), n = j.$root.find(".embed .field input"), o = j.$root.find(".miniplayer .field input"), p = j.$root.find(".size label"), q = j.$root.find(".size input"), r = j.$root.find(".resizer .width input"), s = j.$root.find(".resizer .height input"), t;
        return D(5), h(b, w), j.$root.on("click", B), j.$root.find("input").blur(), l.on("mouseenter", z).tip({
            title: "Copied",
            trigger: "manual",
            placement: "top"
        }), p.each(function(a, b) {
            var c = $(b), d = c.siblings("input");
            c.tip({
            ...
            var b = u(r.val(), 480, 960), c = Math.round(b * 9 / 16);
            v(b, c)
        }), s.on("keydown", i).on("change", function(a) {
            var b = u(s.val(), 270, 540), c = Math.round(b * 16 / 9);
            v(c, b)
...
(function(a) {
    ...
    if (Myspace.User.isLoggedIn) {
        var b = Myspace.User.authContext, c = b.action, d = b.object;
        if (c && d)
            switch (c.toLowerCase()) {
            case"connect":
...
Myspace.StandalonePlayer = function(a, b, c) {
    function n(a, b) {
        var c = {
            mediaType: "video",
            isLiveStream: !0,
            liveControlsEnabled: a.liveControlsEnabled,
            replayControlsEnabled: a.replayControlsEnabled,
            startDate: a.startDate,
            endDate: a.endDate,
            streamHttpBase: a.publishingEntryPointStreamHttpBase || a.publishingEntryPoint.streamHttpBase,
            streamTitle: a.publishingEntryPointStreamTitle || a.publishingEntryPoint.streamTitle,
            isCurrentlyAiring: a.isCurrentlyAiring,
            isEnded: a.isEnded
        };
        if (a.publishingEntryPoint.streams) {
            var d = b ? b: a.publishingEntryPoint.initialViewPointName;
            $.extend(c, a.publishingEntryPoint.streams[d])
        } else {
            var d = b ? b.toLowerCase(): a.publishingEntryPointInitialViewPointName.toLowerCase();
            for (var e = 1; e < 10; e++) {
                var f = a[d + "Stream_" + e];
                if (!f)
                    break;
    ...
    function o(a) {
        ...
        var b = "beacon.v3", g = {
            ...
            albumId: c.albumId,
            artistId: c.artistId,
            catalogReportedMediaTotalLengthSeconds: isNaN(c.duration)?-1: c.duration,
            currentPlayheadPositionSeconds: d,
            deltaPlayElapsedSeconds: e - f,
            directObjectEntityKeyText: c.entityKey,
            drawerPinnedIndicator: k("pinned"),
            drawerVisibleIndicator: l.hasClass("queueOpen"),
            incognitoIndicator: !0,
            influencerId: undefined,
            firstAutoPlayIndicator: !1,
            majorModeText: c.isLiveStream ? "liveStream": "queue",
            mediaId: c.mediaId,
            mediaReleaseId: c.mediaReleaseId,
            mediaTypeText: c.isLiveStream ? "videoLiveStream": c.mediaType == "audio" ? "song": c.mediaType,
            minorModeText: "standalonePlayer",
            muteEnabledIndicator: !1,
            originalMediaSourceEntityKeyText: undefined,
            originalStreamStartUtcDateTime: c.streamStartDateTime,
            pausedIndicator: !1,
            playerBundleVersionValue: 1,
            playerBufferState: undefined,
            queueSourceEntityKeyText: undefined,
            radioStationEntityKeyText: undefined,
            repeatModeText: "off",
            sampleIndicator: !c.isFullLength,
            shuffleEnabledIndicator: !1,
            totalPlayElapsedSeconds: e,
            volumeLevelValue: 0
        };
        comm.send(b, g), f = e
    }
    ...
    if (!b instanceof $ ||!b.length ||!c)
        return;
    var d, e, f, g = 10, h, i, j = config.urls.beacon, k = new CookieHelper("player"), l = $("body"), m = embedSWF(config.urls.playerSwf, a, b.get(0), {
        callback: "Myspace." + a
    }, undefined, undefined, "standalonePlayer");
    Myspace[a] = {
        onPlayerLoaded: function(a) {
            d = 0, e = 0, f = 0, h = 1, i=!1, o("AttemptLoadStream"), m.setCurrentVolume(0);
            switch (c.mediaType) {
            case"audio":
                m.loadSong({
                    rtmpURL: c.streamUrl
                ...
                break;
            case"video":
                c.isLiveStream ? n(c) : m.loadVideo({
                    rtmpURL: c.streamUrl,
                    timedTextUrl: c.timedTextUrl
                })
            }
        },
        onPlayStarted: function() {
            c.streamStartDateTime = (new Date).toISOString(), o("PlayStarted")
        },
        onCurrentTime: function(a, b, f, j, k) {
            d = a, e = j, e > g * h && (o("PlayedInterval"), h++), !i && e >= 1 && (o("Played1Second"), i=!0, comm.send("comscoreBeacon.played1Second", c), p("Video Player", "play", "Onsite"))
        },
        onStop: function() {
            o("FinishedStream")
        }
...
(function(a) {
    ...
    var b, c = function() {
        function A(a) {
            v.show(), navigator.getMedia({
                ...
                q = d, navigator.mozGetUserMedia ? l.mozSrcObject = d : window.URL && window.URL.createObjectURL ? l.src = window.URL.createObjectURL(d) : l.src = d, k.bind("canplay", function() {
                    if (!l.videoWidth) {
                        if (++p === 10)
                            return q.stop(), a(new Error("error getting camera feed"));
                        setTimeout(function() {
                            k.trigger("canplay")
                        }, 500);
                        return 
                ...
                var c;
                navigator.mozGetUserMedia ? b === "PERMISSION_DENIED" ? c = z.PERMISSION_DENIED : b === "NO_DEVICES_FOUND" && (c = z.DEVICE_NOT_FOUND) : navigator.webkitGetUserMedia ? b.name === "PERMISSION_DENIED" && (c = z.PERMISSION_DENIED) : b.PERMISSION_DENIED && (c = z.PERMISSION_DENIED), c && (z.PERMISSION_DENIED === c ? comm.send("track", new Tracking("Webcam", "Error", "PermissionDenied")) : z.DEVICE_NOT_FOUND === c && comm.send("track", new Tracking("Webcam", "Error", "DeviceNotFound"))), a(b)
            })
        }
        function B() {
        ...
        function D(a) {
            A(function(b) {
                b && (v.hide(), a(b, null)), comm.send("track", x), d.click(function() {
                    d.unbind("click"), C(), comm.send("track", new Tracking("Webcam", "Invoke", "Done")), a(null, j.prop("src"))
                })
            })
        }
        function E(a) {
        ...
        function F(a, b, c) {
            ...
            var d = y[b], e = d.totalProcesses, g = Caman(a, function() {
        ...
        function G(b) {
            var c = a(b), d = c[0], e = d.width, f = d.height;
                ...
                a.ajax({
                    ...
                    function b() {
                        if (window.Caman)
                            return I();
                        if (!--a)
                            return comm.send("track", new Tracking("Webcam", "Error", "LoadFilterScript")), Myspace.errorDialog("Sorry, filters are currently unavailable");
                        setTimeout(function() {
                            b()
                        }, 500)
                    }
                    ...
                    comm.send("track", new Tracking("Webcam", "Error", "FetchFilterScript")), Myspace.errorDialog("Sorry, filters are currently unavailable")
                });
                return 
            }
            t || K(), i.addClass("show"), comm.send("track", new Tracking("Webcam", "Invoke", "FilterTray"))
        }
        function J() {
            i.removeClass("show")
        }
        function K() {
            ...
            var b = Array.prototype.slice.call(i[0].children), c = a(b.shift()).find("canvas"), d = c[0], e = d.getContext("2d"), f = c.width(), g = r / s, h = f * g, j =- ((h - f) / 2), k = b.length;
            i.addClass("loading"), d.width = f, d.height = f, e.translate(f, 0), e.scale( - 1, 1), e.drawImage(l, j, 0, f * g, f), a.each(b, function(b, c) {
                var e = a(c), g = e.find("canvas")[0];
                g.width = f, g.height = f, g.getContext("2d").drawImage(d, 0, 0, 60, 60), F(g, e.data("filter"), function() {
                    m()
                })
            })
        }
        var b = a("#webcam"), c = b.find("section"), d = b.find("button.primary"), e = b.find("button.close"), f = c.find("button.filters"), g = c.find("button.back"), h = c.find("button.shutterRelease"), i = c.find("#filterTray"), j = c.find("img.preview"), k = c.find("video"), l = k[0], m = c.find("canvas.main")[0], n = m.getContext("2d"), o = {}, p = 0, q, r, s, t, u, v = new Myspace.Dialog("#webcamLoading", {
            closeAll: !1
        }), w = new Tracking("Webcam", "Invoke", "ShutterRelease"), x = new Tracking("Webcam", "Invoke", "Open"), y = [{
            name: "revert",
            totalProcesses: 0
        }, {
            name: "greyscale",
        ...
        return f.click(function() {
            ...
            })), comm.send("track", new Tracking("Webcam", "Invoke", "Filter: " + b.name))
        }), h.click(function() {
            var a;
            l.pause(), E("reviewing"), n.drawImage(l, 0, 0), a = m.toDataURL("image/jpeg"), o.revert = a, j.prop("src", a), d.prop("disabled", !1), comm.send("track", w)
        }), g.click(function() {
            B(), l.play()
        }), e.click(C), {
            takePhoto: D
...
(function(a) {
    ...
    if (!context.features.isComScoreEnabled)
        return;
...
(function() {
    var a = $("#settings-link"), b = $("#settings-popout"), c = new Myspace.FooterPopout(b, {
        onClose: $.noop
    });
    a.on("click", function() {
...
(function() {
    var a = $("#site-info"), b = $("#site-info-popup"), c = new Myspace.FooterPopout(b, {
        onClose: $.noop
    });
    a.on("click", function() {
        c.toggle()
