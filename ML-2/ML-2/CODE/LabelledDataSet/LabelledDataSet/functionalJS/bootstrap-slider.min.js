!function(a) {
    ...
    function d(b) {
        ...
        return c.each(function() {
            var c = a(this), d = c.data("slider"), e = "object" == typeof b && b;
    ...
    var e = {
        ...
        var i = this;
        a.each(["min", "max", "step", "precision", "value", "reversed", "handle"], function(a, b) {
        ...
        - 1 !== j.indexOf(this.handle) && (this.handle1.addClass(this.handle), this.handle2.addClass(this.handle)), this.offset = this.picker.offset(), this.size = this.picker[0][this.sizePos], this.formater = c.formater, this.tooltip_separator = c.tooltip_separator, this.tooltip_split = c.tooltip_split, this.setValue(this.value), this.handle1.on({
    ...
    f.prototype = {
        ...
        layout: function() {
            var a;
            if (a = this.reversed ? [100 - this.percentage[0], this.percentage[1]] : [this.percentage[0], this.percentage[1]], this.handle1Stype[this.stylePos] = a[0] + "%", this.handle2Stype[this.stylePos] = a[1] + "%", "vertical" === this.orientation)
                this.selectionElStyle.top = Math.min(a[0], a[1]) + "%", this.selectionElStyle.height = Math.abs(a[0] - a[1]) + "%";
            else {
                this.selectionElStyle.left = Math.min(a[0], a[1]) + "%", this.selectionElStyle.width = Math.abs(a[0] - a[1]) + "%";
                var b = this.tooltip_min[0].getBoundingClientRect(), c = this.tooltip_max[0].getBoundingClientRect();
        ...
        mousedown: function(b) {
            ...
            if (this.range) {
                var d = Math.abs(this.percentage[0] - c), e = Math.abs(this.percentage[1] - c);
        ...
        keydown: function(a, b) {
            ...
            if (c) {
                ...
                var d = c * this.percentage[2], e = this.percentage[a] + d;
