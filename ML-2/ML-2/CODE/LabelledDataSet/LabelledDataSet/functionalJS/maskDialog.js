function maskDialog(w,h)
{
    // public properties start
    this.mainForm;
    this.mainFormWidth =w;
    this.mainFormHeight=h;
    this.top=document.documentElement.clientHeight/2-100;
    ...
    this.scroll=function()
    {
        ...
        if(typeof this.mainForm != "undefined" && this.mainForm != null)
        {
            ...
            {
                this.mainForm.style.width= this.mainFormWidth + "px";
            }
            if(typeof this.mainForm.style.height == "undefined" || this.mainForm.style.height=="")
            {
                this.mainForm.style.height= this.mainFormHeight + "px";
            }
