(function(e, t, undefined) {
    ...
    function i() {
        var t = this;
        t.name = "Footable Paginate", t.init = function(i) {
            if (i.options.paginate===!0) {
                if (e(i.table).data("page")===!1)
                    return;
                e(i.table).bind({
                    footable_initialized: function() {
                        i.pageInfo = new a(i), i.raise("footable_setup_paging")
                    },
                    "footable_row_removed footable_redrawn footable_sorted footable_filtered footable_setup_paging": function() {
                        i.pageInfo && t.setupPaging(i)
                    }
                })
            }
            ...
            var i = 1, o = t.pageInfo, n = i * o.pageSize, r = [], l = [];
            o.pages = [];
            ...
            if (0 === i.length) {
                if (i = e(a.pageInfo.pageNavigation), i.parents("table:first") !== e(a.table))
                    return;
            ...
            if (0 !== i.length) {
                ...
                var o = a.pageInfo;
                o.control = i, o.pages.length > 0 && (i.append('<li class="footable-page-arrow"><a data-page="first" href="#first">' + a.pageInfo.firstText + "</a>"), i.append('<li class="footable-page-arrow"><a data-page="prev" href="#prev">' + a.pageInfo.previousText + "</a></li>"), e.each(o.pages, function(e, t) {
                    t.length > 0 && i.append('<li class="footable-page"><a data-page="' + e + '" href="#">' + (e + 1) + "</a></li>")
                }), i.append('<li class="footable-page-arrow"><a data-page="next" href="#next">' + a.pageInfo.nextText + "</a></li>"), i.append('<li class="footable-page-arrow"><a data-page="last" href="#last">' + a.pageInfo.lastText + "</a></li>")), i.find("a").click(function(i) {
                    i.preventDefault();
                    var n = e(this).data("page"), r = o.currentPage;
                    "first" === n ? r = 0 : "prev" === n ? r > 0 && r-- : "next" === n ? o.pages.length - 1 > r && r++ : r = "last" === n ? o.pages.length - 1 : n, t.paginate(a, r)
                }), t.setPagingClasses(i, o.currentPage, o.pages.length)
            }
        }, t.paginate = function(a, i) {
            var o = a.pageInfo;
            if (o.currentPage !== i) {
                var n = e(a.table).find("> tbody"), r = a.raise("footable_paging", {
                    page: i,
                    size: o.pageSize
                });
                if (r && r.result===!1)
            ...
            var i = e(t), o = i.next(), n = e(a.table);
    ...
    if (t.footable === undefined || null === t.footable)
