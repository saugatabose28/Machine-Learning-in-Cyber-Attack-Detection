...
(function(a, c) {
    ...
    (function(r, g) {
        ...
        }, p = h.support = {}, e = r("<p>")[0], d, o = r.each;
    ...
    (function() {
        ...
        a.effects.animateClass = function(h, i, l, k) {
            ...
            return this.queue(function() {
                ...
                o.attr("class", m);
                p = p.map(function() {
                    var s = this, q = a.Deferred(), r = a.extend({}, j, {
                        queue: false,
                        complete: function() {
                            q.resolve(s)
                        }
...
(function(a, b) {
    a.effects.effect.highlight = function(h, c) {
        var e = a(this), d = ["backgroundImage", "backgroundColor", "opacity"], g = a.effects.setMode(e, h.mode || "show"), f = {
...
(function(e, c) {
    ...
    e.fn.position = function(z) {
        ...
        return this.each(function() {
            ...
            if (z.using) {
                L = function(P) {
                    var R = y.left - H.left, O = R + w - G, Q = y.top - H.top, N = Q + u - D, M = {
                        target: {
                            element: v,
                            left: y.left,
                            top: y.top,
