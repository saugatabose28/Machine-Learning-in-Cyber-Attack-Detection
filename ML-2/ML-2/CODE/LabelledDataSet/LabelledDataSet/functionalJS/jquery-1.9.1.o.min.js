(function(e, t) {
    ...
    function un(e, t, n) {
        var r = true, i = t === "width" ? e.offsetWidth: e.offsetHeight, s = qt(e), o = b.support.boxSizing && b.css(e, "boxSizing", false, s) === "border-box";
        if (i <= 0 || i == null) {
            i = Rt(e, t, s);
            if (i < 0 || i == null) {
                i = e.style[t]
    ...
    b.extend = b.fn.extend = function() {
        var e, n, r, i, s, o, u = arguments[0] || {}, a = 1, f = arguments.length, l = false;
        if (typeof u === "boolean") {
            l = u;
            u = arguments[1] || {};
            a = 2
    ...
    b.fn.extend({
        ...
        stop: function(e, n, r) {
            ...
            return this.each(function() {
                var t = true, n = e != null && e + "queueHooks", s = b.timers, o = b._data(this);
                if (n) {
                    if (o[n] && o[n].stop) {
                        i(o[n])
                    }
    ...
    b.each({
        ...
        b.each({
            ...
            b.fn[i] = function(i, s) {
                var o = arguments.length && (r || typeof i !== "boolean"), u = r || (i === true || s === true ? "margin" : "border");
