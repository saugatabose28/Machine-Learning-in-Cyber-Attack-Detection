    ...
    var ShareToolsMixin = {
        ...
        **/
        getDataAttrs: function (showAll, customDataAttr) {
            ...
            for (var i = 0, len = shareArr.length; i < len; i += 1) {
        ...
        **/
        handleShortUrlShareAction: function (shareObj, urlOverride) {
            var url;
            var view = this;
            var w = window.open('', shareObj.label + 'Share', 'toolbar=0,status=0,height=' + shareObj.height + ',width=' + shareObj.width + ',scrollbars=yes,resizable=yes');
        ...
        shortUrlRedirect: function (url, shareObj, w) {
            var paramValue, shortUrlWithParams;
            var parameters = [];
