(function(a) {
    a.browserTest = function(b, c) {
        var d = "unknown", e = "X", f = function(a, b) {
            ...
            i[i.name]=!0;
            i.version = (h.exec(b) || [e, e, e, e])[3];
            i.name.match(/safari/) && i.version > 400 && (i.version = "2.0");
            i.name === "presto" && (i.version = a.browser.version > 9.27 ? "futhark" : "linear_b");
            i.versionNumber = parseFloat(i.version, 10) || 0;
            i.versionX = i.version !== e ? (i.version + "").substr(0, 1) : e;
            i.className = i.name + i.versionX;
            return i
        };
        ...
        a.os = {
            name: (/(win|mac|linux|sunos|solaris|iphone|ipad|ipod|kindle|silk|android|blackberry|mini)/.exec(navigator.platform.toLowerCase()) || [d])[0].replace("sunos", "solaris")
        };
