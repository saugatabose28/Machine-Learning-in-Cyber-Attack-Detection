(function(a, b) {
    ...
    a.fn.lazyload = function(c) {
        ...
        0 === e.event.indexOf("scroll") && $container.bind(e.event, function(a) {
            return f()
        });
        this.each(function() {
            var b = this, c = a(b);
    ...
    a.belowthefold = function(c, d) {
        var e;
        d.container === undefined || d.container === b ? e = $window.height() + $window.scrollTop() : e = $container.offset().top + $container.height();
        return e <= a(c).offset().top - d.threshold
    };
    a.rightoffold = function(c, d) {
        var e;
        d.container === undefined || d.container === b ? e = $window.width() + $window.scrollLeft() : e = $container.offset().left + $container.width();
        return e <= a(c).offset().left - d.threshold
    };
    a.abovethetop = function(c, d) {
        var e;
        d.container === undefined || d.container === b ? e = $window.scrollTop() : e = $container.offset().top;
        return e >= a(c).offset().top + d.threshold + a(c).height()
    };
    a.leftofbegin = function(c, d) {
        var e;
        d.container === undefined || d.container === b ? e = $window.scrollLeft() : e = $container.offset().left;
