...
var ddmegamenu = {
    ...
    init: function (setting) {
        //var $=jQuery
        var s = $.extend({ fx: 'none', easing: '', dur: 0, hidedelay: 0 }, setting)
        ...
        function buildmenu($anchors) {
            ...
            $anchors.each(function () { //loop through anchor links
                ...
                //console.log(orienttoleft);

                var orientationtop = /\[top\]/.test($anchor.attr('rel')) //check for rel="submenuid[top]" to indicate submenu should be top aligned
                //console.log(orientationtop);

                $submenu.wrap('<div class="megawrapper" style="z-index:' + ddmegamenu.startzindex + ';position:absolute;top:0;left:0;visibility:hidden"><div style="position:absolute;left:0;top:0;width:100%;height:100%;"></div></div>')
...
//                    }
                    ...
                    if (orientationtop) {
                        $wrapper.css({ visibility: 'visible',
                            left: offset.left - (orientationtop ? -$submenu.outerWidth() + 10/*$anchor.outerWidth()-ddmegamenu.wrapperoffset[0]*/ : 0),
