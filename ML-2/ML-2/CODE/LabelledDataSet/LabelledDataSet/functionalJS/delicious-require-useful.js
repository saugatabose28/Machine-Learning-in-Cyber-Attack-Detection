            ...
            if (!s) {
                if (s=!0, eachProp(z, function(a) {
                    ...
                    if (a.enabled && (c.isDefine || h.push(a), !a.error))
                        ...
                        else if (!a.inited && a.fetched && c.isDefine && (i=!0, !c.prefix))
                            return k=!1
                }), f && g.length)
                            ...
                            if (this.defining=!0, this.depCount < 1&&!this.defined) {
                                if (isFunction(f)) {
                                    ...
                                    if (this.map.isDefine && void 0 === e && (b = this.module, b ? e = b.exports : this.usingExports && (e = this.exports)
                                        ), a)return a.requireMap = this.map, a.requireModules = this.map.isDefine ? [this.map.id] : null, a.requireType = this.map.isDefine ? "define" : "require", j(this.error = a)
                                } else 
                                    e = f;
