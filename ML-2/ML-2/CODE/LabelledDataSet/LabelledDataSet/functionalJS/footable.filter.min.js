    ...
    function a() {
        ...
        e.name = "Footable Filter", e.init = function(a) {
            if (e.footable = a, a.options.filter.enabled===!0) {
                if (t(a.table).data("filter")===!1)
                    return;
                a.timers.register("filter"), t(a.table).bind({
            ...
            var i = e.footable, o = t(i.table), r = o.data("filter-minimum") || i.options.filter.minimum, n=!a, l = i.raise("footable_filtering", {
                filter: a,
                clear: n
            });
            if (!(l && l.result===!1 || l.filter && r > l.filter.length))
                if (l.clear)
                    e.clearFilter();
                else {
            ...
            var i = t(e), o = i.next(), r = t(a.table);
            i.is(":visible") || (r.hasClass("breakpoint") && i.hasClass("footable-detail-show") && o.hasClass("footable-row-detail") ? (i.add(o).show(), a.createOrUpdateDetailRow(e)) : i.show())
        }
    }
