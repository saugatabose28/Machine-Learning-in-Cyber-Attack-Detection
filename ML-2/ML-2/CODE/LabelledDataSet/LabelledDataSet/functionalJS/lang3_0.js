...
global_n_votes = ['', '<b>%s vote</b>', '<b>%s votes</b>'];
...
audio_crap_warning = 'The file {audio} has been removed from public access due to lack of aesthetical value.';
audio_crap_warning_text = 'The file {audio} has been removed from public access due to lack of aesthetical value.<br><br>You can {delete_link}.';
...
audio_error_loading = 'An error occurred while downloading the audio file. Please try refreshing the page.';
...
help_ccform_legal_need_email = 'You need to agree that the specified email address may be used by the Site Administration for further communication about the complaint.';
help_ccform_legal_need_inform = 'You need to agree that the information about the right holder, about you, and your complaint will be sent to the person specified as the user who uploaded the arguable content.';
...
help_ccform_natural_need_email = 'You need to agree that the specified email address may be used by the Site Administration for further communication about the complaint.';
help_ccform_natural_need_inform = 'You need to agree that the information about you, and your complaint will be sent to the person specified as the user who uploaded the arguable content.';
...
help_ccform_need_rules = 'Please agree to the conditions of the regulations for investigating complaints concerning content distributed on VK before proceeding.';
help_ccobjection_need_email = 'You need to agree that the email address specified by you may be used by the Site Administration for further communication about the complaint.';
...
help_ccobjection_need_rules = 'Please state that you agree with the regulations for investigating complaints concerning content distributed on VK.';
...
profile_enter_post = 'Type your message here..';
profile_mention_not_found = 'User was not found';
profile_mention_start_typing = 'Start typing a name..';
profile_oph_crop_desc = 'Now select a square area for your profile miniature.<br>The miniature will appear next to your posts, private messages and comments.';
// section = 31; version = 132;

reg_sex_not_set = '- Not specified -';
// section = 35; version = 62;
...
wall_reply_to_post = 'Your comment..';
wall_reply_to_post_link = 'Comment';
wall_send = 'Post';
...
fans_show_all_fans = 'Show all followers';
fans_show_all_idols = 'Show all noteworthy pages';
// section = 54; version = 11;

abuse_goto_support = 'In case of identity theft please <a class="wikiVkLink" href="http://vk.com/support?act=new&amp;from=abuse">contact our Support Team</a>. ';
// section = 58; version = 17;

offers_reban = 'Restore';
offers_unban = 'Remove from list';
// section = 59; version = 37;

mobile_act_not_activated_header = 'Please link a phone number';
mobile_apps_catalog_app_members = ['', '%s user', '%s users'];
mobile_edit_country_null = 'None selected';
mobile_photos_albums_edit_album_btn = 'Save';
mobile_photos_edit_save_btn = 'Save';
mobile_profile_work_label = 'Company: ';
mobile_wall_publish_postponed = 'Publish now';
