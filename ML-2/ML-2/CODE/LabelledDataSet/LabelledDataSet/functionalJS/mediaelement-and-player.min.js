    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        meReady: function(a, b) {
            ...
            if (this.height.toString().indexOf("%") > 0 || this.$node.css("max-width") === "100%" || this.$node[0].currentStyle && this.$node[0].currentStyle.maxWidth === "100%") {
                ...
                c = this.isVideo ||
                !this.options.autosizeProgress ? parseInt(d * e / c, 10) > this.container.parent().closest(":visible").height() ? this.container.parent().closest(":visible").height() : parseInt(d * e / c, 10) : e;
                if (isNaN(c))
                ...
                if (c != 0 && d != 0) {
                    ...
                    this.isVideo && this.media.setVideoSize &&
            ...
            var a = 0, b = 0, c = this.controls.find(".mejs-time-rail"),
            ...
            if (a.isVideo) {
                ...
                j = f('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>').appendTo(c).bind("click", function() {
            ...
            if (a.hasFocus && a.options.enableKeyboard)
                for (var e = 0, d = a.options.keyActions.length; e <
                d; e++)
                    ...
                    if (mejs.MediaFeatures.hasTrueNativeFullScreen) {
                        ...
                        a.isInIframe && setTimeout(function c() {
                            if (a.isNativeFullScreen) {
                                var e = (window.devicePixelRatio || 1) * f(window).width(), d = screen.width;
                ...
                if (this.media.pluginType == "native") {
                    ...
                    for (d = 0; d < this.options.speeds.length; d++) {
                        ...
                        if (this.options.speeds[d] == this.options.defaultSpeed) {
                            ...
                            c += '/><label for="' + this.options.speeds[d] + '">' + this.options.speeds[d] + "x</label></li>"
                    }
                    c += "</ul></div></div>";
                    a.speedButton =
                    f(c).appendTo(b);
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        buildtracks: function(a, b, c, e) {
            if (a.tracks.length !== 0) {
                ...
                if (this.options.toggleCaptionsButtonWhenOnlyOne && b == 1)
