(function(a, b) {
        ...
        if (f.isArray(b)) {
            f.each(b, function(b, e) {
                if (c || bC.test(a)) {
                    ...
                    bY(a + "[" + (typeof e === "object" || f.isArray(e) ? b : "") + "]", e, c, d)
                }
            })
    ...
    function bl(a) {
        if (f.nodeName(a, "input")) {
            bk(a)
        } else if ("getElementsByTagName"in a) {
    ...
    function M(a) {
        ...
        for (i = 0; i < s.length; i++) {
            g = s[i];
            if (g.origType.replace(x, "") === a.type) {
                q.push(g.selector)
            } else {
                s.splice(i--, 1)
            }
    ...
    function m(a, c, d) {
        var e = c + "defer", g = c + "queue", h = c + "mark", i = f.data(a, e, b, true);
        if (i && (d === "queue" ||!f.data(a, g, b, true)) && (d === "mark" ||!f.data(a, h, b, true))) {
            setTimeout(function() {
                if (!f.data(a, g, b, true)&&!f.data(a, h, b, true)) {
                    f.removeData(a, e, true);
                    i.resolve()
                }
            }, 0)
        }
    ...
    function k(a, c, d) {
        if (d === b && a.nodeType === 1) {
            ...
            if (typeof d === "string") {
                try {
                    d = d === "true" ? true : d === "false" ? false : d === "null" ? null : !f.isNaN(d) ? parseFloat(d) : i.test(d) ? f.parseJSON(d) : d
                } catch (g) {}
                f.data(a, c, d)
            } else {
                d = b
    ...
    var f = function() {
        ...
        e.extend({
            ...
            sub: function() {
                ...
                a.fn.constructor = a;
                a.sub = this.sub;
                a.fn.init = function d(c, d) {
                    if (d && d instanceof e&&!(d instanceof a)) {
                        d = a(d)
                    }
    ...
    var g = "done fail isResolved isRejected promise then always pipe".split(" "), h = [].slice;
    f.extend({
        _Deferred: function() {
            var a = [], b, c, d, e = {
                done: function() {
        ...
        when: function(a) {
            ...
            if (d > 1) {
                for (; c < d; c++) {
                    if (b[c] && f.isFunction(b[c].promise)) {
    ...
    f.support = function() {
        ...
        i.checked = true;
        k.noCloneChecked = i.cloneNode(true).checked;
        g.disabled = true;
        ...
        try {
            k.checkClone = l.cloneNode(true).cloneNode(true).lastChild.checked
        } catch (v) {
            k.checkClone = false
        }
        a.innerHTML = "";
    ...
    f.extend({
        ...
        removeData: function(b, c, d) {
            ...
            var k = h[i][e];
            if (f.support.deleteExpando || h != a) {
                delete h[i]
            } else {
                h[i] = null
            }
    ...
    f.extend({
        _mark: function(a, c) {
            if (a) {
                c = (c || "fx") + "mark";
                f.data(a, c, (f.data(a, c, b, true) || 0) + 1, true)
            }
        },
        _unmark: function(a, c, d) {
            ...
            if (c) {
                d = d || "fx";
                var e = d + "mark", g = a ? 0: (f.data(c, e, b, true) || 1) - 1;
                if (g) {
                    f.data(c, e, g, true)
                } else {
        ...
        queue: function(a, c, d) {
            if (a) {
                c = (c || "fx") + "queue";
                var e = f.data(a, c, b, true);
                if (d) {
                    if (!e || f.isArray(d)) {
                        e = f.data(a, c, f.makeArray(d), true)
                    } else {
                        e.push(d)
                    }
                }
    ...
    f.fn.extend({
        ...
        promise: function(a, c) {
            ...
            while (g--) {
                if (l = f.data(e[g], i, b, true) || (f.data(e[g], j, b, true) || f.data(e[g], k, b, true)) && f.data(e[g], i, f._Deferred(), true)) {
                    h++;
                    l.done(m)
                }
            }
    ...
    f.extend({
        ...
        attr: function(a, c, d, e) {
            ...
            if (j) {
                ...
                if (!i) {
                    if (t.test(c)) {
                        i = w
                    } else if (v && c !== "className" && (f.nodeName(a, "form") || u.test(c))) {
                        i = v
                    }
                }
            }
            if (d !== b) {
                if (d === null) {
                    f.removeAttr(a, c);
                    return b
                } else if (i && "set"in i && j && (h = i.set(a, d, c)) !== b) {
                    return h
                } else {
                    a.setAttribute(c, "" + d);
                    return d
                }
            } else if (i && "get"in i && j && (h = i.get(a, c)) !== null) {
                return h
            } else {
                h = a.getAttribute(c);
                return h === null ? b : h
        ...
        removeAttr: function(a, b) {
            ...
            if (a.nodeType === 1) {
                b = f.attrFix[b] || b;
                if (f.support.getSetAttribute) {
                    a.removeAttribute(b)
                } else {
                    f.attr(a, b, "");
                    a.removeAttributeNode(a.getAttributeNode(b))
                }
                if (t.test(b) && (c = f.propFix[b] || b)in a) {
                    a[c] = false
                }
            }
        },
        ...
        prop: function(a, c, d) {
            ...
            if (d !== b) {
                if (h && "set"in h && (g = h.set(a, d, c)) !== b) {
                    return g
                } else {
                    return a[c] = d
                }
            } else {
                if (h && "get"in h && (g = h.get(a, c)) !== b) {
                    return g
                } else {
                    return a[c]
                }
    ...
    f.event = {
        add: function(a, c, d, e) {
            ...
            while (l = c[m++]) {
                ...
                if (!o) {
                    o = j[l] = [];
                    if (!p.setup || p.setup.call(a, e, n, k) === false) {
                        if (a.addEventListener) {
                            a.addEventListener(l, k, false)
        ...
        remove: function(a, c, d, e) {
            ...
            if (f.isEmptyObject(t)) {
                ...
                delete s.events;
                delete s.handle;
                if (f.isEmptyObject(s)) {
                    f.removeData(a, b, true)
                }
            }
        },
        customEvent: {
        ...
        trigger: function(c, d, e, g) {
            ...
            do {
                ...
                if (l && f.acceptData(k) && k[l] && k[l].apply(k, d) === false) {
                    c.result = false;
                    c.preventDefault()
                }
            ...
            if (!c.isDefaultPrevented()) {
                ...
                if ((!o._default || o._default.call(e.ownerDocument, c) === false)&&!(h === "click" && f.nodeName(e, "a")) && f.acceptData(e)) {
                    try {
                        if (l && e[h]) {
                            n = e[l];
                            if (n) {
    ...
    f.Event = function(a, b) {
        ...
        if (a && a.type) {
            ...
            this.type = a.type;
            this.isDefaultPrevented = a.defaultPrevented || a.returnValue === false || a.getPreventDefault && a.getPreventDefault() ? E : D
        } else {
            this.type = a
        }
        if (b) {
    ...
    var F = function(a) {
        var b = a.relatedTarget, c = false, d = a.type;
        a.type = a.data;
        if (b !== this) {
            if (b) {
                c = f.contains(this, b)
    ...
    if (!f.support.changeBubbles) {
        var H, I = function(a) {
            ...
            if (b === "radio" || b === "checkbox") {
                ...
                c = a.selectedIndex>-1 ? f.map(a.options, function(a) {
                    return a.selected
                }).join("-") : ""
            } else if (f.nodeName(a, "select")) {
                c = a.selectedIndex
            }
            return c
        }, J = function cw(a) {
        ...
        f.event.special.change = {
            filters: {
                ...
                click: function(a) {
                    ...
                    if (c === "radio" || c === "checkbox" || f.nodeName(b, "select")) {
                        J.call(this, a)
                    }
                },
                keydown: function(a) {
                    var b = a.target, c = f.nodeName(b, "input") ? b.type: "";
                    if (a.keyCode === 13&&!f.nodeName(b, "textarea") || a.keyCode === 32 && (c === "checkbox" || c === "radio") || c === "select-multiple") {
                        J.call(this, a)
                    }
                },
    ...
    (function() {
        ...
        var a = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, d = 0, e = Object.prototype.toString, g = false, h = true, i = /\\/g, j = /\W/;
        [0, 0].sort(function() {
            h = false;
            return 0
        });
    ...
    f.fn.extend({
        ...
        not: function(a) {
            return this.pushStack(W(this, a, false), "not", a)
        },
        filter: function(a) {
            return this.pushStack(W(this, a, true), "filter", a)
        },
        is: function(a) {
            ...
            if (f.isArray(a)) {
                ...
                if (g && a.length) {
                    for (d = 0, e = a.length; d < e; d++) {
                        i = a[d];
                        if (!j[i]) {
                            j[i] = T.test(i) ? f(i, b || this.context) : i
                        }
                    }
                    while (g && g.ownerDocument && g !== b) {
                        for (i in j) {
                            h = j[i];
                            if (h.jquery ? h.index(g)>-1 : f(g).is(h)) {
                                c.push({
                                    selector: i,
                                    elem: g,
                                    level: k
    ...
    f.each({
        ...
        f.fn[a] = function(c, d) {
            ...
            if ((this.length > 1 || Q.test(d)) && P.test(a)) {
                e = e.reverse()
            }
    ...
    f.fn.extend({
        ...
        html: function(a) {
            ...
            } else if (typeof a === "string"&&!bb.test(a) && (f.support.leadingWhitespace ||!Y.test(a))&&!bf[($.exec(a) || ["", ""])[1].toLowerCase()]) {
                a = a.replace(Z, "<$1></$2>");
                try {
                    for (var c = 0, d = this.length; c < d; c++) {
            ...
            if (this[0]) {
                ...
                if (g) {
                    ...
                    for (var l = 0, m = this.length, n = m - 1; l < m; l++) {
                        d.call(c ? bg(this[l], g) : this[l], e.cacheable || m > 1 && l < n ? f.clone(h, true, true) : h)
                    }
                }
                if (k.length) {
                    f.each(k, bm)
    ...
    f.buildFragment = function(a, b, d) {
        ...
        if (a.length === 1 && typeof a[0] === "string" && a[0].length < 512 && i === c && a[0].charAt(0) === "<"&&!bb.test(a[0]) && (f.support.checkClone ||!bc.test(a[0]))) {
            g = true;
            h = f.fragments[a[0]];
            if (h && h !== 1) {
                e = h
                    ...
                    if (!ba.test(k)) {
                        ...
                        if (!f.support.tbody) {
                            ...
                            for (i = q.length - 1; i >= 0; --i) {
                                if (f.nodeName(q[i], "tbody")&&!q[i].childNodes.length) {
                                    q[i].parentNode.removeChild(q[i])
                                }
                            }
                        }
                        if (!f.support.leadingWhitespace && Y.test(k)) {
                            o.insertBefore(b.createTextNode(Y.exec(k)[0]), o.firstChild)
                        }
                        k = o.childNodes
                    }
                }
    ...
    f.fn.css = function(a, c) {
        ...
        return f.access(this, a, c, true, function(a, c, d) {
    ...
    if (c.defaultView && c.defaultView.getComputedStyle) {
        by = function(a, c) {
            ...
            if (g = e.getComputedStyle(a, null)) {
                ...
                if (d === ""&&!f.contains(a.ownerDocument.documentElement, a)) {
                    d = f.style(a, c)
                }
            }
            return d
    ...
    f.extend({
        ...
        ajaxSetup: function(a, b) {
            if (!b) {
                b = a;
                a = f.extend(true, f.ajaxSettings, b)
            } else {
                f.extend(true, a, f.ajaxSettings, b)
            }
            for (var c in{
                context: 1,
                url: 1
                ...
                if (c in b) {
                    a[c] = b[c]
                } else if (c in f.ajaxSettings) {
                    a[c] = f.ajaxSettings[c]
                }
            }
            return a
        },
    ...
    f.ajaxPrefilter("json jsonp", function(b, c, d) {
        ...
        if (b.dataTypes[0] === "jsonp" || b.jsonp !== false && (ca.test(b.url) || e && ca.test(b.data))) {
            ...
            if (a || a === 0) {
                ...
                for (var d = 0, e = this.length; d < e; d++) {
                    if (this[d].style) {
                        ...
                        if (g !== "none"&&!f._data(this[d], "olddisplay")) {
                ...
                for (i in a) {
                    ...
                    if (c && (g === "height" || g === "width")) {
                        ...
                        if (f.css(this, "display") === "inline" && f.css(this, "float") === "none") {
                            if (!f.support.inlineBlockNeedsLayout) {
    ...
    f.fx.prototype = {
        ...
        step: function(a) {
            var b = cn || cp(), c = true, d = this.elem, e = this.options, g, h;
            if (a || b >= e.duration + this.startTime) {
                this.now = this.end;
                this.pos = this.state = 1;
                this.update();
                e.animatedProperties[this.prop] = true;
                for (g in e.animatedProperties) {
                    if (e.animatedProperties[g] !== true) {
                        c = false
                    }
                }
                if (c) {
                    if (e.overflow != null&&!f.support.shrinkWrapBlocks) {
        ...
        f.fn.offset = function(a) {
            ...
            while ((b = b.parentNode) && b !== i && b !== h) {
                ...
                if (b === d) {
                    l += b.offsetTop;
                    m += b.offsetLeft;
                    if (f.offset.doesNotAddBorder&&!(f.offset.doesAddBorderForTableAndCells && ct.test(b.nodeName))) {
                ...
                if (f.offset.subtractsBorderForOverflowNotVisible && c.overflow !== "visible") {
                    l += parseFloat(c.borderTopWidth) || 0;
                    m += parseFloat(c.borderLeftWidth) || 0
                }
                k = c
    ...
    f.each(["Left", "Top"], function(a, c) {
        ...
        f.fn[d] = function(c) {
            ...
            return this.each(function() {
                g = cv(this);
                if (g) {
                    g.scrollTo(!a ? c : f(g).scrollLeft(), a ? c : f(g).scrollTop())
                } else {
                    this[d] = c
                }
            })
