...
!function(a, b, c, d) {
    c.swipebox = function(e, f) {
        ...
        j.settings = {}, j.init = function() {
            ...
            gesture: function() {
                var a = this, b = null, d = null, e=!1, f = 10, g = 50, h = {}, i = {}, k = c("#swipebox-caption, #swipebox-action"), l = c("#swipebox-slider");
            ...
            animBars: function() {
                var a = this, b = c("#swipebox-caption, #swipebox-action");
            ...
            getVideo: function(a) {
                var b = "", c = a.match(/watch\?v=([a-zA-Z0-9\-_]+)/), d = a.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/), e = a.match(/vimeo\.com\/([0-9]*)/);
            ...
            getNext: function() {
                var a = this, b = c("#swipebox-slider .slide").index(c("#swipebox-slider .slide.current"));
