...
function clickEvent(e) {
    ...
    try {
        ...
        var i = new Image(1, 1);
        i.src = "http://trace.qq.com:80/collect?pj=8888&url=" + escape(location.href) + "&w=" + screen.width + "&x=" + t + "&y=" + n + "&v=" + r + "&u=" + trimUin(pgvGetCookieByName("o_cookie")), delete i
    } catch (s) {}
}
function tracert() {
    if (pgvIsPgvDomain()) {
...
function staybounce() {
    ...
    t.src = "http://trace.qq.com:80/collect?pj=8887&url=" + escape(location.href) + "&t=" + parseInt((e - pvStartTime) / 1e3) + "&v=" + pvClickCount + "&u=" + trimUin(pgvGetCookieByName("o_cookie")), delete t
}
    ...
    tcss.prototype = {
        ...
        getElementPos: function(e) {
            ...
            while (n && n.tagName != "BODY" && n.tagName != "HTML")
                r[0] -= n.scrollLeft, r[1] -= n.scrollTop, n.parentNode ? n = n.parentNode : n = null;
            return {
                x: r[0],
                y: r[1]
            }
