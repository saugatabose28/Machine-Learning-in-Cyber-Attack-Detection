...
if (typeof document !== "undefined"&&!("classList" in document.createElement("a"))) {
    (function(t) {
        ...
        var C = "classList", x = "prototype", q = (t.HTMLElement || t.Element)[x], B = Object, s = String[x].trim || function() {
            ...
            var b = s.call(a.className), c = b ? b.split(/\s+/): [], d = 0, f = c.length;
            for (; d < f; d++) {
                this.push(c[d])
            }
        ...
        y.add = function() {
            var a = arguments, b = 0, d = a.length, c, f = false;
            do {
                c = a[b] + "";
                if (w(this, c)===-1) {
                    this.push(c);
        ...
        y.remove = function() {
            var a = arguments, b = 0, f = a.length, c, g = false;
            do {
                c = a[b] + "";
                var d = w(this, c);
                if (d!==-1) {
        ...
        y.toggle = function(c, b) {
            c += "";
            var d = this.contains(c), a = d ? b !== true && "remove": b !== false && "add";
            if (a) {
                this[a](c)
            }
            return !d
    ...
    Date.prototype.toISOString = function toISOString() {
        ...
        for (g in d) {
            if (d.hasOwnProperty(g) && g !== "year" && g !== "mseconds") {
                d[g] = String(d[g]).length === 1 ? "0" + String(d[g]) : String(d[g])
            }
        }
        if (d.year < 0 || d.year > 9999) {
            f = d.year < 0 ? "-" : "+";
            d.year = f + String(Math.abs(d.year / 1000000)).substr(2, 6)
        }
...
window.matchMedia = window.matchMedia || (function(m, l) {
    var o, j = m.documentElement, i = j.firstElementChild || j.firstChild, n = m.createElement("body"), k = m.createElement("div");
    k.id = "mq-test-1";
    ...
    !function() {
        ...
        c = function(i, l, h) {
            ...
            function n(s) {
                ...
                for (var p = s.split("/"), t = m.split("/").slice(0, - 1), o = 0, q = p.length;
                q > o; o++) {
                    var r = p[o];
                    if (".." === r) {
                        t.pop()
        ...
        var f = h.isArray, g = h.isFunction;
        i.all = o
        ...
        function z() {
            var m = 0, n = new j(f), l = document.createTextNode("");
            return n.observe(l, {
                characterData: !0
            }), function() {
                l.data = m=++m%2
        ...
        var f = h.Promise, g = i.isFunction;
        p.polyfill = q
        ...
        function g(H, I, J, K) {
            var F = H._subscribers, G = F.length;
            F[G] = I, F[G + r] = J, F[G + t] = K
        }
        function h(H, I) {
            for (var J, K, L = H._subscribers, F = H._detail, G = 0;
            G < L.length; G += 3) {
        ...
        var s = A.config, u = (A.configure, B.objectOrFunction), v = B.isFunction, w = (B.now, C.all), x = D.race, y = E.resolve, z = af.reject, l = ag.asap;
        s.async = l;
        var n = void 0, p = 0, r = 1, t = 2;
        ai.prototype = {
            constructor: ai,
            _state: void 0,
            _detail: void 0,
...
require = (function e(h, j, l) {
    ...
    19: [function(d, g, f) {
        ...
        (function(a2, bc) {
            var aS, a0, bd, bq, bk, bm = a2.document, bj = bm.documentElement, aK = "undefined", bi = false, bl = true, be = 0, a9 = [].slice, aU = [].push, aM = ("sizcache" + Math.random()).replace(".", ""), aE = "[\\x20\\t\\r\\n\\f]", ba = "(?:\\\\.|[-\\w]|[^\\x00-\\xa0])", bb = "(?:[\\w#_-]|[^\\x00-\\xa0]|\\\\.)", aC = "([*^$|!~]?=)", a7 = "\\[" + aE + "*(" + ba + "+)" + aE + "*(?:" + aC + aE + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + bb + "+)|)|)" + aE + "*\\]", az = ":(" + ba + "+)(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|(.*))\\)|)", aA = ":(nth|eq|gt|lt|first|last|even|odd)(?:\\((\\d*)\\)|)(?=[^-]|$)", bf = aE + "*([\\x20\\t\\r\\n\\f>+~])" + aE + "*", bg = "(?=[^\\x20\\t\\r\\n\\f])(?:\\\\.|" + a7 + "|" + az.replace(2, 7) + "|[^\\\\(),])+", aP = new RegExp("^" + aE + "+|((?:^|[^\\\\])(?:\\\\.)*)" + aE + "+$", "g"), av = new RegExp("^" + bf), aQ = new RegExp(bg + "?(?=" + aE + "*,|$)", "g"), b = new RegExp("^(?:(?!,)(?:(?:^|,)" + aE + "*" + bg + ")*?|" + aE + "*(.*?))(\\)|$)"), aG = new RegExp(bg.slice(19, - 6) + "\\x20\\t\\r\\n\\f>+~])+|" + bf, "g"), a = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, aZ = /[\x20\t\r\n\f]*[+~]/, aJ = /:not\($/, aY = /h\d/i, a6 = /input|select|textarea|button/i, aR = /\\(?!\\)/g, aw = {
                ...
                var k = false, i = bm.createElement("div");
                try {
                    k = h(i)
                } catch (j) {}
                i = null;
                ...
                var h = bm.getElementsByName && bm.getElementsByName(aM).length === 2 + bm.getElementsByName(aM + 0).length;
            ...
            var au = a4.selectors = {
                ...
                pseudos: {
                    ...
                    contains: aI(function(h) {
                        return function(i) {
                            return (i.textContent || i.innerText || bt(i)).indexOf(h)>-1
                        }
                    }),
                    has: aI(function(h) {
                        return function(i) {
            ...
            var a8 = a4.isXML = function(h) {
                var i = h && (h.ownerDocument || h).documentElement;
            ...
            : bj.contains ? function(k, h) {
                var i = k.nodeType === 9 ? k.documentElement: k, j = h.parentNode;
            ...
            if (bj.compareDocumentPosition) {
                ...
                bd = function(n, o) {
                    ...
                    var q, k, j = [], l = [], h = n.parentNode, p = o.parentNode, m = h;
                    if (h === p) {
                        return bq(n, o)
                    } else {
                        if (!h) {
            ...
            function aX(v, u, x, q, n) {
                var j, s, m, k, y, l, w, p, t = 0, r = n.length, o = aw.POS, i = new RegExp("^" + o.source + "(?!" + aE + ")", "i"), h = function() {
                    var z = 1, A = arguments.length - 2;
                    for (; z < A; z++) {
                        if (arguments[z] === bc) {
                            j[z] = bc
                        }
            ...
            function br(t, j, q) {
                var o, p, n, h = [], s = 0, r = b.exec(t), l=!r.pop()&&!r.pop(), k = l && t.match(aQ) || [""], m = au.preFilter, i = au.filter, u=!q && j !== bm;
                for (; (p = k[s]) != null && l; s++) {
                    h.push(o = []);
                    if (u) {
                        p = " " + p
                    ...
                    while (p) {
                        ...
                        if ((r = av.exec(p))) {
                            ...
                            l = o.push({
                                part: r.pop().replace(aP, " "),
                                captures: r
                            })
                        }
                        for (n in i) {
                            if ((r = aw[n].exec(p)) && (!m[n] || (r = m[n](r, j, q)))) {
                                p = p.slice(r.shift().length);
                                l = o.push({
                                    part: n,
                                    captures: r
                                })
            ...
            a4.matchesSelector = function(h, i) {
                return a4(i, null, null, [h]).length > 0
            };
            var aN = function(i, o, w, s, t) {
                i = i.replace(aP, "$1");
                var q, r, v, p, m, k, l, j, x, u = i.match(aQ), n = i.match(aG), h = o.nodeType;
                if (aw.POS.test(i)) {
                    return aX(i, o, w, s, u)
                }
                if (s) {
                    ...
                    if (u && u.length === 1) {
                        ...
                        for (v = 0, p = au.order.length; v < p; v++) {
                            l = au.order[v];
                            if ((u = aw[l].exec(k))) {
                                q = au.find[l]((u[1] || "").replace(aR, ""), j, t);
                                if (q == null) {
                                    continue
                                }
                                if (k === x) {
                        ...
                        if (!o&&!p && (!n ||!n.test(r))) {
                            if (v.nodeType === 9) {
                                ...
                                if (v.nodeType === 1 && v.nodeName.toLowerCase() !== "object") {
                                    var t = v.getAttribute("id"), w = t || aM, u = aZ.test(r) && v.parentNode || v;
                                    if (t) {
                                        w = w.replace(k, "\\$&")
                                    } else {
                                        v.setAttribute("id", w)
    ...
    26: [function(q, p, k) {
        var m = new (q("./ac-deferred/Deferred"))(), n = q("smartsign-deferred").Deferred;
        function j() {
            this._defer = new n()
        }
        j.prototype = m;
    ...
    31: [function(o, m, i) {
        ...
        m.exports = function(u) {
            ...
            u = u.replace(/([A-Z]+)([A-Z][a-z])/g, "$1\\-$2").replace(/([a-z\d])([A-Z])/g, "$1\\-$2").replace(/^(\-*webkit|\-*moz|\-*o|\-*ms|\-*khtml)\-/, "").toLowerCase();
            switch (u) {
            case"gradient":
                ...
                l.cssText = (u + k.join(b + u) + k.join(c + u)).slice(0, - u.length);
            ...
            default:
                ...
                if (d.length > 0) {
                    u = d[0];
                    for (g = 1; g < t; g += 1) {
                        u += d[g].substr(0, 1).toUpperCase() + d[g].substr(1)
                    }
                }
                f = u.substr(0, 1).toUpperCase() + u.substr(1);
                if (n[u] !== undefined) {
                    return n[u]
                }
                for (h = j.length - 1;
    ...
    49: [function(D, E, A) {
        ...
        var x = D("ac-element");
        var C = D("ac-object");
        var r = D("ac-event-emitter").EventEmitter;
        ...
        y._shouldEnhance = function() {
            ...
            var a = typeof document.createElement("div").onmouseenter !== "undefined";
    ...
    50: [function(w, x, s) {
        ...
        var t = w("ac-object");
        var u = y.Deferred;
        var n = w("ac-event-emitter").EventEmitter;
        ...
        r._willSendRequest = function(a) {
            ...
            y.all(this._ajaxRequests).then(this._handleData.bind(this))
        };
        r._sendRequest = function(c, d, g, a) {
            ...
            return b.promise().then(this.requestSuccess.bind(this), this.requestFailure.bind(this))
        };
    ...
    52: [function(s, t, q) {
        ...
        var l = s("ac-event-emitter").EventEmitter;
        ...
        p._handleResultItemMouseDown = function(g) {
            ...
            g.returnValue = false;
            var d, a, b, c, f;
            f = this.getAnchorTag(g).href;
            for (d = 0, a = this._results.indexedElements.length;
            d < a; d += 1) {
    ...
    53: [function(t, u, q) {
        var o = t("ac-element");
        var s = t("ac-object");
        var m = t("ac-event-emitter").EventEmitter;
        ...
        var r = function(i, af) {
            ...
            function a(C) {
                ...
                function x(H) {
                    var F;
                    try {
                        F = (H.getElementsByTagName("shortcuts").length) ? true : false
                    } catch (G) {
                        F = false
                    }
                    return F
                ...
                if (x(C) === true) {
                    ...
                    if (y.length === 0) {
                        ...
                        for (D = 0; D < w; D += 1) {
                            ...
                            z.url = decodeURIComponent(z.url).replace(/http(s)?:\/\/www.apple.com/g, f);
                            A.push(z)
                        }
                    } else {
                        return false
                            ...
                            if (C.hasOwnProperty("0")) {
                                ...
                                z = {
                                    ...
                                    url: (aa.searchForm.formAction + "?" + s.toQueryParameters({
                                        ...
                                        geo: n.searchCountry
                                    }) + "&" + aa.searchForm.searchInputName + "=" + encodeURIComponent(v)).replace(/http(s)?:\/\/www.apple.com/g, f)
                                };
                                A.push(z)
                            }
                        }
