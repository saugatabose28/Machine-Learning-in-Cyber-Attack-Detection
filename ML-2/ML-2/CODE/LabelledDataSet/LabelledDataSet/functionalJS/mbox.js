...
mboxFactory.prototype.setVisitorIdParameters =  function(_url, _mboxName) {
  var imsOrgId = '9E1005A551ED61CA0A490D45@AdobeOrg';
...
if (typeof mboxVersion == 'undefined') {
  ...
  var mboxFactoryDefault = new mboxFactory('adobe.tt.omtrdc.net', 'adobe',
    'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
  ...
  document.write('<' + 'scr' + 'ipt language="Javascript1.2" src='
    + '"//admin9.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=adobe.tt.omtrdc.net'
    + '&clientCode=adobe"><' + '\/scr' + 'ipt>');
};
...
mboxVizTargetUrl = function(_mboxName /*, ... */) {
  ...
  _urlBuilder.setBasePath('/m2/' + 'adobe' + '/viztarget');
...
TNT.createGlobalMbox = function () {
  var _globalMboxName = "adobe-global-mbox";
...
/* Customized to enable Adobe Optout*/
