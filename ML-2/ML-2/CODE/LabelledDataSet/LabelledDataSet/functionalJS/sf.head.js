window.Modernizr = function(ap, ao, an) {
    ...
    var am = "1.7pre", al = {}, ak=!0, aj = ao.documentElement, ai = ao.head || ao.getElementsByTagName("head")[0], ah = "modernizr", ag = ao.createElement(ah), af = ag.style, ae = ao.createElement("input"), ad = ":)", ac = Object.prototype.toString, ab = " -webkit- -moz- -o- -ms- -khtml- ".split(" "), Z = "Webkit Moz O ms Khtml".split(" "), X = {
        svg: "http://www.w3.org/2000/svg"
    }, V = {}, T = {}, R = {}, P = [], N, M = function(b) {
    ...
    W(J, an) || W(J.call, an) ? I = function(d, c) {
        ...
        function j(f, e, l, k) {
            f.style.cssText = ab.join(e + ":" + l + ";") + (k || "")
        }
        function b(f, e, l, k) {
            e += ":", f.style.cssText = (e + ab.join(l + ";" + e)).slice(0, - e.length) + (k || "")
        }
        var i = ao.createElement("div"), h = ao.createElement("div");
        b(i, "display", "box", "width:42px;padding:0;"), j(h, "box-flex", "1", "width:10px;"), i.appendChild(h), aj.appendChild(i);
        var g = h.offsetWidth === 42;
        i.removeChild(h), aj.removeChild(i);
        return g
    }, V.canvas = function() {
        ...
        var b, l, k = ai || aj, j = ao.createElement("style"), h = ao.implementation || {
            hasFeature: function() {
                return !1
            }
        };
        j.type = "text/css", k.insertBefore(j, k.firstChild), b = j.sheet || j.styleSheet;
        var g = h.hasFeature("CSS2", "") ? function(a) {
            if (!b ||!a) {
                return !1
            }
            var f=!1;
        ...
        l = g('@font-face { font-family: "font"; src: url(data:,); }'), k.removeChild(j);
        return l
    }, V.video = function() {
        var b = ao.createElement("video"), f=!!b.canPlayType;
        if (f) {
        ...
        var b = ao.createElement("audio"), d=!!b.canPlayType;
    ...
    al.input || O(), al.crosswindowmessaging = al.postmessage, al.historymanagement = al.history, al.addTest = function(d, c) {
        ...
        function q(h, g) {
            var l =- 1, k = h.length, j, i = [];
            while (++l < k) {
                j = h[l], (g = j.media || g) != "screen" && i.push(q(j.imports, g), j.cssText)
            }
            return i.join("")
        }
        function r(d) {
        ...
        var D = "abbr|article|aside|audio|canvas|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", C = D.split("|"), B = C.length, A = new RegExp("(^|\\s)(" + D + ")", "gi"), z = new RegExp("<(/*)(" + D + ")", "gi"), y = new RegExp("(^|[^\\n]*?\\s)(" + D + ")([^\\n]*)({[\\n\\w\\W]*?})", "gi"), x = E.createDocumentFragment(), w = E.documentElement, v = w.firstChild, u = E.createElement("body"), t = E.createElement("style"), s;
        r(E), r(x), v.insertBefore(t, v.firstChild), t.media = "print", F.attachEvent("onbeforeprint", function() {
            var b =- 1, i = q(E.styleSheets, "all"), d = [], h;
            s = s || E.body;
            while ((h = y.exec(i)) != null) {
                d.push((h[1] + h[2] + h[3]).replace(A, "$1.iepp_$2") + h[4])
            }
            t.styleSheet.cssText = d.join("\n");
            while (++b < B) {
                var g = E.getElementsByTagName(C[b]), f = g.length, e =- 1;
                while (++e < f) {
    ...
    return al
}(this, this.document); /*! jQuery v1.11.1 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */
!function(a, b) {
...
SF.log = SF.Logger();
SF.trackClick = function(c, e, f, b) {
    if (!window._gaq) {
        document.location = c
    }
    var a = ["_trackEvent", e, f];
    if (b) {
        if (b.label) {
            a.push(b.label)
        }
        ...
        if (b.noninteraction) {
            a.push(b.noninteraction)
        }
    }
    try {
        _gaq.push(a);
        setTimeout('document.location = "' + c + '"', 100)
    } catch (d) {
        document.location = c
    }
};
