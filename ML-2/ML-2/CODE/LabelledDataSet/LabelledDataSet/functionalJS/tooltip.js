...
CM_Tooltip.gtooltip = function (opts) {
    ...
    tooltipApi = {
        ...
        show: function (content, switchElement) {
            ...
            var w = Math.min(opts.maxw, document.documentElement.clientWidth, window.innerWidth);
            if (jQuery(tooltipWrapper).outerWidth() > w) {
        ...
        pos: function (e) {
            ...
            if (CM_Tooltip.Modernizr.touch)
            {
                x = x + 100;
                width = Math.min(jQuery(tooltipWrapper).outerWidth(), opts.maxw, document.documentElement.clientWidth, window.innerWidth);

                tooltipWrapper.style.top = x + 'px';
                tooltipWrapper.style.left = (l - (width / 2)) + 'px';

                if (width < 400)
                {
                    tooltipWrapper.style.left = '0px';
                }
            }
            /*
